...
<div class="full_div">
		...
		echo $_POST['exam'];
		 ...
		 {
		 $search=mysqli_query($con,"select * from discipline where class='".$_POST['class']."' and exam='".$_POST['exam']."'");
         ?>
		 ...
		 <th>Term</th><th>I Can Sing And Dance</th><th>I enjoy my work</th><th>I love to play</th> <th>I do my work carefully</th><th>I listion to instruction</th>
		 <th>I do my homework regularlly</th><th>I know my table manners</th><th>I am neat & tidy</th><th>I am confident</th><th>I am regular</th>
		 <th></th>
		 ...
		 <td><?php echo $studrow['dance']; ?></td>
		 <td><?php echo $studrow['en_w']; ?></td>
		 <td><?php echo $studrow['paly']; ?></td>
		 <td><?php echo $studrow['w_c']; ?></td>
		 <td><?php echo $studrow['list_in']; ?></td>
		 <td><?php echo $studrow['hwk']; ?></td>
		 <td><?php echo $studrow['know_t']; ?></td>
		 <td><?php echo $studrow['cond']; ?></td>
		 <td><?php echo $studrow['neat']; ?></td>
		 <td><?php echo $studrow['reg']; ?></td>
