...
<div class="full_div">
		...
		<a href="./?pageid=view_health1" style="color:#FFFFFF;float:right; background-color:#009966; margin-top:10px; padding:6px; font-size:18px">View Details</a>
        </div>
        <div class="col_4">
		...
		<div style="width:100%; height:35px; background-color:#FF0000; margin-top:10px;">
		 ...
		 <td style="width:245px;">STUDENT NAME</th>
		 <th style="width:100px;">CLASS</td>
		 <td style="width:222px;">Height</th>
		 <td style="width:222px;">Weight.</th>
		 <td style="width:222px;">Vision L / R</td> 
		 <td></td>
		  </tr>
		  </table>
		</div>
...
var data_str= "cls="+cls+"&idm="+idm+"&height="+height+"&weight="+weight+"&vision="+vision;
 
$.ajax({
type:"POST",
url:"add_recordh1.php",
data:data_str,
success:function(){
