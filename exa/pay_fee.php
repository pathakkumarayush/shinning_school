...
if((!empty($_POST['latefee1']))|| (!empty($_POST['concession'])) || (!empty($_POST['concession'])) )
{
	 ...
	 if($_POST['amntdeposit']<$_POST['amt'])
	  ...
	  if($_POST['montha']=='April,August,December')
	  {
...
instalment,extra_amnt,remark,cno,cd,padv,anual,sch,bank,ne_no,ndat,colle,cba,cbno,name)
values('".$_POST['ses']."','".$_POST['class']."','".$_POST['admissionfee']."','".$_POST['caution']."','".$_POST['inst_fee']."','".$_POST['inst_fee_bus']."','".$_POST['amt']."','".$_POST['tamount']."','$due','".$_POST['pdue']."','".$_POST['ftype']."','".$_POST['amntdeposit']."','".$_POST['montha']."','".$_POST['student']."','$datee',
'".$_POST['latefee1']."','".$_POST['concession']."','".$_SESSION['uid']."','".$_POST['srecipt']."','$m','$instn','$extra','".$_POST['remarks']."','".$_POST['cno']."',
'".$_POST['dat']."','".$_POST['padv']."','".$_POST['anual']."','".$_POST['sch']."','".$_POST['bank']."','".$_POST['ne_no']."','".$_POST['ndat']."','".$_POST['colle']."','".$_POST['cba']."','".$_POST['cbno']."','".$_POST['nnm']."')");
