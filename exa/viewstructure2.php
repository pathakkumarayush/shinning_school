...
<?php
       ...
       ?>
	   <?php
	         if(!empty($_GET['ushiningtd']))
			 {
			 $search=mysqli_query($con,"select * from student where uid='".$_GET['ushiningtd']."' and student_session='".$_SESSION['session']."' and student_school='".$_SESSION['uid']."'");
