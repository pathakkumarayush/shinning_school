...
$d = date("d-m-Y");
$t = 'tech';
 $query=mysqli_query($con,"insert into returnbook(bno,name,sname,sid,idate,ddate,date,amt,type) values('".$_POST['bno']."','".$_POST['title']."','".$_POST['tname']."','".$_POST['sid']."','".$_POST['doe']."','".$_POST['due']."','$d','".$_POST['famt']."','$t') "); 
 
 echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Book Succesfully Return')
    window.location.href='http://localhost/kmp/school/?pageid=book_status_tech';
    </SCRIPT>");
 }
mysqli_close($con);
?>	
