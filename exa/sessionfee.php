...
<div class="full_div">
<br clear="all" />
<div class="left_sect"><img src="images/FEE Management/feehome.png" /><a href="./?pageid=fee_account">
...
<form action="#" method="post" enctype="multipart/form-data">
				 <div class="box-head" style="font-size:18px">
					 <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."feecollectinby_session"."&&divid=1"; ?>"><a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."feecollectinby_session"."&&divid=2"; ?>">  Total Fee Collection By Class In Session</a>
						</div>
      ...
      <div style="border: solid #000 0px; width:500; margin-left:30px; border-radius:5px; margin-top:7px;">
        ...
        <?php
		 ...
		 <div id="printablediv" style="width: 100%;">
          ...
          <h2 align="center" style="margin-top:9px; color:#990033;font-weight:bold;">Session: <?php echo $_POST['session']; ?></h2>
		  <?php if($_POST['class'])
		  {
		  ?>
