...
<div class="full_div">
	    ...
	    <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."studentdetailhome"."&&divid=4"; ?>">Search Student By Class</a>
		</div>				
	 ...
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/studentlist.php?student_class=<?php echo $_POST['class'];  ?>')">     <input type="button" value="Print List " style="width:100px; position:absolute"></a>
	    ...
	    <a href="<?php echo $var."studentdetailhome&did=".$studrow['student_id']; ?>" onClick="return confirmation();">Delete</a>|
