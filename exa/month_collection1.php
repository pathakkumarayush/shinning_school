			...
			<div id="content" style="border:#F00 0px solid; width:990px; height:auto">
                ...
                <a href="./?pageid=fee_managementhome">Fee Management</a>Total fee Colection</a>
				 ...
				 <div class="box-head" style="margin-top:20px; font-size:18px">
					 <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."month_collection1"."&&divid=1"; ?>"><a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."month_collection1"."&&divid=2"; ?>">Toal Fee Collection Monthly By Student</a>
						</div>
