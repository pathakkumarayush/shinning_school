<?php
function sms($sender,$reciever,$sub,$msg,$status,$ses,$page)
{
                 $search=mysqli_query($con,"select * from student where student_session='$ses' and student_school='".$_SESSION['uid']."' and student_id='$reciever'");
...
//$result=mysqli_query($con,"insert into sendmsg(sender,sender_user,reciever,sub,msg,status,date,session,type,class) values('".$sender."','".$_SESSION['uid']."','".$reciever."','".$sub."','".$msg."','".$status."','".$date."','".$_SESSION['session']."','$type','$stdclass')")or die(mysqli_error());	
