...
<center>Non-Teaching Staff Salary , Month - <?php echo $_GET['idpf']; ?></center>
<br />
</td></tr>
    <tr class="box-head" >
  ...
  <?php
		$qry="select * from teacher_sal where session='".$_SESSION['session']."' and month='".$_GET['idpf']."' and st='nonteaching' and pf_per='12'";
