...
<body>
    ...
    <table border="1" cellspacing="0" cellpadding="0" style="font-size:12px; margin-top:25px; font-weight:bold; width:99%;">
		  ...
		  <td colspan="2" align="right">&nbsp;&nbsp;<span>PAY AMOUNT TOTAL</span></td><td>&nbsp;&nbsp;<?php echo $rowfeedetail['fee_deposit']; ?> </td>
		  </tr>
		  
		  <tr style="line-height:25px; font-weight:bold">
		  <td colspan="2" align="right">&nbsp;&nbsp;<span>DUE AMOUNT</span></td><td>&nbsp;&nbsp;<?php echo $rowfeedetail['due']; ?> </td>
		  </tr>
