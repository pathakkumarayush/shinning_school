...
<div class="full_div">
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
         ...
         <th style="width:150px;">computer Education</th>
         <th style="width:100px;">moral</th>
		 ...
		 {
		  $searchs=mysqli_query($con,"select * from other_sub where student='".$studrow['student_id']."' and class='".$studrow['student_class']."' and exam='".$_POST['exam']."' and session='".$_SESSION['session']."'");
		 ...
		 <td >
            <input type="text" name="computer" value="<?php echo $studrows['computer']; ?>" id="computer<?php echo $i;?>" style="width:45px;">
         </td>
		 <td >
            <input type="text" name="moral" value="<?php echo $studrows['moral']; ?>" id="moral<?php echo $i;?>" style="width:45px;">
         </td>
		 
		  <td >
            <input type="text" name="gen_aw" value="<?php echo $studrows['gen_aw']; ?>" id="gen_aw<?php echo $i;?>" style="width:45px;">
         </td>
		 
		 <td >
      <?php if(!empty($studrows['computer']) || !empty($studrows['moral']) || !empty($studrows['gen_aw']) ){ ?>
...
var computer= document.getElementById('computer'+hid).value;
var moral= document.getElementById('moral'+hid).value;
var gen_aw= document.getElementById('gen_aw'+hid).value;
...
var data_str= "cls="+cls+"&idm="+idm+"&exam="+exam+"&computer="+computer+"&moral="+moral+"&gen_aw="+gen_aw;
