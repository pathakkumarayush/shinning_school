...
<div class="col_4" style="margin-top:0px;min-height:330px;">    			
            ...
            <div class="box-head" style="margin-top:20px; font-size:18px">
			  <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."serch_gat_pass"?>">Today  </a>&nbsp;||&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."serch_gat" ?>">Search By Date</a>	 &nbsp;||&nbsp;
           ...
           <table width="99%" border="1" cellspacing="0" cellpadding="0" style=" font-size:14px; margin-left:5px;">
			  ...
			  <th>Out Date Time</th>
				   ...
				   <?php
				   $today=date("Y-m-d");
				   $search=mysqli_query($con,"select * from enquiry_pass where dob='$today'");
