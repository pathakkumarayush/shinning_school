...
<div class="full_div">
       ...
       <div style="width:100%; height:50px; background-color:#FF0000; margin-top:10px;">
		 ...
		 <tr style="color:#FFFFFF; background-color:#006699; line-height:45px;">
		 <th style="width:185px;">STUDENT NAME</th><th style="width:90px;">CLASS</th>
		 <th style="width:90px;">Term</th><th style="width:93px;">GK/WRITING</th><th style="width:93px;">MORAL</th>
		 <th style="width:93px;">CONVER.</th><th style="width:92px;">ART</th> 
		 <th style="width:90px;">GAMES</th><th style="width:90px;">MUSIC</th>
		 <th style="width:91px;">DANCE</th>
		 <th colspan="2"></th> 
		 </tr>
		 </table>
		 </div>
		 ...
		 {
		  $searchs=mysqli_query($con,"select * from other_marks where student='".$studrow['student_id']."' and class='".$studrow['student_class']."' and exam='".$_POST['exam']."' and session='".$_SESSION['session']."'");
		 ...
		 <td><input type="text" name="con" value="<?php echo $studrows['con']; ?>" id="con<?php echo $i;?>" style="width:50px;"></td>
...
var data_str= "cls="+cls+"&idm="+idm+"&exam="+exam+"&art="+art+"&music="+music+"&dance="+dance+"&game="+game+"&moral="+moral+"&gk="+gk+"&con="+con;
...
document.getElementById('con'+hid).value='';
