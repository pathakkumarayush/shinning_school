	...
	<div class="shell"  >
		<div id="main" >
			...
			<div id="content" style="border:#F00 0px solid; width:990px; height:auto">
				...
				<div  style="border:#FF0000 0px solid; height:400px; margin-top:100px">
				 ...
				 <span style="float:right"><a href="./?pageid=feedate" style="color:#FFFFFF; font-size:18px">Back</a></span>
			 ...
			 <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."feecollectionby_date"."&&divid=2"; ?>">Collection By Date</a>&nbsp;||&nbsp;
			    <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."date_rang"?>">Search By Date Range</a>
		...
		<br>
			 ...
			 <table width="100%" border="2" cellspacing="0" cellpadding="0" style=" font-size:14px">
			  ...
			  <td align="center"><a href="view_collection.php?date=<?php echo $studrow['date']; ?>" >View</a> </td>
			  </tr>
			  <?php $i++; } ?>	
