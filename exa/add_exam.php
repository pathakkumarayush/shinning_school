...
<?php
   ...
   {
     $chk=mysqli_query($con,"select * from examination where examination_name='".$_POST['ename']."' and examination_session='".$_SESSION['session']."'");
     if(mysqli_num_rows($chk)<1)
	 {
     $udrec=mysqli_query($con,"update examination set examination_name='".$_POST['ename']."' where examination_id='".$_GET['id']."'");
...
?>
 ...
 <tr bgcolor="#fff">
    ...
    <td align="center "  bgcolor="#6699FF" ><b style="color:#000">View</b></td>
...
while($exa1=mysqli_fetch_array($exa))
{
	    ...
	    <td align="center "><a style="text-decoration:none;" href="./?pageid=examination_schedule&examinationname=<?php echo $exa1["examination_name"]; ?>">View</a></td>
