     ...
     if($_POST['amntdeposit']>$_POST['amt'])
	  {
	   ...
	   $m=date("M");
$acd="Academic Fee";
$query=mysqli_query($con,"insert into fee_detail(session,class,adm_fee,caution,inst_fee,tamnt,due,pay_type,bank_id,acc_id,cheque_no,c_bank,c_bank_add,fee_deposit,date,student,month,latefee,concession,school,receiptno,current_month,remark,extra_amnt,feetype,instalment,tution_fee,tpay)
 values('".$_SESSION['session']."','".$_POST['class']."','".$_POST['admissionfee']."','".$_POST['cautionfee']."','".$_POST['ints']."','".$_POST['amt']."','$due','".$_POST['pay_type']."','".$_POST['bank']."','".$_POST['acc_no']."','".$_POST['cheque_no']."','".$_POST['c_bank']."','".$_POST['c_bank_add']."','".$_POST['amntdeposit']."','$date','".$_POST['student']."','".$_POST['month']."','".$_POST['latefee1']."','".$_POST['concession']."','".$_SESSION['uid']."','$receipt','$m','".$_POST['remarks']."','$extra','$acd','".$_POST['instalment']."','".$_POST['pdue']."','".$_POST['tamtp']."')");
...
$stdcautionrec=mysqli_query($con,"insert into studentcaution(student,class,fee,date,session,totaamnt) values('".$_POST['student']."','".$caustd['student_class']."','".$_POST['cautionfee']."','$date','".$_SESSION['session']."','".$_POST['totalcautionfee']."')");
		...
		$sub="Fee Paid";	
    	$nmsg="Thanks for Paying Fee For the ".$_POST['instalment'].". Received amount".$_POST['amntdeposit'];	
	    ...
	    if(!empty($err))
         ...
         <div class="box-head" style="background-color:#006633">
	<?php /*?>	 <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."pay_fee"."&&divid=1"; ?>">Search Student By Scholar Number</a>
		 &nbsp;||&nbsp;
		 <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."pay_fee"."&&divid=2"; ?>">Search Student By Id</a> <?php */?>
		 <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."pay_fee"."&&divid=3"; ?>">Search Student By Class</a>
		 </div>
		 ...
		 if(!isset($_POST['visible']))
		  {
		  ?>
		 <div style="width:100%; background-color:#999933;">
		 <div style="float:left; width:40%; background-color:#996633">
		 <?php
...
<td><select name="month"  class="select">
		...
		{
	    ?>
		<table style=" margin-left:20px; margin-top:20px; color:#FFFFFF; font-weight:bold">
		<tr>
        <td>Class<span class="textfieldRequiredMsg"></span></td>
        <?php
        $class=mysqli_query($con,"select * from class where school='".$_SESSION['uid']."'");
	    ?>
        <td><select name="class" class="select" style="width:225px" onchange="showStudent(this.value)">
		...
		<?php echo $rclass['class'].$rclass['class_section']; ?>  </option>
        <?php
		}
		?>
        </select>
		...
		<tr>
		  ...
		  <tr>
	      <td>Student Name</td> 
		  <td><select name="stdid" class="select" style="width:225px" onchange="showStudent3(this.value)">
          ...
          $search=mysqli_query($con,"select * from student where student_session='".$_SESSION['session']."' and status='0' and student_class='".$rclass['class']."' 
...
$rclass=mysqli_fetch_array($class2);
				...
				<td> 
				  <select name="instalment" class="select" style="width:225px">
				  <?php
				  for($i=1;$i<=$rowselrec['no_of_inst'];$i++)
				  {
				  ?>
...
<td>&nbsp;</td>
           ...
           <tr>
<td>Month</td>
<td>               <select name="month"  class="select" style="width:225px">
                   <option value="Select Month">Select Month</option>
				    <option value="April">April-Instalment1</option>
                   <option value="July">July</option>
                   <option value="August">August</option>
                   <option value="September">September</option>
                   <option value="October">October-Instalment2</option>
                   <option value="November">November</option>
                   <option value="December">December</option>
                   <option value="January">January-Instalment3</option>
                   <option value="February">February</option>
                   <option value="March">March</option>
                   <option value="May">May</option>
                   <option value="June">June</option>
			 ...
			 <tr> 
		  <td>Date</td>
		  <td><input type="text" name="date" class="tb5" style="width:205px"> dd-mm-yyyy</td>
		  </tr>
		  <tr>
	      <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  ...
		  <tr>  
		  <td></td> <td><input type="submit" name="search7" value="Proceed" style="width:80px"></td>   
		  </tr>
		  <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
		  
		  <tr><td style="font-weight:bold;" colspan="2"><span style="color:#FF9900">Total Fee</span> <?php echo $rclass['class']; ?> &nbsp;-&nbsp;
		
		 <?php $class = $rclass['class']; 
		  $exaw=mysqli_query($con,"select * from definefee  where class='$class'");
          $bal=mysqli_fetch_array($exaw);
		  echo  $bal['amnt'];
		  ?>
		</td>
		</tr>
		...
		<?php
		 ...
		 <div style="float:left;width:59%;background-color:#996633; margin-left:10px; height:400px;">
		 <div id="state-list">
          ...
          <div id="txtHint1">
			   ...
			   <table width="60%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px">
				...
				$rowselrec=mysqli_fetch_array($selrc);
								 ...
								 ?><input type="hidden" name="ints" value="<?php echo $rowselrec['amnt']; ?>" /></td>
								 </tr>   
								 <?php
	...
	$admissionfee=mysqli_query($con,"select * from admission where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."' and class='".$studrow['student_class']."'");
								 ...
								 <td>Admission Fee</td>
								  ...
								  <input type="hidden" name="admissionfee" value="<?php echo $rowadmission['fee']; ?>">
									<?php
						   ...
						   $caution=mysqli_query($con,"select * from cautionfee where class='".$studrow['student_class']."' and session='".$_SESSION['session']."'");
	                        ...
	                        <tr>
									...
									<td><div><?php echo $val1+$duerow['due']+$fine1; ?></div>
									 <input type="hidden" name="tamtp" value="<?php echo $val1+$duerow['due']+$fine1; ?>">
									</td>				
	                                 </tr>     
							...
							<tr>
									...
									<input  type="hidden" name="totpay" value="<?php echo $val1+$duerow['due']+$fine1; ?>">
									</td>
...
<script src="http://code.jquery.com/jquery-latest.js"></script>
                ...
                $('#id_radio2').click(function () {
                      ...
                      $('#tab2').show('fast');
                              ...
                              <table>
							  <tr>
							  <td ><b style="margin-left:75px;">&nbsp;Payment Type</b></td>
							  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							  Case pay <input id="id_radio1" type="radio" name="pay_type" value="Case" checked="checked" /></td>
							     <td>Cheque pay <input id="id_radio2" type="radio" name="pay_type" value="Cheque" /></td>
							     </tr>
							     </table>
...
function getXMLHTTP() { //fuction to return the xml http object
	...
	function getState(bankId) {		
		
		var strURL="findState.php?bank="+bankId;
		var req = getXMLHTTP();
	...
	function getCity(countryId,stateId){		
		...
		if (req) {
			...
			req.send(null);
								...
								<tr>
								<td><b style="margin-left:80px;">Bank Name</b></td>
								<td><select name="bank" onChange="getState(this.value)"  class="select" style="margin-left:110px;width:150px;">
								...
								<tr>
								<td><b style="margin-left:80px;">Account No</b></td>
								<td><div id="statediv"><select name="acc_no" class="select" style="margin-left:110px; width:150px;">
								...
								<tr>
								<td><b style="margin-left:80px;">Parents Cheque No</b></td>
								<td><input type="text" name="cheque_no"  style="margin-left:110px; width:130px;"/>
								</td>
								</tr>
								
								<tr>
								<td><b style="margin-left:80px;">Parents Bank Name</b></td>
								<td><input type="text" name="c_bank"  style="margin-left:110px; width:130px;"/>
								</td>
								</tr>
								
								<tr>
								<td><b style="margin-left:80px;">Cheque date</b></td>
								<td><input type="text" name="c_bank_add"  style="margin-left:110px; width:130px;"/>
								</td>
								</tr>
									 ...
									 else if(!empty($rowcom['combinemonth']))
							   {
								 echo $_SESSION['month1'].",".$rowcom['combinemonth'];
									...
									<td><b style="margin-left:55px;">Amount Deposited</b> <span style="color:#FF0000">*</span></td>
									<td><input type="text" name="amntdeposit" class="tb5" style="width:130px;margin-left:105px;" onKeyPress="return isNumberKey(event)"></td>
								</tr>
								<tr>
								  <td></td>  
								  <td><b style="margin-left:55px;">Remarks <br>&nbsp;<br>&nbsp;</td>
									<td><textarea name="remarks" cols="20" rows="3" style="margin-left:105px;"></textarea></td>
								</tr>
								<tr>
								    
									<td>&nbsp;</td><td>&nbsp;</td>
									<td><input type="submit" name="pay"  style="width:100px; margin-left:173px;" value="Pay Fee"></td>
								</tr>
								</table>
		   ...
		   ?>
		  <td>
<a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/kmps/school/getreceipt.php?id=<?php echo $_SESSION['studentid']; ?>')">
		  <input type="button" value="Genrate Receipt " style="width:200px; margin-left:0px; margin-top:15px" ></a></td>
		  <?php
