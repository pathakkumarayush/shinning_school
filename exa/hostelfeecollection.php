			...
			<div id="content" style="border:#F00 0px solid; width:990px; height:auto">
				...
				<div  style="border:#FF0000 0px solid; height:400px; margin-top:20px">
				   <img src="css/images/hostel.jpg" style="margin-left:20px;height:80px; width:80px"><br />
                    	<span style=" color:#000000; font-size:18px; margin-top:-20px; margin-left:10px">Hostel Fee Collection</span>

                        <div style="border:#900 2px solid; margin-top:10px"></div>
                <a href="./?pageid=transport_home">Transport</a> >>css/images/hostel.jpg</a>
		...
		<?php  } ?>
         ...
         <table border="0" style="margin:10px 0px 0px 20px">
           ...
           <tr>
            ...
            <tr>
            <td>Fee Name<span class="textfieldRequiredMsg">*</span></td>
         ...
         <tr>
            <td>Start Date<span class="textfieldRequiredMsg">*</span></td>
             <td><input type="text" name="class" class="tb5" value="<?php echo $rowselrec['class']; ?>" readonly></td>
          </tr>
          <tr>
              <td>&nbsp;</td>
		    ...
		    <tr>
            <td>End Date<span class="textfieldRequiredMsg">*</span></td>
             <td><input type="text" name="class" class="tb5" value="<?php echo $rowselrec['class']; ?>" readonly></td>
          </tr>
          <tr>
              <td>&nbsp;</td>
		     ...
		     <tr>
            <td>Due Date<span class="textfieldRequiredMsg">*</span></td>
             <td><input type="text" name="class" class="tb5" value="<?php echo $rowselrec['class']; ?>" readonly></td>
          </tr>
