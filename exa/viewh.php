...
{
$id = $_GET['did'];
$query=mysqli_query($con,"DELETE FROM homework WHERE homework_id='$id'");	 
}
?>
<div class="col_4">
...
<table class="table table-bordered" id="sample_1" style="font-size:12px; ">
    ...
    $sql=mysqli_query($con,"select * from  homework where teach_id='".$_SESSION['userid']."' and session='".$_SESSION['session']."'");
	...
	while($row=mysqli_fetch_array( $sql))
	{
		?>
               <tr>
				  ...
				  <td>
	<?php /*?><a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/gps/school/print_id.php?id=<?php echo $row['student_id']; ?>')">
	Print Id Card</a>||<?php */?>
				  <a href="<?php echo $var."edit_admission&upstudid=".$row['student_id']; ?>" target="_blank"></a>
