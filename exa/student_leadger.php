...
<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
			...
			&nbsp;||&nbsp;
			<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."student_leadger"."&&divid=1"; ?>">Search Student Admission No. Wise </a>
			</div>
		...
		<?php
		 ...
		 if((!empty($_GET['divid'])) && ($_GET['divid']==1))
	        ...
	        ?>
		    <table style="margin:20px 20px 0px 0px; margin-left:20px; font-size:16px" >
			<tr><td></td><td><a style="border-radius:5px;padding:5px;color:#FFFFFF; background-color: #FF0066;font-size:15px;border-top-left-radius:7px;border-top-right-radius:7px; text-decoration:none;">Search Student Admission No. Wise</a></td></tr>
			 <tr>
			    <td>&nbsp;</td>
				<td>&nbsp;</td>
			 </tr>
		    <tr>
            <td>Admission No.<span class="textfieldRequiredMsg"></span></td>
	   ...
	   <tr>
	   <td style="font-weight:bold">Religion </td><td><?php echo $rowss['religion']; ?></td>
	   <td style="font-weight:bold">Nationality </td><td><?php echo $rowss['mot']; ?></td>
	   <td style="font-weight:bold">Mother Tongue </td><td><?php echo $rowss['mtongue']; ?></td>
   ...
   Print
    ...
    <a href="<?php echo $var."edit_fee&id=".$rowmemo['id']; ?>"  style="color:#FF0000" target="_blank"> Pay Due</a>
