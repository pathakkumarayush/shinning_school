...
<div class="right_side" style="margin-top:90px;">
        <?php   
        $search=mysqli_query($con,"select * from teacher where uid='".$_SESSION['userid']."' and teacher_session='".$_SESSION['session']."' ");
...
<tr>
<td><b>Sent By - <?php echo $studrow['teacher_name']; ?></b></td>
