...
$term=$_GET['exam'];
$uid=$_GET['student_id'];
$reg=mysqli_query($con,"select * from student where uid='$uid' and student_session='".$_SESSION['session']."'");
$rowstud=mysqli_fetch_array($reg);
?>	
	  
      <div style="width:1050px;height:1530px; border:6px #244357 solid;background-color:#fff">
...
{
?>
<tr style="line-height:40px; font-weight:normal;">
...
<tr style="line-height:48px;" align="center">
...
<tr style="line-height:49px;" align="center">
...
<br clear="all" />
<table border="0" style="width:100%;margin-top:55px; font-size:25px; font-weight:bold;color:#000;">
<tr>
