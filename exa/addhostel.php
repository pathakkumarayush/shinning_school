...
<div id="container">
			...
			<div id="content" style="border:#F00 0px solid; width:990px; height:auto">
				...
				<div  style="border:#FF0000 0px solid; height:400px; margin-top:20px">
				   <img src="css/images/hostel.jpg" style="margin-left:20px;height:80px; width:80px"><br />
                    	<span style=" color:#000000; font-size:18px; margin-top:-20px; margin-left:10px">Add Hostel</span>

                        <div style="border:#900 2px solid; margin-top:10px"></div>
                <a href="./?pageid=hostelhome">Hostel</a> >>Add Hostel</a>
    ...
    <?php
		...
		<?php  } ?>
         ...
         <tr>
            <td>Hostel type<span class="textfieldRequiredMsg">*</span></td>
             <td><input type="text" name="class" class="tb5" value="<?php echo $rowselrec['class']; ?>" readonly></td>
          </tr>
          <tr>
              <td>&nbsp;</td>
		    ...
		    <tr>
            <td>Other Information <br>&nbsp; <br>&nbsp; <br>&nbsp;<br>&nbsp;<br>&nbsp;</td>
          ...
          <tr>
		   ...
		   <tr>
			...
			<br><br>
            <div class="box-head">
						<h2 class="left">View Hostel	 Details</h2>
