...
$res_up=mysqli_query($con,"update student set student_id='".$_POST["sid"]."',student_scholar='".$_POST["scholar"]."',student_name='".$_POST["txtname"]."',student_gender='".$_POST["gender"]."',student_dob='".$_POST["txtdob"]."',student_session='".$_SESSION["session"]."',student_rollno='".$_POST["txtrno"]."',mother_tong='".$_POST['mothertong']."',religion='".$_POST['religion']."',caste='".$_POST['caste']."',pschool='".$_POST['prev_school']."',reason_change='".$_POST['reas_school']."',subj_req='".$_POST['subject']."',is_bro='".$_POST['is_bro']."',b1='".$_POST['b1']."',c1='".$_POST['c1']."',b2='".$_POST['b2']."',c2='".$_POST['c2']."',addmisionfee='$t',student_doj='".$_POST["txtdoj"]."',student_section='".$_POST["section"]."',bus='".$_POST['bus']."',hname='".$_POST['hname']."',std_type='".$_POST['student_type']."',mot='".$_POST['mot']."',student_class='".$_POST['txtclass']."',fid='".$_POST['fid']."',presult='".$_POST['presult']."',fc='".$_POST['fc']."',famt='".$_POST['famt']."',bg='".$_POST['bg']."',ork='".$_POST['ork']."',admb1='".$_POST['admb1']."',admb2='".$_POST['admb2']."',orn='".$_POST['orn']."',ochild='".$_POST['ochild']."',rno='".$_POST['rno']."' where student_id='".$_POST["sid"]."' and student_session='".$_SESSION['session']."'");
...
<input  type="radio" value="Inactive" name="hostel_status" <?php if(!empty($_GET["upstudid"]) && ($rowstud["hostel_status"]=="Inactive") ) { ?> checked="checked"  <?php } ?> checked="checked" >No
		...
		<td>
          ...
          {
		  ?>
		  <option value="<?php echo $rows["name"]; ?>" <?php if($rows["name"]==$rowstud["mot"] ) { ?> selected="selected" <?php }?>> <?php echo $rows["name"]; ?></option>
		  <?php
		  }  
          ?>
          </select>
		  ...
		  <?php
		  if(!empty($rowstud['orn']))
		  {
		  ?>
		
	     <input type="text" name="orn" class="tb5"  value="<?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['orn']; if(isset($_GET["upstudid"])){echo $rowstud["orn"];} ?>"/>
	   ...
	   <tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
	    ...
	    <tr>
		<td>Mother Tongue</td> 
		<td><input type="text" name="mtongue" class="tb5" value="<?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['mtongue']; if(isset($_GET["upstudid"])){echo $rowstud["mtongue"]; } ?>"  ></td>
	    <td>Blood Group</td> 
