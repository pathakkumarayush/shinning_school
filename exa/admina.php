...
{	
$res_up=mysqli_query($con,"update student set rea='".$_POST['rea']."' where student_id='".$_POST["sid"]."' and student_session='".$_SESSION['session']."'");	
?>
<script type="text/javascript">
                    window.location="<?php echo $var."admina&&sumsg=Reason Update Successfully"; ?>";
			       </script>
 <?php
}
   ?>
...
<br clear="all" />
<div class="left_sect"><img src="images/Student Admission.png" /><a href="./?pageid=pro_student">
...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Inactive/Active Student</h2>
</div>
<div class="col_4">
<div class="form-style-2-heading">Inactive Student</div>
  <form method="post" name="myForm" id="myform" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
	  ...
	  <input type="hidden" name="sid" value="<?php echo $_GET["upstudid"]; ?>" />
       <input type="text" name="rea" style="" />
	  </td> 
