...
<div class="col_4" style="margin-top:0px;" >
				<!-- Box -->
				  <div style="margin-left:45px;height:30px;margin-top:15px;">
				 <a href="<?php echo $var."allstda" ?>" style="float:left;margin-left:60px; border-radius:5px;background-color:#cc0000;color:#FFFFFF;font-size:15px;padding:10px;text-decoration:none">Prenursery To UKG</a>
				  ...
				  <div style="margin-left:50px;">
				   ...
				   <hr />
				   <?php $res_msg1=mysqli_query($con,"select count(id) from sendmsg where reciever='".$_SESSION[userid]."'  and is_read='0'")or die(mysqli_error());
				  ...
				  <div class="sms_l">
				  <a href="./?pageid=message_inbox">Inbox <?php if($row_msg1['count(id)']>0) { ?> 
<span style="color:#FFF">&nbsp;<?php  echo  "(".$row_msg1['count(id)'].")"; ?> </span> <?php }  ?></a>
				  </div>
				 ...
				 <div class="sms_l">
				  ...
				  <a href="./?pageid=allstd">All Student1</a>
				   ...
				   <div class="sms_l">
				   <a href="./?pageid=homeworkadd">Homework</a></div>				 
				   </div>
 ...
 <tr>
   ...
   <td>
   <?php
   $query1=mysqli_query($con,"select count(teacher_id) from teacher where teacher_school='".$_SESSION['uid']."' ");
 ...
 ?>
				 ...
				 <div style="width:975px; height:180px; border:20px #339966 solid; ">
				 <div style="width:967px; height:172px; border:4px #CC0000 solid; ">
				  <?php
...
while($rows=mysqli_fetch_array($res))
{
	...
	{
?>
<label style="width:auto" onclick="window.location='./?pageid=classwise&class=<?php echo $rows["class"]."&section=".$rows['class_section'];; ?>'" class='cla'>
<?php echo $rows["class"].$rows['class_section']; ?>
</label>
<?php
	}
	else
	{
?>
<label style="border:#FF0000 0px solid; width:auto"  onclick="window.location='./?pageid=classwise&class=<?php echo $rows["class"]."&section=".$rows['class_section']; ?>'" class='cla1'>
<?php echo $rows["class"].$rows['class_section']; ?>
</label>
<?php
	}
