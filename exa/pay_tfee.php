...
function add(a)
{
z=document.getElementById("tamount").value;
...
function concess()
{
b1=document.getElementById("tamount").value;
...
if(!empty($_SESSION['sumsg']))
{
  unset($_SESSION['sumsg']);
				...
				*/
				...
				$distinctmonth=mysqli_query($con,"select distinct(month) from fee_detail_trans where student='".$studrow['student_id']."' and school='".$_SESSION['uid']."' and session='".$_SESSION['session']."'");
...
$search=mysqli_query($con,"select * from fee_detail_trans where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."' and student='".$studrow['student_id']."'");
...
if((!empty($_POST['latefee1']))|| (!empty($_POST['concession'])) )
{
	 ...
	 $_POST['amt']=$_POST['amt']-$_POST['concession'];
	  ...
	  if($_POST['montha']=='April,October,January')
	  {
	  $instn='Instalment1,Instalment2,Instalment3';
	  }
	  
	  if($_POST['montha']=='April,October')
	  {
	  ...
	  if($_POST['montha']=='April,January')
	  {
	  $instn='Instalment1,Instalment3';
	  }
	  ...
	  $m=date("M");
$receptno=mysqli_query($con,"select * from fee_detail_trans where receiptno='".$_POST['srecipt']."' and session='".$_SESSION['session']."'");
if(mysqli_num_rows($receptno)<1)
{

$query=mysqli_query($con,"insert into fee_detail_trans(session,class,adm_fee,caution,inst_fee,tamnt,tpay,due,pdue,pay_type,fee_deposit,month,student,date,latefee,concession,school,receiptno,current_month,instalment,
extra_amnt,remark,cno,cd,padv)
values('".$_SESSION['session']."','".$_POST['class']."','".$_POST['admissionfee']."','".$_POST['cm']."','".$_POST['inst_fee']."','".$_POST['amt']."',
'".$_POST['tamount']."','$due','".$_POST['pdue']."','".$_POST['ftype']."','".$_POST['amntdeposit']."','".$_POST['montha']."','".$_POST['student']."','$date','".$_POST['latefee1']."','".$_POST['concession']."','".$_SESSION['uid']."','".$_POST['srecipt']."','$m','$instn','$extra','".$_POST['remarks']."','".$_POST['cno']."','".$_POST['cd']."',
'".$_POST['padv']."')");
		...
		$update=mysqli_query($con,"update fee_detail_trans set admissionfee='Yes' where id='$insertid' and school='".$_SESSION['uid']."'");
		} 
...
#div2{ display:none;}
 ...
 <div class="full_div">
		...
		<a href="./?pageid=pay_tfee" style="color:#FFFFFF;float:right; background-color:#009966; margin-top:10px; padding:6px; font-size:18px">Pay Tution Fee</a>
        </div>
<div class="col_4">
	...
	<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return validateForm()" >
		  ...
		  <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."pay_tfee"."&&divid=3"; ?>">Search Student By Class</a>
          ...
          $search=mysqli_query($con,"select * from student where student_session='".$_SESSION['session']."' and status='0' and rti='No' and transport_status='Active' 
		  and student_class='".$rclass['class']."' order by student_name Asc");
		  ...
		  <td> 
		  <div id="txtHint2">
		  <input type="checkbox" name="month1[]" value="April"><span style="color:#fff; font-weight:bold">Instalment1</span>-April<br>
		  <input type="checkbox" name="month1[]" value="October"><span style="color:#fff; font-weight:bold">Instalment2</span>-October <br>
          <input type="checkbox" name="month1[]" value="January"><span style="color:#fff; font-weight:bold">Instalment3</span>-January <br>
		  <input type="checkbox" name="month1[]" value="March"><span style="color:#fff; font-weight:bold">Instalment4</span>-March <br>
          </div>
		  </td>
		  ...
		  <tr><td style="font-weight:bold;" colspan="2"><span style="color:#FF9900">
		 ...
		 <div id="state-list">
		  ...
		  <td>
		  <?php
		  $maxid=mysqli_query($con,"select max(receiptno) from fee_detail_trans where school='".$_SESSION['uid']."'");
		  $rowid=mysqli_fetch_array($maxid);
		   $rowid['max(receiptno)']+1; 
		  ?>
		  <input type="text" name="srecipt" style="width:75px"  value="<?php echo $rowid['max(receiptno)']+1; ?>"required/>
		  </td>
		  <td>Month</td>
		  <td>
		  <?php
		  ...
		  <?php
		  $i=1;
		  $selrc=mysqli_query($con,"select * from trans_instdetail where stop_name='".$studrow['transport_stopage']."' and session='".$_SESSION['session']."' and month='$m'");
		  ...
		  <td><b><?php   $search1=mysqli_query($con,"select * from fee_detail_trans where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."' 
...
?>
<td>
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/kmps/school/getreceipt_trans.php?id=<?php echo $_SESSION['studentid']; ?>')">
