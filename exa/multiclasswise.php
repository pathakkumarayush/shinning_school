...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Sens Message - class wise </h2>
</div>
<div class="col_4" style="margin-top:0px; min-height:2000px;" >
  ...
  <div style="width:95%; height:100px; border:1px solid black" id="msg" >
   ...
   <input type="text" id="m_1" style="border: 1px solid black; height:70px; margin-left: auto; width: 250px;">
 	...
 	<table style="margin:30px 0px 0px 70px; font-size:14px; width:300px">
         ...
         <tr>
			 ...
			 ?>
            <td> <select id="Place" name="class[]" multiple="multiple" class="xyz">
   ...
   <tr valign="top"><td style="border:none;">
    ...
    <div id="secstud">
				...
				{
                    ?>
                    <table cellpadding="10" cellspacing="1" style="width:126%">
   ...
   <input type='checkbox' value='on' id='chkall' name='allbox' onclick='checkAll();'/>
                        ...
                        <th><strong style="color:black">Name</strong></th>
                        <th><strong style="color:black">Father Name</strong></th>
                        <th><strong style="color:black">Class</strong></th>
						<th><strong style="color:black">Mobile</strong></th>
                    </tr>
                </thead>
                <tbody>
                <?php
                   ...
                   $qu = $query . " WHERE student_class in (" . $selectedOption . ")";
...
//echo 'jmd' .$qu;
			//	print_r($result);
				...
				$result = mysqli_query($con,$query . " WHERE student_class in (" . $selectedOption . ")");
$x=1;
while ($row = mysqli_fetch_array($result, mysqli_NUM)) { ?>
	<tr>
	 <td align="center"><input type="checkbox" name='formDoor[]' value="<?php printf($row[1]); ?>"  id='chk<?php echo $i; ?>' /></td>
<td>&nbsp;<?php echo $x++; ?></td>
   <td><?php  printf($row[5].'<br>'); ?> </td>
    <td><?php printf($row[7].'<br>'); ?></td>
                        <td><?php printf($row[16].'<br>'); ?></td>
   <td><?php printf($row[10].'<br>'); ?></td>
   </tr>
...
function gets(s)
{
	...
	{
		mymsg = "your child NAME has been found coming to school late. Kindly ensure that NAME always comes in time.";
	}
	...
	{
		var m_1=document.getElementById('m_1').value;
		mymsg ="<?php echo $_SESSION['school_name']." "; ?>Wish you a "+m_1+".";
	}
   ...
   else if(subs=="Christmas Wishing Message")
	{
		...
		mymsg ="Goenka Public School Christmas Holidays from d_1 to d_2.";
	}
	...
	else if(subs=="monthly test")
	{
	    var d_1=document.getElementById('d_1').value;
		mymsg ="Your child monthly test will be held on "+d_1+".";
	}
		else if(subs=="Wishing Message Takshila")
	{
	    var m_1=document.getElementById('m_1').value;
		mymsg ="Takshila wishes a very "+m_1+".";
	}
	...
	else if(subs=="child is absent btmhs")
	{
	    var d_1=document.getElementById('d_1').value;
		mymsg ="Your child NAME is absent on "+d_1+". This is for your information.";
	}
	else if(subs=="child is absent takshila")
	{
	    var d_1=document.getElementById('d_1').value;
		mymsg ="Your child is absent since "+d_1+". kindly inform the school regarding reasons for the same.";
	}
	else if(subs=="child is absent grace")
	{
	    var d_1=document.getElementById('d_1').value;
		mymsg ="Your child is absent since "+d_1+". kindly inform the school regarding reasons for the same.";
	}
	else if(subs=="long absent btmhs")
	{
	    var d_1=document.getElementById('d_1').value;
		var d_2=document.getElementById('d_2').value;
		mymsg ="Your child NAME is absent from "+d_1+" to "+d_2+" be are concerned. Please advise reasons. thanks";
	}
	else if(subs=="student coming to school late btmhs")
	{
	    var d_1=document.getElementById('d_1').value;
		mymsg ="your child NAME Late to school on d_1 please come on time.";
	}
	else if(subs=="student coming to school late btmhs")
	{
	    var d_1=document.getElementById('d_1').value;
	...
	{
	    var d_1=document.getElementById('d_1').value;
		mymsg ="This is to inform "+d_1+". ";
	}
	else if(subs=="Transport Message")
	{
	    var d_1=document.getElementById('d_1').value;
		var t_1=document.getElementById('t_1').value;
		var t_2=document.getElementById('t_2').value;
	  mymsg ="Please send your child on your own vehcle on "+d_1+" because school bus wil not be operative  "+t_1+" due to "+t_2+". ";
	}
	else if(subs=="Information Message Btmhs")
	{
	    var d_1=document.getElementById('d_1').value;
		mymsg =""+d_1+"";
	}
	else if(subs=="takshila Information Message")
	{
	    var d_1=document.getElementById('d_1').value;
	   mymsg =""+d_1+"";
	}
...
<br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all">