...
if(!empty($_GET['id']))
{
$getdetail=mysqli_query($con,"select * from fee_detail_trans  where id='".$_GET['id']."' and school='".$_SESSION['uid']."' and session='".$_SESSION['session']."'");
		...
		<?php
         ...
         <div class="table" style="border:#FF0000 0px solid; height:autopx; margin:1px 0px 0px 2px">
		  ...
		  <td>&nbsp;&nbsp;Stop Name</td><td>&nbsp;&nbsp; <?php echo $rowstud['transport_stopage']; ?></td>
		   ...
		   <tr>
		  <td>&nbsp;&nbsp; <?php echo $rowfeedetail['instalment']; ?>-Fee</td><td>&nbsp;&nbsp; <?php echo $rowfeedetail['inst_fee']; ?></td>
		  </tr>
		   <?php
