...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">MOTOR SKILLS</h2>
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
		 ...
		 <table style="width:100%;color:#000000">
		    ...
		    <tr style="color:#FFFFFF;text-align: center; background-color:#006699;">
             <th style="padding: 10px;">STUDENT NAME</th><th style="width:104px;">CLASS</th><th style="width:95px;">Exam</th>
              <th>WORKING WITH CLAY</th>
              <th >DRAWING COLOURING PAINTING</th>
			  <th >PUZZLES AND GAMES</th>
			  <th >EYE HAND CO-ORDINATION</th>
			  <th >PARTICIPATION IN INDOOR GAMES</th>
			  <th >RHYTHMIC DANCING</th>
			  <th >EXERCISES</th>
             <th colspan="2">Action</th>
            </tr>
            </thead>
		 ...
		 {
		  $searchs=mysqli_query($con,"select * from motor_skill where student='".$studrow['student_id']."' and class='".$studrow['student_class']."' and exam='".$_POST['exam']."' and session='".$_SESSION['session']."'");
