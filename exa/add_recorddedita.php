...
mysqli_query($con,"update life_skills11 set critical='$critical',decision='$decision',selfa='$selfa',creative='$creative',prob='$prob',coping='$coping',emotions='$emotions'
where student='".$_POST["idm"]."' and class='".$_POST["cls"]."' and exam='".$_POST['exam']."' and ls='".$_POST['ls']."'");
