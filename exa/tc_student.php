...
<script type="text/javascript">
		function popitup(url) 
		{
	     ...
	     return false;
			  ...
			  $query1=mysqli_query($con,"delete from tc where sid='".$_GET['tid']."'");	 
              }
			  ?>
...
<div class="full_div">
	 ...
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('http://localhost/manorama/school/studentlist.php?student_class=<?php echo $_POST['class'];  ?>')">     <input type="button" value="Print List " style="width:100px; position:absolute"></a>
	...
	<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/get_tc.php?id=<?php echo $studrow['student_id']; ?>')">Print</a>
	<td>
	</td> 
        </tr>
    <?php
