...
mysqli_query($con,"update personality set confidant='$confidant',polite='$polite',reponsible='$reponsible',decipline='$decipline',regular='$regular',appe='$appe',sans='$sans'
