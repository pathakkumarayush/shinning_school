...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:15px; margin-top:15px;">Update Dairy </h2>
...
<?php
  ...
  ?>
    ...
    <tr>
	  ...
	  {
	  ?> 
	  <option value="<?php echo $subrow["sub"];  ?>" <?php if($subrow["sub"]==$rowc["subject_id"] ) { ?> selected="selected" <?php }?>><?php echo  $subrow["sub"] ?> -- <?php echo $subrow["class"]; ?></option>
