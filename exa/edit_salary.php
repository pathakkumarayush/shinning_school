...
$res_up=mysqli_query($con,"update teacher_sal set teacher='".$_POST["enm"]."',sal_rec='".$_POST["net"]."',cur_sal='".$_POST["ptot"]."',cl='".$_POST["cl"]."',absent='".$_POST["abs"]."',pf_ded='".$_POST["pf"]."',month='".$_POST["month1"]."',session='".$_SESSION['session']."',workingd='".$_POST["wd"]."',esi='".$_POST["esi"]."',esi_per='".$_POST["agesi"]."',hra='".$_POST["hra1"]."',act_hra='".$_POST["hra"]."',conv='".$_POST["con1"]."',act_conv='".$_POST["con"]."',it_pt='".$_POST["it_pt1"]."',act_itpt='".$_POST["apt"]."',basic='".$_POST["tot1"]."',act_basic='".$_POST["basic"]."',adv='".$_POST["adv"]."',dect='".$_POST["dect"]."',cla='".$_POST["cla"]."',st='".$_POST["st"]."',allow='".$_POST["allow"]."',ac_allow='".$_POST["allow1"]."',pf_per='".$_POST["agpf"]."',retcmon='".$_POST["secpay"]."' where id='".$_POST["eid"]."'");

?>
 <script type="text/javascript">
             window.location="<?php echo $var."salarydetail&&sumsg=Updated Successfully&eid=".$_POST["eid"]; ?>";
 </script>
<?php
}
else
...
?> 
<?php
$qry1="select * from teacher where teacher_id='$tech'";
...
?> 
		  ...
		  <tr>
		   ...
		   <tr>
		   <td>Employee Name</td>
		   <td><input name="enm" type="text"  size="40" class="tb51" value="<?php echo $row["teacher"]; ?>" style="width:20px;" />
		    <input name="" type="text" class="tb51" value="<?php echo $row1["teacher_name"]; ?>" style="width:160px;"/>
		   <input name="st" type="hidden"  size="40" class="tb51" value="<?php echo $row["st"]; ?>" />
		   ...
		   <tr>
			 ...
			 <td>Absent</td>
			 <td><input type="text" name="abs" class="tb521" id="txt2" onkeyup="getValues(1)" style="width:110px;" value="<?php echo $row["absent"]; ?>"/>
		  ...
		  <tr>
			 ...
			 <td>Amount</td>
			 <td><input type="text" id="tot1" name="tot1" class="tb51"   readonly="readonly" value="<?php echo $row["basic"]; ?>" /></td>
			  <td>Pf</td>
			  <td><input type="text" name="pf" id="pf" class="tb521"  readonly="readonly" value="<?php echo $row["pf_ded"]; ?>" /></td>
		  </tr>
		   ...
		   <tr>
			  ...
			  <td>Hra Amount</td>
			  <td><input name="hra1" type="text" id="hra1" class="tb51"   size="40"  readonly="readonly" value="<?php echo $row["hra"]; ?>" /></td>
			  <td>Esi</td>
			 ...
			 <td>Other Allowance</td>
			 <td><input name="allow1" type="text" id="allow1" class="tb51"   size="40" readonly="readonly" value="<?php echo $row["ac_allow"]; ?>" /></td>
			  <td>Security</td>
			  <td><input name="secpay" type="text" id="secamt"  class="tb51" placeholder="Add SecurityAmount" value="<?php echo $row["retcmon"]; ?>" style="width:150px;" /> 
		    ...
		    <tr>
			 ...
			 <td>Conveyance</td>
			 <td><input name="con1" type="text" id="con1" class="tb51"   size="40" readonly="readonly" value="<?php echo $row["conv"]; ?>"/></td>
			  <td>Total <?php $gt = $row["basic"]+$row["conv"]+$row["ac_allow"]+$row["hra"];?></td>
			  <td><input name="tot2" type="text" id="tot2" class="tb521"   size="40" readonly="readonly" value="<?php echo $gt-$row["pf_ded"]; ?>"/>
			  <input name="it_pt1" id="it_pt1" class="tb521"  readonly="readonly"  type="hidden" /></td>
		   </tr>
		  
		    <tr>
		     <td>Total Amount</td>
			 <td><input type="text" id="ptot" name="ptot" class="tb51"  readonly="readonly"    value="<?php echo $row["cur_sal"]; ?>"/></td>
			 <td>Grand total</td>
<td><input name="gt" type="text" id="gt" class="tb51"   size="40" readonly="readonly" value="<?php echo $gt; ?>"/></td>
			   <?php
			 if($row['pf_per']=="12")
			 {
			 ?>
...
?>
<input name="adv" type="text" id="adv" class="tb51" style="width:155px;" value="<?php echo $row["adv"]; ?>" placeholder='Advance Money - <?php echo $ttp-$adrow['sum(adv)']; ?>' />
...
<td>Add CL</td>
<td>
<input name="cla" type="text" id="cla"  class="tb51" placeholder="Add CL Amount" style="width:158px;" value="<?php echo $row["cla"]; ?>"/> 
<input type="button" name="Add" value="cal" onClick="addTwoNumber5()"/>
</td>
		  
<td>Net</td>
<td><input name="net" type="text" id="net" class="tb521"   size="40" readonly="readonly" value="<?php echo $row["sal_rec"]; ?>"/></td>
</tr>
