...
<div class="col_4" style="margin-top:0px; min-height:335px;" >
		...
		<form name="f3" method="post" action="" style=" margin-left:50px;" >
		<table width="891" height="167" border="0">
          <tr  class="box-head" >
            <td colspan="3" align="center" >Change Book Limit</td>
            </tr>
			<?php
		...
		?>
          <tr class="table" >
            ...
            <td width="479"><input class="tb5" type="text" name="limit" value="<?php echo $limit; ?>" /></td>
          </tr>
          <tr class="table" >
            <td>&nbsp;</td>
            <td>&nbsp;</td>
...
$qry1="update variables set book_limit='$limit' ";
