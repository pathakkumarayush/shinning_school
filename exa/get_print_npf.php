...
<center>Teaching Staff Salary , Month - <?php echo $_GET['idn']; ?></center>
<br />
</td></tr>
    <tr class="box-head" >
  ...
  <?php
		$qry="select * from teacher_sal where session='".$_SESSION['session']."' and month='".$_GET['idn']."' and st='teaching' and pf_type='No'";
...
<tr><td colspan="20"><b>&nbspIn Words&nbsp;-<?php echo convert_digit_to_words($tnnt); ?> Only.</b></td></tr>
	  </table>
