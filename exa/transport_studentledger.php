 ...
 if(isset($_POST['search1']))
				{
				 ...
				 $memo=mysqli_query($con,"select * from fee_detail where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."' and student='".$studrow['student_id']."' and feetype='$feetyp' ");
...
<div id="container">
			...
			<div id="content" style="border:#F00 0px solid; width:990px; height:auto">
                ...
                <a href="./?pageid=fee_managementhome">Fee Management</a> >>Student Ledger</a>
                 <form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
                    ...
                    <div class="box-head">
						 <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."studentledger"."&&divid=1"; ?>">Search Student By Scholar Number</a>&nbsp;||&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."studentledger"."&&divid=2"; ?>">Search Student By Id</a>&nbsp;||&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."studentledger"."&&divid=3"; ?>">Search Student By Class</a>
				   </div>
            <?php
   ...
   <td><?php echo $rowmemo['tamnt'];?></td>
	...
	<td><?php echo $rowmemo['session'];?></td> 
	 ...
	 <td><a href="<?php echo $var."ledgerdetail&edit_id=1&id=".$rowmemo['id']; ?>">Edit</a></td>
	 <td><a href="<?php echo $var."studentledger&did=".$rowmemo['id']."&stdid=".$studrow['student_id']; ?>" onclick="confirmation();">Delete</a></td> 
        </tr>
    <?php
    $i++;
	}
