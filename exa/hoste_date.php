...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Student Tution Fee Collection by date </h2>
...
<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
            ...
            <div class="box-head" style=" font-size:18px">
			  <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."hoste_date"."&&divid=1"; ?>">Today Collection</a>&nbsp;&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."hoste_date"."&&divid=2"; ?>">Collection By Date</a>	
			  &nbsp;&nbsp;   
			</div>
      ...
      <div style="border: solid #000 0px; width:500; margin-left:30px; border-radius:5px; margin-top:7px;">
		 ...
		 ?>
		   ...
		   <div id="printablediv" style="width: 100%;">
		    <h2 align="center" style="margin-top:9px; color:#990033">Kabra Memorial Public School</h2>
                   <h2 align="center" style="margin-top:9px; color:#990033">Hostel Fee - Session: <?php echo $_SESSION['session']; ?></h2>
         ...
         <?php
	      ...
	      ?>
		   ...
		   <table width="72%" border="1" cellspacing="0" cellpadding="0" style="margin:10px 0px 0px 120px; font-size:14px">
			...
			$today=date("Y-m-d");
			  $search=mysqli_query($con,"select * from fee_detail_hostel where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."'  and date='".$today."'");
	   ...
	   <h2 align="center" style="margin-top:9px; color:#990033">Date: <?php echo date("d-m-Y",strtotime($_POST['date'])); ?></h2>
		   <table width="90%" border="1" cellspacing="0" cellpadding="0" style="margin:10px 0px 0px 50px; font-size:14px">
			  ...
			  $search=mysqli_query($con,"select * from fee_detail_hostel where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."'  and date='".$_POST['date']."'");
