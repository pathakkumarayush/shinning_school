...
<table id="tbl_exm" width="100%" border="1" cellspacing="0" cellpadding="0">
 ...
 <tr align="center">
         ...
         <span align="center" style="margin-top:9px; color:#006633;font-weight:bold;">FEE DEFAULTER ALL CLASS  Session: <?php echo $_GET['ses']; ?></span><br />
	...
	$search=mysqli_query($con,"select * from student where student_session='".$_GET['ses']."' and status='0' order by student_class asc");
		...
		$instd=mysqli_query($con,"select * from instdetail where month='".$_GET['month']."' and session='".$_GET['ses']."' and class='".$studrow['student_class']."'");
