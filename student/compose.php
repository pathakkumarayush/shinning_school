...
<style type="text/css">
.succ{ width:300px; background-color:#FF0000; color:#FFFFFF; margin-left:50px; line-height:25px;border-radius:4px;}
...
<a href="./?pageid=compose" style="background-color:#EF7F1A; padding-left:7px; padding-right:7px; padding-bottom:2px; padding-top:2px; border-radius:4px; border:#FFFFFF solid; color:#FFFFFF;margin-left:10px;">Doubt/Compose Msg</a>
...
<div class="fee_main" style="">
       ...
       <?php if(($_GET['list']=='sendmessages') || ($_GET['list']=='')) { ?>
		  ...
		  $logo3=mysqli_fetch_array($logo2);
		   ...
		   $ctech=mysqli_query($con,"select * from class_teacher where class='".$logo3['student_class']."'");
          ...
          <td width="200">
		  <div style="height:80px; width:330px; overflow:scroll">
	      <input type="checkbox" value="acsss" name="receiver[]">School Admin<br>
          <input type="checkbox" value="<?php echo $row_teach['uid']; ?>" name="receiver[]"><?php echo ucwords($row_teach['teacher_name']); ?> - Class Teacher<br>
