...
?>
       <?php   
		...
		?>
<?php
$res_msg=mysqli_query($con,"select * from sendmsg where reciever='$std_id' and id='".$_GET['id']."'")or die(mysqli_error());
$row_msg=mysqli_fetch_array($res_msg);
$updmsg=mysqli_query($con,"update sendmsg set is_read='1' where reciever='$std_id' and id='".$_GET['id']."' ");
?>
<div id="container">
<div class="shell">
...
<li><a href="./?pageid=online_study">Online Studay</a></li>
<li><a href="./?pageid=attandance">Attendance</a></li>
...
<li style="background-color:#999900"><a href="./?pageid=inbox">Message In-Box</a></li>
<li><a href="./?pageid=compose">Doubt/Compose Msg</a></li>
<li><a href="./?pageid=sentbox">Message Sent-Box</a></li>
</ul>
...
<a  style="background-color:#999900; padding-left:7px; padding-right:7px; padding-bottom:2px; padding-top:2px; border-radius:4px; border:#FFFFFF solid; color:#FFFFFF;margin-left:10px;" href="<?php echo $var."inbox"; ?>">Message In-Box <?php if($row_msg11['count(id)']>0) { ?> 
...
<tr>
<td><div  style="width:295px; height:auto;"><?php echo $row_msg['msg']; ?></div></td>
<td>&nbsp;</td>
</tr>
<tr>
<td>&nbsp;</td>
