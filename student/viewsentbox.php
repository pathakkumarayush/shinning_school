...
<?php
$res_msg=mysqli_query($con,"select * from sendmsg where sender_user='".$_SESSION['userid']."' and id='".$_GET['id']."'")or die(mysqli_error());
...
<li ><a href="./?pageid=inbox">Message In-Box</a></li>
<li><a href="./?pageid=compose">Doubt/Compose Msg</a></li>
<li style="background-color:#999900"><a href="./?pageid=sentbox">Message Sent-Box</a></li>
</ul>
...
<a href="" style="background-color:#999900; padding-left:7px; padding-right:7px; padding-bottom:2px; padding-top:2px; border-radius:4px; border:#FFFFFF solid; color:#FFFFFF;margin-left:10px;">Message Sent-Box</a>
...
<?php
 ...
 {
 ?>
<a href="<?php echo $var."sentbox"?>"><img src="images/wpe93e59c3.png" style="width:120px; height:40px; float:right"></a>
 <?php
 }
?>
...
<tr>
<td><b>Sent By - <?php echo $studrow['student_name']; ?></b></td>
