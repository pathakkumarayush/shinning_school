...
{
$st="Active";
$query=mysqli_query($con,"insert into teacher(teacher_id,teacher_name,teacher_gender,teacher_dob,teacher_doj,teacher_qualifi,email,teacher_dom,teacher_school,staff_typ,address,
contact,father_name,status,deduction,secmon,sname,designation,role,eno)values('".$_POST['eid']."','".$_POST['txtname']."','".$_POST['gender']."','".$_POST['txtdob']."','".$_POST['txtdoj1']."','".$_POST['select']."','".$_POST['mrt']."','".$_POST['txtdom2']."','".$_SESSION['uid']."','".$_POST['typ']."','".$_POST['add']."','".$_POST['cont']."',
'".$_POST['fnm']."','$st','".$_POST['deduction']."','".$_POST['secmony']."','".$_POST['sname']."','".$_POST['designation']."','".$_POST['role']."','".$_POST['eno']."')");
...
{
$upd_rec=mysqli_query($con,"update teacher set teacher_name='".$_POST['txtname']."',teacher_gender='".$_POST['gender']."',teacher_dob='".$_POST['txtdob']."',teacher_doj='".$_POST['txtdoj1']."',teacher_qualifi='".$_POST['select']."',maritial_status='".$_POST['mrt']."',teacher_dom='".$_POST['txtdom2']."',teacher_school='".$_SESSION['uid']."',staff_typ='".$_POST['typ']."',pan='".$_POST['pan']."',address='".$_POST['add']."',contact='".$_POST['cont']."',father_name='".$_POST['fnm']."',deduction='".$_POST['deduction']."', 
secmon='".$_POST['secmony']."',sname='".$_POST['sname']."',designation='".$_POST['designation']."',role='".$_POST['role']."',eno='".$_POST['eno']."'
...
<td>
<input type="radio" name="deduction"  value="Yes" />Yes
<input type="radio" name="deduction"  value="No" checked="checked"/>No
<input type="text" name="secmony" placeholder='Amount' style="width:130px;"/>
</td>
</tr>
<tr class="table">
...
<td>Security Money</td>
<td>
<input type="radio" name="deduction" id="input"  value="Yes"  checked="checked"<?php if($rowteacher['deduction']=="Yes")  { ?> checked="checked"  <?php }   ?> />
<label class="check_label">Yes</label>
<input type="radio" name="deduction" id="input" value="No" <?php if($rowteacher['deduction']=="No") { ?> checked="checked"  <?php } ?> />
<label class="check_label" >No</label>
<input type="text" name="secmony" placeholder='Amount' value="<?php echo $rowteacher['secmon']; ?>" style="width:130px;"/>
