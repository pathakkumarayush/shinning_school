...
require_once("../db.php");
$_POST["student_id"];
$exa=mysqli_query($con,"select * from fee_detail_hostel where student='".$_POST["student_id"]."'");
...
$total=mysqli_query($con,"select * from definefee_hostel  where class='$cls'");
...
<tr><td style="color:#CCCC33">Concession </td><td><?php echo $tcon; ?></td><td style="color:#CCCC33">Fine (Late Fee) </td><td><?php echo $tfine; ?></td></tr>
                  ...
                  <?php
		          $shkstd=mysqli_query($con,"select * from fee_detail_hostel where student='".$_POST["student_id"]."'");
