...
{	
$res_up=mysqli_query($con,"update teacher set status='".$_POST['status']."',rea='' where teacher_id='".$_POST["tid"]."' and teacher_session='".$_SESSION['session']."'");	
?>
<script type="text/javascript">
                    window.location="<?php echo $var."adminatt&&sumsg=Update Successfully"; ?>";
			       </script>
 <?php
}
   ?>
