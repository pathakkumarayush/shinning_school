...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			 ...
			 <div style="border:#CCC 2px solid; min-height:400px; width:550px; margin:0px 0px 0px 40px; background:#ACFBB6">
		...
		<img src="css/images/<?php echo $rowsch['school_logo']; ?>" width="350" height="50" style="border:#FF0000 0px solid; margin-top:10px; margin-left:30px">
		
		<label style="font-size:16px; font-weig	ht:bold;  margin-left:120px; margin-top:20px"><?php echo ucwords($rowsch['school_address']); ?></label><br>
		...
		?>
			 ...
			 { ?>
						...
						<tr>
							  <td></td>
							  <td>Arrears/Fine</td>
							  <td><?php echo $_SESSION['fine']+$rowfeedetail['latefee']; ?></td>
							 </tr>
