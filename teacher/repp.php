...
<center><h2 style="text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Search Students Details</h2></center>
</div>
<?php
if(!empty($_GET['did']))
{
		...
		?>
               <tr>
				 ...
				 <?php /*?> <td>
				  ...
				  <a href="<?php echo $var."edit_admission&id=".$row['student_id']; ?>" target="_blank">Edit</a>
