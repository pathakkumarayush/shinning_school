...
<div id="dvContainer">
    <?php
    $qry="select * from teacher_sal where session='".$_SESSION['session']."' and st='teaching' and pf_type='Yes' and month='".$_GET['id']."' ";
  ...
  <div style="width:550px; height:450px; border:4px #000000 solid; ">
