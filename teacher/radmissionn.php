...
?>
 <script type="text/javascript">
             window.location="<?php echo $var."radmissionn&&sumsg=Updated Successfully&upstudid=".$_POST["sid"]; ?>";
 </script>
 <?php
}
   ?>
...
subj_req,f_prof,f_quali,f_off_add,f_tell_no_off,m_name,m_work,m_prof,m_off_add,m_off_tel,m_quali,is_bro,b1,c1,b2,c2,is_medi,addmisionfee,rti,student_doj,tc,marksheet,adm_class,std_type,hname,bus,mot,hostel_status,pr_no,presult,fc,famt,date,memail,pn,dimg,aimg,simg) values(' $maxv','".$_POST["scholar"]."','".$_POST["txtrno"]."','".$_POST["txtname"]."','".$_POST["gender"]."','".$_POST["txtfatname"]."','".$_POST["txtdob"]."','".$_POST["txtmobile"]."','".$_POST["femail"]."','".$_POST["address"]."','".$_POST["fid"]."','".$_SESSION["uid"]."','".$_SESSION["session"]."','".$_POST["txtclass"]."','".$_POST["section"]."','$file_name3','$stdid','".$_POST['mothertong']."','".$_POST['religion']."','".$_POST['caste']."','".$_POST['prev_school']."','".$_POST['reas_school']."','".$_POST['subject']."','".$_POST['fprofession']."','".$_POST['fqualification']."','".$_POST['oaddress']."','".$_POST['offadd']."','".$_POST['m_name']."','".$_POST['mype']."','".$_POST['mprofession']."','".$_POST['moaddress']."','".$_POST['mofftel']."','".$_POST['mqualification']."','".$_POST['mype2']."','".$_POST['b1']."','".$_POST['c1']."','".$_POST['b2']."','".$_POST['c2']."','".$_POST['med']."','".$_POST['student_type']."','".$_POST['rti']."','".$_POST["txtdoj"]."','$tc','$marksheet','".$_POST['adm_class']."','$t','$hname','$bus','".$_POST['mot']."','".$_POST['hostel_status']."','".$_POST['pr_no']."','".$_POST['presult']."','".$_POST['fc']."','".$_POST['famt']."','$da','".$_POST['memail']."','".$_POST['pn']."','https://smarterponline.com/shining/school/upload/$file_name','https://smarterponline.com/shining/school/upload/$file_name1','https://smarterponline.com/shining/school/upload/$file_name2')")or die(mysqli_error());
	   ...
	   $r=sms($_SESSION["uid"],$maxv,$sub,$msg,'Yes',$session,$page);
				...
				$res_up=mysqli_query($con,"update reg set status='1' where id='".$_GET["id"]."' ");
		...
		?>
                   <script type="text/javascript">
                    window.location="<?php echo $var."radmissionn&&sumsg=Inserted Successfully"; ?>";
			       </script>
			  <?php
              }
	        else
...
<?php
$res_stud=mysqli_query($con,"select * from  reg where id='".$_GET["id"]."' ")or die(mysqli_error());
$rowstud=mysqli_fetch_array($res_stud);?>
...
<tr><td>Form No.</td> <?php
	  ...
	  <td><input name="scholar" type="text" id="txtrno"  class="tb5" /></td> 
	   ...
	   <input type="hidden" name="sid" value="<?php echo $_GET["upstudid"]; ?>" />
			 ...
			 <input name="txtname" type="text" id="txtname" value="<?php echo $rowstud['student_name']; ?>" class="tb5" /></td> 
...
<input  type="radio" value="Inactive" name="hostel_status" <?php if(!empty($_GET["upstudid"]) && ($rowstud["hostel_status"]=="Inactive") ) { ?> checked="checked"  <?php } ?> checked="checked" >No
	    ...
	    <tr>
          ...
          <?php
			 ...
			 ?></td> 
		<td>&nbsp;&nbsp;Nationality</td> 
		<td><input name="mot" type="text" id="txtname" value="<?php echo $rowstud['nat']; ?>" class="tb5" /></td>
		 </tr>
	   
	   <tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
	   
	    <tr><td>Date Of Birth<span style="color:#FF0000">*</span></td> 
		<td><input name="txtdob"  id="demo1" type="text" value="<?php echo $rowstud['student_dob']; ?>" class="tb5"  />
		...
		<td>Religion</td> 
		   <td><input type="text" name="religion" class="tb5" value="<?php echo $rowstud['religion']; ?>"  ></td>
		 
		 
		 <td>Aadhar No</td> 
		 <td><input name="txtrno" type="text" id="txtrno" value="<?php echo $rowstud['adhar']; ?>"  class="tb5"  /></td>
		 </tr>
	  ...
	  <td><input name="txtfatname" type="text" id="txtfatname" value="<?php echo $rowstud['student_fname']; ?>"  class="tb5"  /></td> 
	  
	  
	  <td>&nbsp;&nbsp;Father Qualification </td>
	   <td><input type="text" name="fqualification"  id="txtname" class="tb5" value="<?php echo $rowstud['fquli']; ?>"/></td> 
	  </tr>
	  ...
	  <tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
	   ...
	   <td><input type="text" name="fprofession"   id="txtname" value="<?php echo $rowstud['foccu']; ?>" class="tb5" /></td>
	   <td>&nbsp;&nbsp;Father Mobile No</td> 
	   <td> <input name="txtmobile" type="text" id="txtmobile" value="<?php echo $rowstud['fmobile']; ?>" maxlength="10" class="tb5"  /></td>
	    </tr>
	    ...
	    <tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
		 ...
		 <td><input name="femail" type="text" class="tb5" value="<?php echo $rowstud['femail']; ?>" /></td>
		   <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td>
		  </tr>
	  ...
	  <tr>
	  <td>Mother Name</td> 
	  <td><input name="m_name" type="text" id="txtfatname" value="<?php echo $rowstud['m_name']; ?>" class="tb5"  /></td>
	  <td>Mother Qualification </td>
	   <td><input type="text" name="mqualification" value="<?php echo $rowstud['mquli']; ?>"  id="txtname"  class="tb5" /></td>
	   </tr>
	  ...
	  <td> <input name="mprofession" type="text" value="<?php echo $rowstud['moccu']; ?>" class="tb5"  /></td>
	  <td>Mobile No.(Mother)</td>
	  <td><input name="offadd" type="text" id="txtmobile" value="<?php echo $rowstud['mmobile']; ?>" maxlength="10" class="tb5"  /></td> 
	  ...
	  <tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
	   ...
	   <td><input name="memail" type="text" class="tb5"  value="<?php echo $rowstud['memail']; ?>"/></td>
	   <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td>
	   </tr>
	  ...
	  <td>&nbsp;&nbsp;State</td> 
	   <td>
	    <input type="text" name="mofftel" class="tb5" value="<?php echo $rowstud['state']; ?>" >
	   </td>
	   ...
	   <tr>
	  <td>Pin Code</td>
	  <td><input name="pn" type="text" id="txtmobile" value="<?php echo $rowstud['pinc']; ?>" class="tb5"  /></td> 
...
<input type="radio" name="mype2" value="No" onclick="showMe2()" checked="checked">No </td>
	  ...
	  <tr>
		   ...
		   {
		   ?>
           <input type="submit" name="add_student" id="add" value="Add Student" style="width:120px;margin-left:350px" />
           <?php } ?></td>
		    <td></td>
         </tr>
		 <tr>
