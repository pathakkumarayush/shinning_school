...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Health Details</h2>
		<a href="./?pageid=health1" style="color:#FFFFFF;float:right; background-color:#009966; margin-top:10px; padding:6px; font-size:18px">Back</a>
        </div>
        <div class="col_4">
        ...
        <div class="table" style="min-height:480px; width:1087px;">
		 ...
		 $search=mysqli_query($con,"select * from health_status1 where class='".$_POST['class']."' and exam='".$_POST['exam']."'");
         ?>
		 ...
		 <th>STUDENT NAME</th><th style="width:50px;">CLASS</th><th>EXAM</th>
	 	 <th>Height</th><th>Weight.</th><th>Vision L / R</th> 
		 <th></th>
		 ...
		 <td><?php echo $studrow['height']; ?></td>
		 <td><?php echo $studrow['weight']; ?></td>
		 <td><?php echo $studrow['vision']; ?></td>
