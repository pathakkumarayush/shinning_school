...
if(empty($err))
{ 	
$sel=mysqli_query($con,"select store from  addstore where store='".$_POST['store']."'");
if(mysqli_num_rows($sel)<1)
{

$queryw=mysqli_query($con,"insert into  addstore(store) values('".$_POST['store']."')") or die(mysqli_error());
/*
$id=mysqli_insert_id();
$textn="t".$id;
...
$selrc=mysqli_query($con,"select * from addstore where store='".$_GET['id']."'");	
$rowselrec=mysqli_fetch_array($selrc);	
	}
if(isset($_POST['update']))
{

$queryupdate=mysqli_query($con,"update addstore set store='".$_POST['store']."' where store='".$_POST['id']."'") or die(mysqli_error());	
?>
 <script type="text/ecmascript">
	  window.location = "<?php echo $var."addstore&uid=Update Sucessfully"; ?>";
	</script>
<?php
}
?>
<?php
 if(!empty($_GET['did']))
 {
	 ...
	 */
	 $del2=mysqli_query($con,"delete from addstore where id='".$_GET['did']."'"); 
   ?>	
  <script type="text/ecmascript">
...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">
 <a href="./?pageid=inventry_home" style="text-decoration:none">Inventory</a> -> Add Categories</a></h2>
</div>
<div class="col_4" style="margin-top:0px; min-height:335px;" >
    ...
    <?php
      ...
      ?>
        ...
        <table border="0" style="margin:80px 0px 0px 20px; font-size:18px">
          <tr>
            <td>Category Name<span>*</span></td>
            <td><input type="text" class="tb5" name="store" style="width:250px"  id="txtname" value="<?php echo $rowselrec['store']; ?>" />
           </td>
          </tr>
        ...
        <table border="0" width="600" style="margin:20px 0px 0px 20px; font-size:18px">
            ...
            <td>Category Name<span>*</span></td>
            <td>
              <input type="text" name="store" class="tb5" style="width:250px"  id="txtname" />
             </td>
          </tr>
		  <tr>
		      <td>&nbsp;</td>
       ...
       <tr>
        ...
        <?php
            ...
            <br><br>
            <div class="box-head">
						<h2 class="left">Currently Available Categories</h2>
				   </div>
       ...
       <?php
        $memo=mysqli_query($con,"select * from addstore");
    ...
    <td><?php echo $i;  ?></td>
    <td><?php echo ucwords($rowmemo['store']); ?></td>
        <td><a style="color:#CC0033" href="<?php echo $var."addstore"."&&id=".$rowmemo['store']; ?>">Edit</a></td>
    <td><a style="color:#CC0033" href="<?php echo $var."addstore"."&&did=".$rowmemo['id']; ?>" onClick="return confirmation();">Delete</a></td>
    </tr>
    <?php
    $i++;
	}
