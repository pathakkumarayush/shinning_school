...
<div class="col_4" style="margin-top:0px; min-height:335px;" >
  ...
  <tr class="table" >
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="submit" name="Submit2" value="Renew Book" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
...
{
$q="update issue_tech set issuedate='".$_POST['doe']."',duedate='".$_POST['due']."' where bookno='".$_POST['bno']."'";
mysqli_query($con,$q);	


$qry1="update addbook set status='1' where bookno='".$_POST['bno']."'";
mysqli_query($con,$qry1);


$d = date("d-m-Y");
$t = 'tech';
 $query=mysqli_query($con,"insert into renewbook(bno,name,sname,sid,idate,ddate,date,amt,type) values('".$_POST['bno']."','".$_POST['title']."','".$_POST['tname']."','".$_POST['sid']."','".$_POST['doe']."','".$_POST['due']."','$d','".$_POST['famt']."','$t') "); 
 
 echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Book Succesfully Renew')
    window.location.href='https://smarterponline.com/kmps/school/?pageid=book_status_tech';
    </SCRIPT>");
 }
mysqli_close($con);
?>	
