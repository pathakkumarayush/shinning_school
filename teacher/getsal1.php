...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <?php
  $qry="select * from teacher_sal where session='".$_SESSION['session']."' and month='".$_GET['id']."' and st='nonteaching' and pf_type='Yes'";
...
<table  border="0" cellspacing="0" cellpadding="0" style="color:#000000; margin-top:40px; width:700px;">
<tr><td>&nbsp;&nbsp;&nbsp;Principle</td><td>&nbsp;&nbsp;&nbsp;Director</td><td>&nbsp;&nbsp;&nbsp;&nbsp;Chairman</td></tr>

</table>
<table  border="0" cellspacing="0" cellpadding="0" style="color:#000000; margin-top:30px; width:700px;">
