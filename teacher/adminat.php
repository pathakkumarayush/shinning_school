...
{	
$res_up=mysqli_query($con,"update teacher set status='".$_POST['status']."',rea='".$_POST['rea']."' where teacher_id='".$_POST["tid"]."' and teacher_session='".$_SESSION['session']."'");	
?>
<script type="text/javascript">
                    window.location="<?php echo $var."adminat&&sumsg=Update Successfully"; ?>";
			       </script>
 <?php
}
   ?>
...
<br clear="all" />
<div class="left_sect"><img src="images/Pay Roll/staff.png" /><a href="./?pageid=current_student">
...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Inactive/Active Teacher</h2>
</div>
<div class="col_4">
<div class="form-style-2-heading">Inactive Teacher</div>
  <form method="post" name="myForm" id="myform" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
       ...
       <select class="select" name="status" style="width:125px;">
	   <option value="Inactive">Inactive</option>
	   <option value="Active">Active</option>
	   </select>
	  </td> 
	  <td><input type="text" name="rea" style="width:200px;" placeholder="Reason" /></td>
	  
	  <td><input type="submit"  name="update_student" id="add" value="Update" style="width:120px;margin-left:50px" /> </td>
