...
<h2 style="margin-left:0px; color:#006633; font-size:15px; line-height:40px;">&nbsp;Add Student Complaint</h2>
...
{
$res_ins=mysqli_query($con,"insert into comp_box(name,fname,class,date,comp,session,tid)values('".$_POST["name"]."','".$_POST["fname"]."','".$_POST["class"]."','".$_POST["date"]."','".$_POST["comp"]."','".$_SESSION['session']."','".$_SESSION['userid']."')")
or die(mysqli_error());
...
<input type="text" name="name" readonly value="<?php echo $rowstud["student_name"]; ?>" /></td>
</tr>
...
<input type="text" name="class" readonly value="<?php echo $rowstud["student_class"]; ?>" /></td>
</tr>

<tr><td style="font-weight:bold;">Date<br />
<input name="date"  id="demo1" type="text" required/>
...
<textarea name="comp" cols="25" rows="15"><?php echo $rowstud["student_address"]; ?></textarea></td>
</tr>
