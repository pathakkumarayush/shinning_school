...
<div class="col_4" style="margin-top:0px; min-height:335px;" >
  ...
  <br><br>
            <div class="box-head" style="width:1142px">
						 <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."allocate_student"."&&divid=1"; ?>">Search Student By Scholar Number</a>&nbsp;||&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."allocate_student"."&&divid=2"; ?>">Search Student By Id</a> || &nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."allocate_student"."&&divid=4"; ?>">Search Student By Class</a>
						</div>
            <?php
