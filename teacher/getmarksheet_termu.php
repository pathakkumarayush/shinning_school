...
<style>
.tbl{ width:330px;color:#000; border:1px #77ab59 solid; font-size:20px; border-top:3px #77ab59 solid;border-bottom:3px #77ab59 solid;}
.tb2{ width:169px;color:#000; border:1px #77ab59 solid;font-size:20px; border-top:3px #77ab59 solid;border-bottom:3px #77ab59 solid;}
.sn{ width:135px!important;}
.sn1{ width:125px!important;}
</style>
<body>
<div style="width:1050px; height:auto; background-color:#f0f7da; border:6px #77ab59 solid;">
...
<span style="font-size:34px; color:#da1010;"><center>Panchkuiyan Tiraha, Jhansi(U.P.)</center></span>
</div>
...
<img src="upload/<?php echo $rowstud["student_id"].$_SESSION['uid'].$rowstud['student_img'];  ?>" style="height:125px; margin-left:10px; width:110px; margin-top:4px; " />
</div>
...
<tr style="background-color:#77ab59; color:#FFFFFF;"><td style="line-height:54px;">&nbsp;&nbsp;Subject</td></tr>
<?php
...
<table border="1"  cellpadding="0" cellspacing="0" style="margin-left:20px;font-size:20px; margin-top:15px;color:#000;border:1px #77ab59 solid; width:96%;">
<tr style="line-height:30px;color:#FFFFFF; background-color:#77ab59;">
...
<table style="width:50%; float:left; font-size:20px; margin-top:15px; margin-left:19px;color:#000;"  border="0" cellpadding="0" cellspacing="0">
...
<table border="0" style="width:100%;margin-top:125px; font-size:20px; font-weight:bold;color:#000;">
<tr>
