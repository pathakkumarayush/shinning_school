...
<?php
  if(!empty($_GET['did']))
    {
	  $delete=mysqli_query($con,"delete from in_ac where id='".$_GET['did']."'");
	}
?>
...
<div class="full_div">
<br clear="all" />
<div class="left_sect"><img src="images/Accounts/acc.png" /><a href="./?pageid=expenses">
...
<table class="table table-bordered" id="sample_1" style="font-size:12px; font-weight:bold; ">
    ...
    ?>
                 ...
                 <td><a style="color:#CC0033" href="<?php echo $var."in_ac"."&&did=".$row['id']; ?>" onClick="return confirmation();">Delete</a></td>
				 </tr>
      <?php
	 $i++;
	}
...
{
$query=mysqli_query($con,"insert into in_ac(name)values('".$_POST['name']."')");
