...
$maxid2=mysqli_query($con,"select count(student_id) from student where student_school='".$_SESSION["uid"]."' and student_session='".$_SESSION['session']."'and status='1'");
 ...
 <?php
				...
				{
			    $search=mysqli_query($con,"select * from student where student_session='".$_POST['session']."' and status='0' order by student_class Asc");
				$num=mysqli_num_rows($search);	   
				}
 ...
 <div style="font-size:24px; color:#990000; margin:40px 0px 0px 270px; border:#FF0000 0px solid	"><?php echo date("d-m-Y");  ?></div>
  ...
  <br><br>
            <div class="box-head" style="width:1127px">
						 <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."student_attendance"."&&divid=1"; ?>">Search Student By Scholar Number</a>&nbsp;||&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."student_attendance"."&&divid=2"; ?>">Search Student By Id</a> ||&nbsp;
<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."student_attendance"."&&divid=3"; ?>">Search Student By Name</a>
||&nbsp;
<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."student_attendance"."&&divid=4"; ?>">Search Student By clsss</a>
||&nbsp;
<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."allstudent_attendance"."&&divid=4"; ?>">All Student</a>
						</div>
          ...
          <table style="margin:30px 0px 0px 70px; font-size:14px; width:300px">
           ...
           <td><input type="text" name="session"  value="<?php echo $_SESSION['session'] ?>" /> </td>
