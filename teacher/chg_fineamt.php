...
<div class="col_4" style="margin-top:0px; min-height:335px;" >
		...
		<table width="891" height="167" border="0">
          <tr  class="box-head" >
            <td colspan="3" align="center" >Update Fine Amount</td>
            </tr>
			<?php
			$penality1=mysqli_query($con,"select * from variables where id='1'");
		$rowpenality1=mysqli_fetch_array($penality1);
		$fineamt=$rowpenality1["fineamt"];
		?>
          <tr class="table" >
            <td width="170">&nbsp;</td>
            <td width="220">Course</td>
            <td width="479"><input class="tb5" type="text" name="fine" value="<?php echo $fineamt; ?>" /></td>
          </tr>
          <tr class="table" >
            <td>&nbsp;</td>
            <td>&nbsp;</td>
...
$qry1="update variables set fineamt='$fine'  ";
