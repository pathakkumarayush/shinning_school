...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Enter Masths Marks</h2>
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
		 ...
		 <th style="width:120px;">activity & Painting</th>
         <th style="width:150px;">concept Education</th>
         <th style="width:100px;">mental_ab</th>
		 ...
		 {
		  $searchs=mysqli_query($con,"select * from maths where student='".$studrow['student_id']."' and class='".$studrow['student_class']."' and exam='".$_POST['exam']."' and subject='".$_POST['subject']."' and session='".$_SESSION['session']."'");
		 ...
		 <td >
            <input type="text" name="activity" value="<?php echo $studrows['activity']; ?>" id="activity<?php echo $i;?>" style="width:50px;">
         </td>
		 <td >
            <input type="text" name="concept" value="<?php echo $studrows['concept']; ?>" id="concept<?php echo $i;?>" style="width:45px;">
         </td>
		 <td >
            <input type="text" name="mental_ab" value="<?php echo $studrows['mental_ab']; ?>" id="mental_ab<?php echo $i;?>" style="width:45px;">
         </td>
		 
		  <td >
            <input type="text" name="numberation" value="<?php echo $studrows['numberation']; ?>" id="numberation<?php echo $i;?>" style="width:45px;">
         </td>
		 
		 <td >
      <?php if(!empty($studrows['activity']) || !empty($studrows['concept']) || !empty($studrows['mental_ab']) || !empty($studrows['numberation']) ){ ?>
...
var activity= document.getElementById('activity'+hid).value;
var concept= document.getElementById('concept'+hid).value;
var mental_ab= document.getElementById('mental_ab'+hid).value;
var numberation= document.getElementById('numberation'+hid).value;
...
var data_str= "cls="+cls+"&idm="+idm+"&exam="+exam+"&subject="+subject+"&activity="+activity+"&concept="+concept+"&mental_ab="+mental_ab+"&numberation="+numberation;
