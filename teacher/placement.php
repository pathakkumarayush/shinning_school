...
<table border="0" style="margin:20px 0px 0px 20px">
		...
		<tr>
		   ...
		   <td><input type="text" name="e_esal" class="tb5"/ required></td>
			...
			<td> <input type="Text" id="demo1" maxlength="25" name="e_d" class="tb5" size="25"><a href="javascript:NewCal('demo1','ddmmmyyyy',false,24)"><img src="css/images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></td>
		</tr>
...
<table class="table table-bordered" id="sample_1" style="font-size:12px; width:800px;">
...
$sqlAdd = mysqli_query($con,"insert into resume(e_name,e_fh,mobile,dob,email,e_q,e_post,e_exp,e_sub,e_sale,e_esal,e_d,address,e_f,po) VALUES
('".$_POST['e_name']."','".$_POST['e_fh']."','".$_POST['mobile']."','".$_POST['dob']."','".$_POST['email']."','".$_POST['e_q']."','".$_POST['e_post']."','".$_POST['e_exp']."','".$_POST['e_sub']."','".$_POST['e_sale']."','".$_POST['e_esal']."','".$_POST['e_d']."','".$_POST['address']."','$image_name','".$_POST['po']."')");
