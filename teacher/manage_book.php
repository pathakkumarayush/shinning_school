		...
		<table width="888" height="242" border="0">
		  ...
		  <tr>
            ...
            <td> <table width="1130" height="52" border="0"  style="border: #006633 solid 15px;"   >
			  ...
			  echo  "<td> <a href='delete.php?bookno=".$row["bookno"]."'  onclick='return valid();'  >Delete </a></td>";
			  echo "</tr>";
			  }
			   break;
			   case "1":
			  ...
			  echo  "<td> 
			   <a href='view.php?bookno=".$row["bookno"] ."' >
			  View/
			  </a>
			  
			    <a href='edit.php?bookno=".$row["bookno"]."'  >
			  Edit/
			  </a>
			    <a href='delete.php?bookno=".$row["bookno"]."'  onclick='return valid();'  >
			  Delete
			  </a>
