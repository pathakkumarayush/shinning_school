...
<style>
.enquiry{ width:100%; height:45px;background-color:#FFFFFF; margin-top:150px; border:4px #006633 solid;}
...
<h2 style="margin-left:0px; color:#006633; font-size:20px; line-height:40px;">&nbsp;TEACHER PROFILE</h2>
...
<tr>
<td colspan="2">
<img src="../school/uploads/<?php echo $techrow["timg"]; ?>" style="height:100px;border-radius:5px;  margin-left:17px; width:90px; margin-top:4px; " />
</td>
</tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr>
...
<td>
<?php
$tech=mysqli_query($con,"select * from  teacher where uid='".$_SESSION['userid']."' and teacher_session='".$_SESSION['session']."'");
$techrow=mysqli_fetch_array($tech);
?>
<span style="color:#000; font-weight:bold;" 
<strong><?php echo ucwords($techrow['teacher_name']); ?></strong></span>
...
<td><?php echo $techrow['father_name']; ?></td>
</tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr>
<td>Gender :</td>
<td><?php echo $techrow['teacher_gender']; ?></td>
</tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr>
<td>D.O.B :</td>
<td><?php echo $techrow['teacher_dob']; ?></td>
</tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
 <tr>
<td>Qualification :</td>
<td><?php echo $techrow['teacher_qualifi']; ?></td>
</tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr>
<td>Address :</td>
<td><?php echo $techrow['address']; ?></td>
</tr>
