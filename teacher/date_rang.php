...
<img src="images/buttonGoBack.png"  style="float:right; width:150px; height:60px;"/></a></div>
	<div class="shell"  >
		<div id="main" >
			...
			<div id="content" style="border:#F00 0px solid; width:990px; height:auto">
			   ...
			   <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."feecollectionby_date"."&&divid=1"; ?>">Today Collection </a>&nbsp;||&nbsp;
			 <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."feecollectionby_date"."&&divid=2"; ?>">Fee Collection date- wise</a>&nbsp;||&nbsp;
			    <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."date_rang"?>">Fee Collection B/W the dates</a>
		...
		<br>
			...
			<tr style="line-height:40px;"><td colspan="3"><a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/feedate_listt.php?from=<?php echo $_POST['from']."&to=".$_POST['to']."&ses=".$_SESSION['session'] ;  ?>')">     <input type="button" value="Print List " style="width:100px;"></a>
		      ...
		      $a=$_POST['from'];
              $b=$_POST['to'];
		      $searchs=mysqli_query($con,"select date,SUM(fee_deposit) from fee_detail where session='".$_SESSION['session']."' and date BETWEEN '$a' AND '$b' GROUP BY date");
		 ...
		 $sch=mysqli_query($con,"select * from school");
			...
			$rowsch['school_name'];
			  ...
			  <h2 align="center" style="margin-top:10px; color:#006633"> Income Report</h2>
 ...
 <a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/view_collection.php?date=<?php echo $studrow['date'];  ?>')"> View </a>
			  </td>
			  </tr>
			  <?php $i++; } ?>	
