 ...
 <div class="shell">
		<div id="main">
			...
			<div id="content">
				...
				<div  style="border:#FF0000 0px solid; height:400px; margin-top:20px">
				  <img src="images/SMS/Message.png" style="width:200px; height:80px;" />
                 
                
				   <div style="border:#900 2px solid; margin-top:10px"></div>
				     <span style="float:right; color:#FFFFFF"><a href="./?pageid=staff_home" style="color:#FFFFFF">Back</a></span>
            <a href="<?php echo $var."staff_home";  ?>">Back</a>             
  ...
  <input type="button" onclick="gets('msg'); display('sub1','none'); display('sub2','inline');" value="view Message" name="sendall" />
   ...
   <input type='checkbox' value='on' id='chkall' name='allbox' onclick='checkAll();'/>
	...
	<?php
	$i=0;
	$res_all=mysqli_query($con,"select * from teacher where teacher_school='".$_SESSION["uid"]."' order by hostel asc")or die(mysqli_error());
