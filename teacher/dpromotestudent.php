 ...
 if(isset($_POST['search1']))
				...
				if(isset($_POST['promote']))
				  ...
				  foreach($_POST['formDoor'] as $id)
				  {
				   ...
				   $msg="Student Dpromoted Successfully";
					  }
 ...
 <div class="shell">
			...
			<div id="content">
				...
				<div  style="border:#FF0000 0px solid; height:400px; margin-top:20px">
				  <img src="css/images/studentdetail.jpg" style="margin-left:20px;height:80px; width:80px"><br />
                    	<span style=" color:#000000; font-size:18px; margin-top:-20px; margin-left:20px">Dpromote Student </span>
  ...
  <br><br>
            <div class="box-head" style="width:950px">
						<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."dpromotestudent"."&&divid=4"; ?>">Dpromote Student By Class</a>
			</div>
	   ...
	   ?>
		 ...
		 <table style="margin:30px 0px 0px 70px; font-size:14px; width:340px">
         ...
         <tr>
           ...
           <td><input type="submit" name="promote" value="Dpromote" style="width:80px"></td>   
		  </tr>
        </table>
        </div>
