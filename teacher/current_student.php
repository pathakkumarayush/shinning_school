...
<table class="table table-bordered" id="sample_1" style="font-size:12px; ">
              ...
              <tbody>
	<?php
    $sql=mysqli_query($con,"select * from student where student_school='".$_SESSION['uid']."' and  student_session='".$_SESSION['session']."' and status='0' order by student_name Asc");
	...
	Print Id Card</a>||<?php */?>
				  ...
				  <a href="<?php echo $var."current_student&did=".$row['student_id']; ?>" onClick="return confirmation();">Delete</a>
				 &nbsp;&nbsp;||&nbsp;&nbsp;
				    <a href="<?php echo $var."admini&upstudid=".$row['student_id']; ?>" target="_blank"><b>Inactive</b>
					 &nbsp;&nbsp;||&nbsp;&nbsp;
