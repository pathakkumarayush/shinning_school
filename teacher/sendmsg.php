...
/*
	...
	{
	  $sub=array();
	   $marks=mysqli_query($con,"select * from marks where student='$f' and ses='".$_SESSION["session1"]."' and exam='".$_SESSION['rexam']."'");
	   $otot=0;
		 $tot=0;
	  ...
	  $msg="Report Card for Your Child is ".$obtmarks1."and total is".$std_marks." & attendance is".$present." & remark is".$remark;
    
	  echo $msg;	
	 // $r=sms($_SESSION["uid"],$f,"Report card",$msg,$page,'Yes');
	}
...
value='".$row_marks['obtainmarks']."' /></td>";
	...
	echo "<td class='bu'><input type='button' readonly onclick='showUser(\"$std_name\",\"$std_id\",\"$vara\",\"divTot$iii\",\"sday\",\"$sp\",\"$mob\",\"txtrem".$iii."\")' value='Save Record'></td> 
...
<h2 style="margin-left:0px; color:#006633; font-size:20px; line-height:40px;">&nbsp;Fill Form </h2>
</div>
<div class="col_4" style="margin-top:0px; min-height:335px;" >	
<form action="" method="post">
<div  style="border:#FF0000 0px solid; margin-top:10px; width:350px; margin-left:2px">
    <table style="font-size:14px; ">
    
     <tr><th>Session:</th><td><select name="session" id="session" onchange="" size="1" class="select" style="width:200px;">
