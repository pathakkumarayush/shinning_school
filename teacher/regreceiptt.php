...
<body>
	...
	<table class="table" style="margin:5px 0px 0px 1px; width:325px; font-size:12px; font-weight:bold;" border="0">
	     ...
	     <td align="center">No</td>
		  ...
		  <td>&nbsp;&nbsp;<b><?php echo $rowstud['amt']; ?></b></td>
		   ...
		   <tr style="line-height:22px;">
		   <td colspan="3" style="font-size:12px;">Payment Type: <b>
		   <?php
		  ...
		  Date - <?php  echo $rowstud['dat'];  ?>, Bank - <?php  echo $rowstud['bank'];  ?>
		   ...
		   <?php
		   if($rowfeedetail['pay_type']=='Neft')
		   {
		   echo 'Neft/Rtgs/Imps';
		   ?>
		  ,&nbsp;Transaction Id - <?php  echo $rowfeedetail['ne_no'];  ?>,  Date - <?php  echo $rowfeedetail['ndat'];  ?>
		   ...
		   echo 'Swipe';
		   ?>
		  ,&nbsp;Transaction Id - <?php  echo $rowstud['sw_no'];  ?>
		   <?php
		   } 
		   ?>
