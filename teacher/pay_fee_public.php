...
if(!empty($_SESSION['sumsg']))
{
  unset($_SESSION['sumsg']);
				...
				/* $ckfee=mysqli_query($con,"select * from fee_detailp where student='".$studrow['student_id']."' and session='".$_SESSION['session']."' and month='".$_SESSION['month1']."'");
	            $numchk=mysqli_num_rows($ckfee);
				*/
				
				$distinctmonth=mysqli_query($con,"select distinct(month) from fee_detailp where student='".$studrow['student_id']."' and school='".$_SESSION['uid']."' and session='".$_SESSION['session']."'");
...
$search=mysqli_query($con,"select * from fee_detailp where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."' and student='".$studrow['student_id']."'");
$num=mysqli_num_rows($search);
		...
		//query to check previous month fee
		 ...
		 /*
			  $prevfee=mysqli_query($con,"select * from fee_detailp where month='".$rowprev2['month']."' and student='".$studrow['student_id']."' and school='".$_SESSION['uid']."' and session='".$_SESSION['session']."'");
...
if((!empty($_POST['latefee1']))|| (!empty($_POST['concession'])) )
{
	 ...
	 $_POST['amt']=$_POST['amt']-$_POST['concession'];
	  ...
	  $m=date("M");
$receptno=mysqli_query($con,"select * from fee_detailp where receiptno='".$_POST['srecipt']."' and session='".$_SESSION['session']."'");
if(mysqli_num_rows($receptno)<1)
{
//$instn = $_POST['montha'];
if($_POST['montha']=='June,August,October,December,February')
{
$instn='Instalment1 to Instalment5';
}
if($_POST['montha']=='June,August,October,December')
{
$instn='Instalment1 to Instalment4';
}
if($_POST['montha']=='June,August,October,')
{
$instn='Instalment1 to Instalment3';
}
if($_POST['montha']=='June,August')
{
$instn='Instalment1,Instalment2';
}
if($_POST['montha']=='June')
{
$instn='Instalment1';
}

if($_POST['montha']=='August,October,December,February')
{
$instn='Instalment2 to Instalment5';
}
if($_POST['montha']=='October,December,February')
{
$instn='Instalment3 to Instalment5';
}
if($_POST['montha']=='December,February')
{
$instn='Instalment4,Instalment5';
}

if($_POST['montha']=='August')
{
$instn='Instalment2';
}
...
if($_POST['montha']=='December')
{
$instn='Instalment4';
}
if($_POST['montha']=='February')
{
$instn='Instalment5';
}

if($_POST['montha']=='August,October')
{
$instn='Instalment2,Instalment3';
}
if($_POST['montha']=='August,October,December')
{
$instn='Instalment2 to Instalment4';
}
if($_POST['montha']=='October,December')
{
$instn='Instalment3,Instalment4';
}


$query=mysqli_query($con,"insert into fee_detailp(session,class,adm_fee,caution,inst_fee,inst_fee_bus,tamnt,tpay,due,pdue,pay_type,fee_deposit,month,student,date,latefee,concession,school,receiptno,current_month,
instalment,extra_amnt,remark,cno,cd,padv,anual,activity)
values('".$_SESSION['session']."','".$_POST['class']."','".$_POST['admissionfee']."','".$_POST['cm']."','".$_POST['inst_fee']."','".$_POST['inst_fee_bus']."','".$_POST['amt']."','".$_POST['tamount']."','$due','".$_POST['pdue']."','".$_POST['ftype']."','".$_POST['amntdeposit']."','".$_POST['montha']."','".$_POST['student']."','$date',
'".$_POST['latefee1']."','".$_POST['concession']."','".$_SESSION['uid']."','".$_POST['srecipt']."','$m','$instn','$extra','".$_POST['remarks']."','".$_POST['cno']."',
'".$_POST['cd']."','".$_POST['padv']."','".$_POST['anual']."','".$_POST['actv']."')");
		...
		$update=mysqli_query($con,"update fee_detailp set admissionfee='Yes' where id='$insertid' and school='".$_SESSION['uid']."'");
		} 
		...
		$nmsg="Thanks for Paying Fee For the month $instn. Received amount ".$_POST['amntdeposit'];	
...
<div class="col_4">
	...
	<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return validateForm()" >
		  ...
		  <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."pay_fee"."&&divid=3"; ?>">Pay Fee Kids Care</a>
		  &nbsp;&nbsp;||&nbsp;&nbsp;
		  <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."pay_fee_public"."&&divid=3"; ?>">Pay Fee Public</a>
		  &nbsp;&nbsp;||&nbsp;&nbsp;
		  <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."pay_fee_hr"."&&divid=3"; ?>">Pay Fee Hr. Sec.</a>
		  </div>
          <?php
          ...
          <?php
          $class=mysqli_query($con,"select * from class where type='public'");
		  ?>
		  ...
		  <td><select name="stdid" class="select" style="width:200px" onchange="showStudentp3(this.value)">
          <option>Select Student</option>
          <?php
          $class=mysqli_query($con,"select * from class where type='public' and class_id='".$_SESSION['student_class']."'");
		  ...
		  <tr>
		  <td style="font-weight:bold;">Instalment<br>&nbsp;<br>&nbsp;<br>&nbsp;<br></td>
		  <td> 
		  <div id="txtHint2" >
	     <input type="checkbox" name="month1[]" value="June"><span style="color:#fff; font-weight:bold">Instalment1</span>-June<br>
          <input type="checkbox" name="month1[]" value="August"><span style="color:#fff; font-weight:bold">Instalment2</span>-August<br>
          <input type="checkbox" name="month1[]" value="October"><span style="color:#fff; font-weight:bold">Instalment3</span>-October<br>
          <input type="checkbox" name="month1[]" value="December"><span style="color:#fff; font-weight:bold">Instalment4</span>-December<br>
		  <input type="checkbox" name="month1[]" value="February"><span style="color:#fff; font-weight:bold">Instalment5</span>-February<br>
		  </div>
		  ...
		  <td><input type="text" name="date" value="<?php echo date('d-m-Y'); ?>" class="tb5" style="width:110px"> dd-mm-yyyy</td>
		  </tr>
		  <tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		 ...
		 <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
		  ...
		  <td>
		  <?php
		  $maxid=mysqli_query($con,"select max(id) from fee_detailp where school='".$_SESSION['uid']."'");
		  ...
		  $rowselrec=mysqli_fetch_array($selrc);
		   ...
		   $trans=mysqli_query($con,"select * from stopage where stop_name='".$studrow['transport_stopage']."' and session='".$_SESSION['session']."' and no_of_inst='5'");
		  $transrec=mysqli_fetch_array($trans);
		  
		  $anualfee=mysqli_query($con,"select * from exam_fee where class='".$studrow['student_class']."' and session='".$_SESSION['session']."' and month='$m'");
	      ...
	      <tr>
		  <td><?php echo $i; ?></td>
		  <td><?php echo $rowselrec['inst_type']; ?></td>
		  <td>
		  <?php 
		  if($studrow['prosd']=='Yes')
		  {
		  $secd = $rowselrec['amnt']*25/100;
		  $val =  $rowselrec['amnt']-$secd;
		  }
		  else if($studrow['pr_no']=='Yes')
		  {
		  $val = $rowselrec['amnt']*50/100;
		  }
		  else
		  {
		  $val = $rowselrec['amnt'];
		  ...
		  <td><b><?php   $search1=mysqli_query($con,"select * from fee_detailp where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."' 
		  ...
		  <input type="button" name="latefee" onclick="add('<?php echo $val1+$duerow['due']+$_SESSION['fine']; ?>')" value="Add"   />
		  ...
		  <input type="button" name="latefee" onclick="concess()" value="Add"   />
		  </td>
		  </tr>	
		  <tr>
		  <td>&nbsp;</td>
		  ...
		  <input type="hidden" name="tamount" value="<?php echo $val1+$duerow['due']+$fine1; ?>">
		  ...
		  <input type="hidden" name="belt" value="<?php echo  $tbtf; ?>" style="width:75px;">
		  <input type="hidden" name="tie" value="<?php echo  $ttef; ?>" style="width:75px;">
		  <input type="hidden" name="cm" value="<?php echo  $tcafe; ?>" style="width:75px;">
...
?>
<td>
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/eliten/school/getreceiptp.php?id=<?php echo $_SESSION['studentid']; ?>')">
