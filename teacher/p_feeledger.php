...
<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."p_feeledger"."&&divid=3"; ?>">Search Student By Class </a>
	   ...
	   ?>
		...
		<form id="form1">
		<div id="dvContainer">
		<h1 align="center" style="color:#000000; font-size:18px">Ajay Satya Prakash PUBLIC SCHOOL</h1>
		<h2 align="center" style="color:#000000;font-size:16px">Gram kevlari, Panagr, Jabalpur,(M.P.)</h2>
		<h2 align="center" style="color:#000000;font-size:14px">CONTACT NO - 0761-2350211</h2>
