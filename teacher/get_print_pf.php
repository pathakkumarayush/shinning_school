...
<center>Teaching Staff Salary , Month - <?php echo $_GET['idpf']; ?></center>
<br />
</td></tr>
    <tr class="box-head" >
  ...
  <?php
		$qry="select * from teacher_sal where session='".$_SESSION['session']."' and month='".$_GET['idpf']."' and st='teaching' and pf_type='Yes'";
...
mysqli_close($con);
?>
<tr><td colspan="21"><span style="float:right; font-weight:bold;">Total Amount&nbsp;</span></td><td>&nbsp;<b><?php echo $tnnt; ?></b></td></tr>
<tr><td colspan="21"><b>&nbspIn Words&nbsp;-<?php echo convert_digit_to_words($tnnt); ?> Only.</b></td></tr>
	  </table>
