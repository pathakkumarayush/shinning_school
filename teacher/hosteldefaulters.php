			...
			<div id="content" style="border:#F00 0px solid; width:990px; height:auto">
				...
				<div  style="border:#FF0000 0px solid; height:400px; margin-top:20px">
				   <img src="css/images/hostel.jpg" style="margin-left:20px;height:80px; width:80px"><br />
                    	<span style=" color:#000000; font-size:18px; margin-top:-20px; margin-left:10px">Hostel Fee Defaulters</span>

                        <div style="border:#900 2px solid; margin-top:10px"></div>
                <a href="./?pageid=transport_home">Transport</a> >>Hostel Fee Defaulters</a>
