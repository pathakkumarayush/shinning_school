...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<?php
		 ...
		 <span style=" font-size:14px; margin-left:0px; font-weight:bold;"><?php echo $rowsch['school_name'];?></span><br>
		 <span style=" font-size:13px;margin-left:0px;">Pipariya Road, Mamti, Gadarwara.</span><br>
         ...
         <div class="table" style="border:#FF0000 0px solid; height:autopx; margin:1px 0px 0px 2px">
		  ...
		  <?php } ?>
		   ...
		   ?>
		  <tr>
		  <td>&nbsp;&nbsp;Advance</td><td>&nbsp;&nbsp; <?php echo $rowfeedetail['padv']; ?></td>
		  </tr>
		  <?php } ?>
