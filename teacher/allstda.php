...
<div class="col_4" style="margin-top:0px; " >	
  ...
  <div style="width:95%; height:100px; border:1px solid black" id="msg" >
   ...
   <tr valign="top"><td style="border:none;">
	...
	$qry=mysqli_query($con,"select * from student where student_class='".$row_all['class']."' and student_section='".$row_all['class_section']."' and student_school='".$_SESSION['uid']."' and student_session='".$_SESSION['session']."' and status='0' and st_type='pri' order by student_name Asc");
	   ...
	   {
	    $sec1="";
        $qry=mysqli_query($con,"select * from student where student_class='".$row_all['class']."' and  student_section='$sec1' and  student_school='".$_SESSION['uid']."' and student_session='".$_SESSION['session']."' and status='0' and st_type='pri' order by student_name Asc");
