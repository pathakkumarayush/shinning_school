...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Additional Subject</h2>
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
		 ...
		 <table style="width:100%;color:#000000">
		    ...
		    <thead>
             ...
             <th >GK<br>(UKG)</th> 
             <th >Drawing<br>(Nursery,LKG,UKG)</th>
             <th >EVS<br>(9th,11th clas)</th>
			 <th colspan="2">Action</th>
            </tr>
            </thead>
		 ...
		 <td >
        <?php if(!empty($studrows['height']) || !empty($studrows['weight']) || !empty($studrows['vision']) ){ ?>
...
var data_str= "cls="+cls+"&idm="+idm+"&exam="+exam+"&height="+height+"&weight="+weight+"&vision="+vision;
