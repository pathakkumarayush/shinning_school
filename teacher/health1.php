...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">HEALTH STATUS</h2>
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
		 ...
		 {
		  $searchs=mysqli_query($con,"select * from health where student='".$studrow['student_id']."' and class='".$studrow['student_class']."' and exam='".$_POST['exam']."' and session='".$_SESSION['session']."'");
		 ...
		 <td >
            <input type="text" name="height" value="<?php echo $studrows['height']; ?>" id="height<?php echo $i;?>" style="width:50px;">
         </td>
		 <td >
            <input type="text" name="weight" value="<?php echo $studrows['weight']; ?>" id="weight<?php echo $i;?>" style="width:50px;">
         </td>
		 <td >
            <input type="text" name="vision" value="<?php echo $studrows['vision']; ?>" id="vision<?php echo $i;?>" style="width:45px;">
         </td>
		
		 <td >
            <input type="text" name="bg" value="<?php echo $studrows['bg']; ?>" id="bg<?php echo $i;?>" style="width:45px;">
         </td>
		 
		  <td >
            <input type="text" name="ailment" value="<?php echo $studrows['ailment']; ?>" id="ailment<?php echo $i;?>" style="width:45px;">
         </td>
		 
		  <td >
            <input type="text" name="teeth" value="<?php echo $studrows['teeth']; ?>" id="teeth<?php echo $i;?>" style="width:45px;">
         </td>
		 
		  <td >
            <input type="text" name="oral" value="<?php echo $studrows['oral']; ?>" id="oral<?php echo $i;?>" style="width:45px;">
         </td>
		 
		 <td >
      <?php if(!empty($studrows['height']) || !empty($studrows['weight']) || !empty($studrows['vision']) || !empty($studrows['bg']) || !empty($studrows['ailment']) || !empty($studrows['teeth']) || !empty($studrows['oral']) ){ ?>
...
var teeth= document.getElementById('teeth'+hid).value;
var oral= document.getElementById('oral'+hid).value;
...
var data_str= "cls="+cls+"&idm="+idm+"&exam="+exam+"&height="+height+"&weight="+weight+"&vision="+vision+"&bg="+bg+"&ailment="+ailment+"&teeth="+teeth+"&oral="+oral;
