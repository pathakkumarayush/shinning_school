...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Send Message - All Class</h2>
</div>
<div class="col_4" style="margin-top:0px; height:1000px;" >						
		<?php
		   if((empty($_GET['tid'])))
		   {
		?>			
  ...
  <input type="button" onclick="gets('msg'); display('sub1','none'); display('sub2','inline');" value="view Message" name="sendall" />
   <textarea name="txtmsg" style="width:95%; height:100px; border:1px solid black" id="mm" readonly="readonly"></textarea>
    ...
    <input type="submit" id="sub2" value="Send Message" name="send" style="display:none;" /> 
           ...
           <table  cellpadding="5" cellspacing="0" style=" margin-left:20px; border-radius:5px; margin-right:20px; " width="700" >
