...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Student Daybording Collection by date </h2>
<a href="./?pageid=trans_fee_date" style="color:#FFFFFF;float:right; background-color:#009966; margin-top:10px; padding:6px; font-size:18px">Transport Fee</a>
<a href="./?pageid=feecollectionby_date" style="color:#FFFFFF;float:right; background-color: #CC0000; margin-top:10px; padding:6px; font-size:18px">Tution Fee</a>
</div>
<div class="col_4">
...
<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
            ...
            <div class="box-head" style=" font-size:18px">
			  <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."db_fee_date"."&&divid=1"; ?>">Today Collection</a>&nbsp;&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."db_fee_date"."&&divid=2"; ?>">Collection By Date</a>	
			  &nbsp;&nbsp;
			  <?php /*?><a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."db_rang"."&&divid=2"; ?>">
			  Collection By B/W 
			  Date</a>  <?php */?> 
			</div>
      ...
      <div style="border: solid #000 0px; width:500; margin-left:30px; border-radius:5px; margin-top:7px;">
        ...
        <?php
		 ...
		 ?>
		   ...
		   <div id="printablediv" style="width: 100%;">
		    <h2 align="center" style="margin-top:9px; color:#990033"><?php echo $rowsch['school_name'];?></h2>
                   <h2 align="center" style="margin-top:9px; color:#990033">Dayboarding Fee - Session: <?php echo $_SESSION['session']; ?></h2>
         ...
         <?php
	      ...
	      ?>
		   ...
		   <table width="72%" border="1" cellspacing="0" cellpadding="0" style="margin:10px 0px 0px 120px; font-size:14px">
			...
			$today=date("Y-m-d");
			  $search=mysqli_query($con,"select * from fee_db where session='".$_SESSION['session']."' and date='$today'");
	   ...
	   <h2 align="center" style="margin-top:9px; color:#990033">Date: <?php echo date("d-m-Y",strtotime($_POST['date'])); ?></h2>
		   <table width="90%" border="1" cellspacing="0" cellpadding="0" style="margin:10px 0px 0px 50px; font-size:14px">
			  ...
			  $search=mysqli_query($con,"select * from fee_db where session='".$_SESSION['session']."' and date='".$_POST['date']."'");
