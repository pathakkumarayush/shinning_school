...
<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
            ...
            <div class="box-head" style=" font-size:18px">
			  <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."feedate"."&&divid=1"; ?>">Today Collection</a>&nbsp;&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."feedate"."&&divid=2"; ?>">Collection By Date</a>	
			  &nbsp;&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."daterang"."&&divid=2"; ?>">
			  Collection By B/W 
			  Date</a>   
			</div>
		 ...
		 ?>
		   ...
		   <div id="printablediv" style="width: 100%;">
		    <h2 align="center" style="margin-top:9px; color:#990033">Kabra Memorial Public School</h2>
                   <h2 align="center" style="margin-top:9px; color:#990033">Tution Fee - Session: <?php echo $_SESSION['session']; ?></h2>
