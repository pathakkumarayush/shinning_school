...
<center><h2 style="text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Student Enquiry Details</h2></center>
</div>
		...
		?>
                 <tr>
                  ...
                  <td><?php echo $row['address'] ?></td>
				   ...
				   {
				   ?>
				   <span style="color:#003399">Convert To Registered</span>
				  ...
				  <?php  
				   ...
				   {
				   ?>
				   <span style="color: #006633">Convert To Admission</span>
				  ...
				  <td> 
				  <?php /*?> <a href="<?php echo $var."senq&id=".$row['id']; ?>" target="_blank">Registration </a>&nbsp;|&nbsp;
				  '<a href="<?php echo $var."senq&id=".$row['id']; ?>" target="_blank">Admission</a>
				  <a href="<?php echo $var."admissionn&id=".$row['id']; ?>" target="_blank">Admission</a><?php */?>
				  ...
				  <a href="<?php echo $var."enquiry_reg&id=".$row['id']; ?>" target="_blank">Registration</a>&nbsp;|&nbsp;
				  
				  
				  <a href="<?php echo $var."enquiry_admission&id=".$row['id']; ?>" target="_blank">Admission</a>
