...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Group-D Staff</h2>
...
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="./?pageid=non_teaching" style="color:#FFFFFF;float:right; margin-left:-20px; background-color: #CC0000; margin-top:10px; padding:6px; font-size:18px">Non-Teaching Staff Details</a>
</div>
<?php
if(!empty($_GET['did']))
{
$delete=mysqli_query($con,"delete from teacher where teacher_id='".$_GET['did']."' and teacher_session='".$_SESSION['session']."'");
} 
?>
<?php
$maxid=mysqli_query($con,"select count(teacher_id) from teacher where staff_typ='grd' and teacher_session='".$_SESSION['session']."'");
...
$qry=mysqli_query($con,"select * from teacher where staff_typ='nonteaching'");
...
<table class="table table-bordered" id="sample_1" style="font-size:12px; ">
			  ...
			  <tbody>
			  <?php
    $sql=mysqli_query($con,"select * from teacher where staff_typ='grd' and teacher_session='".$_SESSION['session']."'");
	...
	?>
          ...
          <tfoot> <tr><td colspan="9">  <input type="button" value="Print ID Cards " id="printcheckbox" style="width:125px;color:#FF0000;"></td> </tr></tfoot>
          </table>
