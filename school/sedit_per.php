...
student_gender='$student_gender',reg_no='$student_address',hname='$hname' where student_id='".$_POST["idm"]."' 
and student_session='".$sess."'");

mysqli_query($con,"update roll_no set rno='$rnoo' where sid='".$_POST["idm"]."' and ses='".$sess."'");
