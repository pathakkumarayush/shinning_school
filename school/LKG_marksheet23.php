...
if($rowstud['student_class']=='LKG' || $rowstud['student_class']=='LKG A' || $rowstud['student_class']=='LKG B')
{
$clls = 'LKG';
}
...
else if($rowstud['student_class']=='LKG A')
{
$sec = 'A';
}
else if($rowstud['student_class']=='LKG B')
{
$sec = 'B';
}
...
?>
<img src="fot.png" style="margin-left:5px; margin-top:34px;" />
<?php
}
?>
