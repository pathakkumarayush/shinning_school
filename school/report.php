...
<div class="full_div">
	...
	<a style="border-radius:5px;padding:5px;color:#FFFFFF; background-color:#ca68a3;font-size:15px;border-top-left-radius:7px;border-top-right-radius:7px; text-decoration:none;" href="<?php echo $var."report"."&&divid=2"; ?>">All Registered Student</a>&nbsp;
	
	<a style="border-radius:5px;padding:5px;color:#FFFFFF; background-color:#961149;font-size:15px;border-top-left-radius:7px;border-top-right-radius:7px; text-decoration:none;" href="<?php echo $var."report"."&&divid=8"; ?>">Registration Class Wise</a>&nbsp;
		

<?php /*?><a style="border-radius:5px;padding:5px;color:#FFFFFF; background-color:#9c7854;font-size:15px;border-top-left-radius:7px;border-top-right-radius:7px; text-decoration:none;" href="<?php echo $var."report"."&&divid=3"; ?>">Follow Up</a>&nbsp;<?php */?>

<?php /*?><a style="border-radius:5px;padding:5px;color:#FFFFFF; background-color:#524940;font-size:15px;border-top-left-radius:7px;border-top-right-radius:7px; text-decoration:none;" href="<?php echo $var."report"."&&divid=9"; ?>">Follow Up Class Wise</a>&nbsp;<?php */?>
...
&nbsp;&nbsp;<a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/reglist.php?status=<?php echo $_POST['status'];  ?>')">     <input type="button" value="Print" style="width:100px;"></a>
	    ...
	    {
	    $search=mysqli_query($con,"select * from  reg  WHERE  student_class='".$_POST['class']."' and student_session='".$_SESSION['session']."'");
		$num=mysqli_num_rows($search);
        ?>
	    <table  id="tbl_exmm" width="100%" border="1" cellspacing="0" cellpadding="0">
	    <tr style="font-weight:bold">
