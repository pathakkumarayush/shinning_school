...
<div class="full_div">
        <br clear="all" />
        <div class="left_sect"><img src="images/Student Detail/home.png" /><a href="./?pageid=board_home">
	    ...
	    <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."studentdetailhomeb"."&&divid=4"; ?>">Search Student By Class Section</a>
	&nbsp;||&nbsp;
	
		
		 <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."studentdetailhomeb"."&&divid=2"; ?>">Search Student By Name</a>
       ...
       <?php
        ...
        <table style="margin:30px 0px 0px 70px; font-size:14px; width:300px">
         ...
         <?php
         $class=mysqli_query($con,"select distinct(class) from class where school='".$_SESSION['uid']."' and status='0'");
		 ?>
	 ...
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/studentlist.php?student_class=<?php echo $_POST['class'];  ?>')">     <input type="button" value="Print List " style="width:100px; position:absolute"></a>
	    ...
	    <td> <a href="<?php echo $var."upload_document&upstudid=".$studrow['student_id']; ?>" target="_blank">Upload Document</a>
