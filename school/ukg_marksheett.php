...
.sn{width:138px!important;font-size:18px!important;}
...
?>	
<div style="width:1050px;height:1530px; border:8px #FF5722 solid;font-family:Arial;background:url(wmm.png) no-repeat center;" class="fsz">
<br clear="all" />
...
<div style="width:60%; float:left;height:210px;text-transform: capitalize;">
...
<tr>
<td class="sn" colspan="2">D.O.B(In Words)&nbsp;&nbsp;:
<?php
...
<div style="width:39%; height:210px;float:left;">
...
<tr style="line-height:37px;"><td class="sn2">Admission No.</td><td class="snn">&nbsp;:&nbsp;<?php echo $rowstud['student_scholar']; ?></td></tr>
<tr style="line-height:37px;"><td class="sn2">FMID No.</td><td class="snn">&nbsp;:&nbsp;<?php echo ucwords($rowstud['family_id']); ?></td></tr>
<tr style="line-height:37px;"><td class="sn2">SSSM ID</td><td class="snn">&nbsp;:&nbsp;<?php echo $rowstud['student_rollno']; ?></td></tr>
<tr style="line-height:37px;"><td class="sn2">Aadhar No.</td><td class="snn">&nbsp;:&nbsp;<?php echo $rowstud['religion']; ?></td></tr>
</table>
</div>
...
<table border="0" width="" cellpadding="0" cellspacing="0" style="margin-left:5px; color:#0033CC; font-size:20PX;">
<tr><td colspan="5" align="center" style="font-weight:bold; font-size:24px;">Annual Result - 2022-2023</td></tr>
<tr>
<td>
<table class="tbl" border="1" cellpadding="0" cellspacing="0" style="color:#000000;border:1px #000000 solid;border-left:3px #000000 solid;border-top:2px #000000 solid;font-size:20PX; width:800PX;">
<tr align="center" style="font-weight:bold; color:#FF5722;">
...
<table class="tb2" border='1' cellpadding="0" cellspacing="0" style="width:240px;color:#000000;border-right:3px #000000 solid;border-top:2px #000000 solid;border-left:1px #000000 solid; font-size:20px;">
<tr style="font-weight:bold; color:#FF5722;">
...
<tr>
<td>
<table class="tbl" border="1" cellpadding="0" cellspacing="0" style="color:#000000;border:1px #000000 solid;border-left:3px #000000 solid;font-size:20PX; width:800PX;">
<tr align="center" style="font-weight:bold; color:#000;">
<td style="line-height:50px;width:68px;"></td>
<td style="line-height:50px; width:335px;border-left:3px #000000 solid;">Total</td>
<td style="line-height:50px;width:189px;border-left:3px #000000 solid;"><?php echo $tmt; ?></td>
<td style="line-height:50pxwidth:200px;;border-left:3px #000000 solid;">---</td>
</tr>
</table>
</td>

<td>
<table class="tbl" border="1" cellpadding="0" cellspacing="0" style="color:#000000;border:1px #000000 solid;border-right:3px #000000 solid;font-size:20PX; width:240PX;">
<tr align="center" style="font-weight:bold; color:#000;">
...
<span style="color:0033CC; margin-left:20px; font-weight:bold; font-size:20px;">Additional Subject</span>
...
<td style="width:190px;border-right:2px #000000 solid;">100</td>
<td style="width:192px;border-right:2px #000000 solid;">33</td>
...
<br clear="all" />
<table style="width:1036px; float:left;margin-left:50px;font-weight:bold; color: #0033CC; font-size:18px;" border="0" cellpadding="0" cellspacing="0">
<tr style="line-height:20px;">
<td style="width:1000px;">Result: 
<?php	
if($rowcount=='1')
{
$ppr = 'Supplementary';
...
</td> <td style="width:600px;">Percentage: <?php $perc = $ttmot1*100/$tmt;  echo $pr = substr($perc, 0, 3); ?> %
...
<table style="width:1036px; float:left;margin-left:50px;font-weight:bold; color: #0033CC;font-size:18px;" border="0" cellpadding="0" cellspacing="0">
<tr style="line-height:20px;">
<td style="width:945px;">Promoted to class: 
<?PHP
if($rowcount=='1')
{
$clss = 'Not Promoted';
...
<br clear="all" /><br clear="all" />
<table border="0" style="width:98%;margin-top:80px; margin-left:20px;font-weight:bold; font-size:20px;color:#FF5722;">
<tr>

<td style="width:325px;">Class Teacher</td>

<td style="width:240px;"> <span style="float:right;font-size:20px; margin-right:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Principal<br />Shining Public Hr. Sec. School<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Raisen(M.P.)</span></td>
</tr>
</table>
...
<img src="fo.png" style="width:1040px; margin-left:5px; margin-top:30px;" />
