...
<body>
<?php
$search=mysqli_query($con,"select * from student where id='".$_GET['id']."' and status='0' and transport_status='Active' order by student_name Asc");
...
?>
    <div style="width:640PX; height:175px; float:left; margin-top:30px; margin-left:15px;text-transform: uppercase; border:1PX #FF9900 solid;">
	 ...
	 <div style="width:100%;">
	  ...
	  <span style="font-size:10px; margin-left:2px; color:#FF0000;">SES.:<?php echo $_SESSION['session']; ?></span><br clear="all">
