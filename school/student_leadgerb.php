...
.row-fluid .span6 {
 ...
 {
 $id = $_GET['stdid'];
 $delete=mysqli_query($con,"delete from fee_detail_board where id='".$_GET['did']."'");
 }
 ?>
...
$memo=mysqli_query($con,"select * from fee_detail_board where session='".$_SESSION['session']."' and sch='$sch' ");               
...
<div class="full_div">
<br clear="all" />
<div class="left_sect"><img src="images/FEE Management/feehome.png" /><a href="./?pageid=board_home">
...
<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
            ...
            <div class="box-head">
			<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."student_leadgerb"."&&divid=3"; ?>">Search Student Class Wise </a>
			&nbsp;||&nbsp;
	...
	<td><?php echo $rowmemo['board_fee'];?></td>
	<td><?php echo $rowmemo['practical_fee'];?></td>
	<td><?php echo $rowmemo['fee_deposit'];?></td>
    <td><?php echo date("d-m-Y",strtotime($rowmemo['date']));?></td> 
    <td style="font-size:14px;">
   
	<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/printb1.php?id=<?php echo $rowmemo['id']; ?>')">
   Print
    </a>
	&nbsp;||&nbsp;
