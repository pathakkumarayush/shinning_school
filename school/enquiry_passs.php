   ...
   if(isset($_POST['submit']))
     {
	   ...
	   $query=mysqli_query($con,"insert into enquiry_passs(name,fname,mname,dob,aclass,pclass,percentage,mobile,address,gender,session,city,school,rmkm,rmkw,student,fn) values('".$_POST['name']."','".$_POST['fname']."','".$_POST['mname']."','$dt2','".$_POST['classs']."','$dt4','".$_POST['per']."','".$_POST['mobile']."','".$_POST['address']."','".$_POST['gender']."','".$_SESSION['session']."','".$_POST['city']."','".$_SESSION['uid']."','".$_POST['rmkm']."','".$_POST['rmkw']."','".$_POST['class']."','".$_POST['stdid']."') ");
...
{ 
    if(!confirm("Do You Want To Delete This Record")) { 
        return false;
              ...
              {
              $d=date("Y-m-d");
              $query=mysqli_query($con,"delete from enquiry_passs where id='".$_GET['did']."' ");	 
              }
			  ?>
...
<table border="0" style="margin:40px 0px 0px 20px">
          ...
          {
          ?>
          <option value="<?php echo $row['student_name']; ?>"><?php echo $row['student_name'].'-'.$row['student_fname']; ?></option>  
          <?php
          }
          ?>
          </select>
		  ...
		  <td>&nbsp;</td>
		   ...
		   <td>
		   <input type="text" name="fname" class="tb5" required>
         ...
         <tr>
		   ...
		   <td>
		   <input type="text" name="mname" class="tb5" required>
		...
		<tr>
          ...
          <tr>
            ...
            <div id="dvPassport" style="display: none; position:absolute">
			   ...
			   <select name="classs" class="tb5" placeholder='ghfg'>
...
$sql = "select * from  enquiry_passs order by id desc limit 5";
...
<a style="text-decoration:none; color:#FFFFFF" href="actions.php?status=<?php echo $row['id'];?>" class="act" onClick="return confirm('<?php echo $row['name']; ?>');">
&nbsp;Out</a>
                                  </div>
								   <?php
                                     }
...
<a style="text-decoration:none; color:#FFFFFF " href="actions.php?status=<?php echo $row['id'];?>" class="deact" onClick="return confirm('Out <?php echo $row['name']; ?>');"> &nbsp;&nbsp;In</a>
                                  </div>
								    <?php
                                     }
                                    ?>
...
<td style="width:80px;"> 
 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/print_passs.php?id=<?php echo $row['id']; ?>')">
 <input type="button" value="Print" style="width:100px;"></a> </td>
 
 <td><a href="<?php echo $var."enquiry_passs&did=".$row['id']; ?>" onClick="return confirmation();">Delete</a></td>
</tr>
<?php } ?>
</table>
