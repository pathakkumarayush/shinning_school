...
.tbl1 tr{line-height:50px!important;font-size:21px!important;}
...
<div style="width:1050px;height:1548px; border:6px #000 solid;font-family:Arial;" class="fsz">
<br clear="all" />
...
<div style="width:69%; float:left;height:300px;text-transform: capitalize;">
...
<tr style="line-height:50px;"><td class="sn2">Roll No.</td><td class="snn">&nbsp;:&nbsp;<?php echo ucwords($rowstud['rno']); ?></td></tr>
<tr style="line-height:50px;"><td class="sn2">Admission No.</td><td class="snn">&nbsp;:&nbsp;<span style="color:#FF0000;"><?php echo $rowstud['student_scholar']; ?></span></td></tr>
<tr style="line-height:50px;"><td class="sn2">FMID No.</td><td class="snn">&nbsp;:&nbsp;<?php echo $rowstud['family_id']; ?></td></tr>
<tr style="line-height:50px;"><td class="sn2">SSSMID</td><td class="snn">&nbsp;:&nbsp;<?php echo $rowstud['religion']; ?></td></tr>
<tr style="line-height:50px;"><td class="sn2">Aadhar No.</td><td class="snn">&nbsp;:&nbsp;<?php echo $rowstud['student_rollno']; ?></td></tr>
</table>
</div>
...
{
?>
<table border="0" width="" cellpadding="0" cellspacing="0" style="margin-left:3px; margin-top:0px;font-size:21px; color:#244357;">
<tr>
<td>
...
<td>
<table class="tb2" border="1" cellpadding="0" cellspacing="0" style="color:#FF0000; border-top:1px #000000 solid;border-right:3px #000000 solid; border-left:1px #000000 solid; font-size:21px; width:112px;">
