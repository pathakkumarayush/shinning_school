...
{	
$res_up=mysqli_query($con,"update student set status='".$_POST['status']."' where student_id='".$_POST["sid"]."' and student_session='".$_SESSION['session']."'");	
?>
<script type="text/javascript">
                    window.location="<?php echo $var."admini&&sumsg=Update Successfully"; ?>";
			       </script>
 <?php
}
   ?>
