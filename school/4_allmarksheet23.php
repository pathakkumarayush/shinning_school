...
<img src="upload/<?php echo $rowstud["student_img"]; ?>" style="border-radius:5px; width:170px; margin-left:20PX; height:200px;">
</td>
</tr>
...
if($rowstud['student_class']=='IV' || $rowstud['student_class']=='IV A' || $rowstud['student_class']=='IV B')
{
$clls = 'IV';
}
...
<?php
$msc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Monthly Evaluation' and subject='EVS' and ses='$ses'") 
or die(mysqli_error());
...
$psc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project' and subject='EVS' and ses='$ses'") 
or die(mysqli_error());
...
<?php
$mss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Monthly Evaluation' and subject='DRAWING' and ses='$ses'") 
or die(mysqli_error());
...
$pss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project' and subject='DRAWING' and ses='$ses'") 
or die(mysqli_error());
...
$mothly = $meng_m+$mhindi_m+$mmath_m+$msc_m;
$half = $heng_m+$hhindi_m+$hmath_m+$hsc_m;
$annual = $english100+$hindi100+$math100+$science100;



$mothly10 = $meng_m10+$mhindi_m10+$mmath_m10+$msc_m10;
$half20 = $heng_m20+$hhindi_m20+$hmath_m20+$hsc_m20;
$annual60 = $aeng_m60+$ahindi_m60+$amath_m60+$asc_m60;
$project60 = $peng_m10+$phindi_m10+$pmath_m10+$psc_m10;
$annual100 = $english+$hindi+$math+$science;
...
<td align="center" style="border-right:2px #000000 solid;">160</td>
...
<td>400</td><td><?php echo number_format($annual100, 2);?></td><td>Pass</td>

<td><?php $fg = $annual100*100/400; echo number_format($fg, 2);?>%</td>
<td>
<?php
                            if($fg > 85)
                             {
