...
<form name="f2" method="post" action="issuebooksave.php" enctype="multipart/form-data" onSubmit="return validation();" >
  ...
  <tr  class="table" >
    ...
    <td width="36">&nbsp;</td>
			 ...
			 ?>
            <td width="344"><select name="class" class="select" style="width:220px" onChange="showStudent(this.value)">
...
$rclass=mysqli_fetch_array($class);
 $search=mysqli_query($con,"select * from student where student_session='".$_SESSION['session']."' and status='0' and student_class='".$rclass['class']."' order by student_name Asc");
		   
		   ?>
			  <tr class="table" >
			   <td width="36">&nbsp;</td>
			  <td width="190">Student Name<input type="hidden" name="cl" value="<?php echo $rclass['class']; ?>" /></td> 
			 <td width="344"><select name="scholarno1" class="select" style="width:220px" >
