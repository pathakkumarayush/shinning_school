...
{
//$instn = $_POST['montha'];
$query=mysqli_query($con,"insert into fee_detail(session,class,inst_fee,tamnt,tpay,due,pay_type,fee_deposit,month,student,date,latefee,school,receiptno,current_month,instalment,remark,cno,cd,sch,bank,ne_no,ndat,colle,cba,cbno,name)
values('".$_POST['ses']."','".$_POST['class']."','".$_POST['inst_fee']."','".$_POST['amt']."','".$_POST['amt']."','$due','".$_POST['ftype']."','".$_POST['amntdeposit']."','".$_POST['montha']."','".$_POST['student']."','$datee',
'".$_POST['latefee']."','".$_SESSION['uid']."','".$_POST['srecipt']."','$m','$instn','".$_POST['rmk']."','".$_POST['cno']."',
'".$_POST['dat']."','".$_POST['sch']."','".$_POST['bank']."','".$_POST['ne_no']."','".$_POST['ndat']."','".$_POST['colle']."','".$_POST['cba']."','".$_POST['cbno']."','".$_POST['name']."')");
...
<div class="col_4">
	...
	<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return validateForm()" >
		  ...
		  <td> <input type="text" name="srecipt" style="width:140px"  value="<?php echo $rowid['max(id)']+1; ?>"  readonly="readonly" required/></td>
		  ...
		  <td><input type="text" name="sch" value="<?php echo $rowefee['sch']; ?>" style="width:140px"  readonly="readonly"/>
			 ...
			 <input type="hidden" name="class" value="<?php echo $rowefee['class']; ?>" style="width:140px" />
			 <input type="hidden" name="name" value="<?php echo $rowefee['name']; ?>" style="width:140px" />
		  </td>
		  </tr>
		  ...
		  <tr>
		  <td>Tution Fee</td>
		  <td><input type="text" name="inst_fee" value="<?php echo $rowefee['due']; ?>" style="width:140px" /></td>
		  ...
		  <tr>
		  <td>Total Fee Pay</td>
		  <td><input type="text" name="amt" value="<?php echo $rowefee['due']; ?>" style="width:140px" /></td>
		  <td>Fee Deposit</td>
		  <td><input type="text" name="amntdeposit" style="width:140px" required/></td>
		  </tr>
		  
		  <tr>
		  <td>Remark</td>
		  <td colspan="3"><textarea name="rmk" cols="55" rows="3"></textarea></td>
