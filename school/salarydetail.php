...
<h2 style="float:left; margin-left:10px; color:#006633; font-size:20px; margin-top:15px;">Teaching Staff Salary Details</h2>
...
<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."salarydetail"."&&divid=2"; ?>">
Search Staff By Name</a> || &nbsp;
<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."salarydetail"."&&divid=3"; ?>">All Staff</a>&nbsp;|| &nbsp;
<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."salarydetail"."&&divid=4"; ?>">All Staff Bank</a>&nbsp;|| &nbsp;
<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."salarydetail"."&&divid=5"; ?>">PF Staff</a>&nbsp;|| &nbsp;
<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."salarydetail"."&&divid=6"; ?>">Non-PF Staff</a>
</div>
<?php 
...
<form action="#" method="post" enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td><select name="eid" class="select" style="border-radius:4px; width:150px;">
				 ...
				 <?php
				   $teacher=mysqli_query($con,"select * from teacher where staff_typ='teaching'");
...
<center>Salary Month - <?php echo $_POST['month1']?></center><br />
  ...
  <?php
		$qry="select * from teacher_sal where session='".$_SESSION['session']."' and month='".$_POST['month1']."' and st='teaching'";
...
<tr><td colspan="19"><span style="float:right; font-weight:bold;">Total Amount&nbsp;</span></td><td>&nbsp;<b><?php echo $tnnt; ?></b></td></tr>
 <table>
	  <tr>
<td>
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/get_print.php?id=<?php echo  $_SESSION['allstid']; ?>')">
<input type="button" value="Generate Print" style="width:165px; line-height:13px; margin-left:0px; margin-top:15px" >
</a>
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/get_print_v.php?id=<?php echo  $_SESSION['allstid']; ?>')">
...
<?php 
  ...
  ?>
  <table  border="1" cellpadding="0" cellspacing="0" style="border:#33cc66 solid 20px; font-size:14px; color:#000000; overflow:scroll;width:1150px;" >
   <tr class="box-head" >
    <td align="center">S.N </td>
  ...
  <?php
	...
	<a href="<?php echo $var."edit_salary&eid=".$row['id']; ?>"><img src="edit.png" style="width:16px; height:16px;" /></a>
	</td>
	</tr>
	<?php
$i++;
...
<?php
  ...
  ?>
    ...
    <td align="center">Amount </td>
        ...
        <?php
        $qry="select * from teacher_sal where session='".$_SESSION['session']."' and month='".$_POST['month1']."' and st='teaching' and pf_type='Yes'";
...
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/getsal.php?id=<?php echo  $_SESSION['tid']; ?>')">
<input type="button" value="Generate Print" style="width:165px; line-height:13px; margin-left:0px; margin-top:15px" >
</a>
	  <?php
...
<center>Salary Month - <?php echo $_POST['month1']?></center><br />
  ...
  <?php
		$qry="select * from teacher_sal where session='".$_SESSION['session']."' and month='".$_POST['month1']."' and pf_type='Yes' and st='teaching'";
		...
		echo "<td>".$row["absent"]."</td>";
		?>
		<td><?php echo $totday = $row["workingd"]-$row["absent"]+$row["cl"]?></td>
		<?php
		echo "<td>".$row["act_basic"]."</td>";
	    echo "<td>".$row["act_hra"]."</td>";
		echo "<td>".$row["act_conv"]."</td>";
		...
		echo "<td>".$row["conv"]."</td>";
		echo "<td>".$row["ac_allow"]."</td>";
		$gd=$row["basic"]+$row["hra"]+$row["conv"]+$row["ac_allow"];
        echo "<td>".$gd."</td>";
		echo "<td>".$row["pf_ded"]."</td>";
		echo "<td>".$row["adv"]."</td>";
		echo "<td>".$row["dect"]."</td>";
...
<tr>
<td>
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/get_print_pf.php?idpf=<?php echo $_POST['month1']?>')">
<input type="button" value="Generate Print" style="width:165px; line-height:13px; margin-left:0px; margin-top:15px" >
</a>
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/print_vouch_pfdet.php?id=<?php echo $_POST['month1']?>')">
<input type="button" value="Print Voucher" style="width:165px; line-height:13px; margin-left:0px; margin-top:15px" >
</a>
</tr>
</td>
...
<center>Salary Month - <?php echo $_POST['month1']?></center><br />
  ...
  <?php
		$qry="select * from teacher_sal where session='".$_SESSION['session']."' and month='".$_POST['month1']."' and pf_type='No' and st='teaching'";
...
<tr>
<td>
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/get_print_npf.php?idn=<?php echo $_POST['month1']?>')">
<input type="button" value="Generate Print" style="width:165px; line-height:13px; margin-left:0px; margin-top:15px" >
</a>
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/print_vouch_npf.php?id=<?php echo $_POST['month1']?>')">
<input type="button" value="Print Voucher" style="width:165px; line-height:13px; margin-left:0px; margin-top:15px" >
</a>
</tr>
</td>
