...
<td colspan="5">&nbsp;Block : Sanchi</td><td colspan="76">&nbsp;District : Raisen</td>
</tr>
...
$english100 = $aeng_m+(float)$peng_m;
...
<?php  $aeng90 = $aeng_m*90/100;  echo $aeng5_5_90 = round($qeng5+(float)$heng5+(float)$aeng90); ?>
</td>
...
<td align="center">
<?php $amath90 = $amath_m*90/100;  echo  $math5_5_90 = round((float)$qmath5+(float)$hmath5+(float)$amath90); ?>
</td>
...
<td align="center">
<?php $asc90 = $asc_m*90/100; echo $sc5_5_90 = round((float)$qsc5+(float)$hsc5+(float)$asc90); ?></td>

<td align="center"><?php $psc90 = round($psc_m*90/100); echo $psc90; ?></td>


<td align="center">
<?php $ass90 = $ass_m*90/100;  echo $ss5_5_90 = round((float)$qss5+(float)$hss5+(float)$ass90); ?></td>
