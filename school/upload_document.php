...
?>
<script type="text/javascript">
             window.location="<?php echo $var."upload_document&&sumsg=Deleted Successfully&upstudid=".$sid; ?>";
</script>
...
?>
 <script type="text/javascript">
             window.location="<?php echo $var."upload_document&&sumsg=Updated Successfully&upstudid=".$_POST["sid"]; ?>";
 </script>
 <?php
}
?>
...
<div class="full_div">
<br clear="all" />
<div class="left_sect"><img src="images/Student Admission.png" /><a href="./?pageid=board_home">
...
<a href="<?php echo $var."upload_document&upstudid=".$_GET['upstudid']; ?>">
...
<span style="margin-left:45px; position:absolute;margin-top:7px;">Upload Document</span>
</div>
</a>
<br clear="all" />
</div>
		...
		<td>1.</td><td style="">Aadhaar Card</td><td>
		...
		<form method="post" name="myForm" id="myform" action="#" enctype="multipart/form-data" style="font-weight:bold">  
		<tr align="center" style="line-height:40px;font-weight:bold">
		<td>4.</td><td>Bank Passbook</td><td>
		...
		<form method="post" name="myForm" id="myform" action="#" enctype="multipart/form-data" style="font-weight:bold">  
		<tr align="center" style="line-height:40px;font-weight:bold">
		<td>5.</td><td>Other Document</td><td>
