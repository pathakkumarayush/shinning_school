...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">
 <a href="./?pageid=inventry_home" style="text-decoration:none">Inventory</a> ->Service Details</a>
 
 
 <a href="./?pageid=stock" style="color:#FFFFFF;float:right; margin-right:0px; background-color: #CC0000; margin-top:-5px; padding:6px; font-size:18px">Stock Details</a>
