...
{ 
    if(!confirm("Do You Want To Delete This Record")) { 
        return false;
              ...
              {
              $d=date("Y-m-d");
              $query=mysqli_query($con,"delete from enquiry_pass where id='".$_GET['did']."' ");	 
              }
			  ?>
<style>
...
<td style="width:80px;"> 
 ...
 <input type="button" value="Print" style="width:100px;"></a> </td>
  ...
  <td><a href="<?php echo $var."enquiry_pass&did=".$row['id']; ?>" onClick="return confirmation();">Delete</a></td>
</tr>
<?php } ?>
</table>
