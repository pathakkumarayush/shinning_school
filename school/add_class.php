...
<option>X F</option>
<option>XI</option>
<option>XI Maths</option>
<option>XI Bio</option>
<option>XI Com.</option>
<option>XI Math Bio</option>
<option>XI Bio Math</option>
<option>XII</option>
<option>XII Maths</option>
<option>XII Bio</option>
<option>XII Com.</option>
<option>XII Math Bio</option>
<option>XII Bio Math</option>
