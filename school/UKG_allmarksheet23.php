...
.tbl1 tr{line-height:35px!important;font-size:21px!important;}
...
?>	
<div style="width:1050px;height:1540px; border:4px #000 solid;font-family:Calisto MT;background:url(wn.png); background-repeat:no-repeat; background-position:center;" class="fsz">
<br clear="all" />
<div style="width:100%; margin:0 auto; height:auto;margin-top:-10px;">
<img src="nlogo.png" style="margin-left:10px;" />
<br clear="all" />
</div>
<br clear="all" />
<div style="width:100%; margin:0 auto; line-height:33px;margin-top:-5px; border-top:2px #000000 solid;border-bottom:2px #000000 solid;">
...
<table style="width:99%;font-size:21px;margin-left:5px; font-size:21px; margin-top:-10PX; font-weight:bold;color:#000000; border:1px #000000 solid;" border="1"  cellpadding="0" cellspacing="0" class="tbl1">
...
<img src="upload/<?php echo $rowstud["student_img"]; ?>" style="border-radius:5px; width:210px; margin-left:7PX; height:240px;">
</td>
</tr>
...
<div style="width:99%; margin:0 auto; line-height:28px;margin-top:0px; border-top:2px #000000 solid;border-bottom:2px #000000 solid;">
...
<table border="0" width="" cellpadding="0" cellspacing="0" style="margin-left:5px; color:#0033CC; font-size:21px; margin-top:-10px;">
<tr>
<td>
<table class="tbl" border="1" cellpadding="0" cellspacing="0" style="color:#000000;border:1px #000000 solid;border-left:3px #000000 solid;border-top:2px #000000 solid;font-size:21PX; width:800PX;">
<tr align="center" style="font-weight:bold; color:#FF0000;">
<td style="line-height:35px; width:70px;">S.N.</td>
<td style="line-height:35px; width:350px;border-left:3px #000000 solid;">Subject</td>
<td style="line-height:35px; width:200px;border-left:3px #000000 solid;">Max. Marks</td>
<td style="line-height:35px; width:200px;border-left:3px #000000 solid;">Min. Marks</td>
</tr>
<?php
$tmt=0;
...
<tr>
<td>
<table class="tbl" border="1" cellpadding="0" cellspacing="0" style="color:#000000;border:1px #000000 solid;border-left:3px #000000 solid;font-size:21px; width:800PX;">
<tr align="center" style="font-weight:bold; color:#000;">
<td style="line-height:35px;width:68px;"></td>
<td style="line-height:35px; width:335px;border-left:3px #000000 solid;">Total</td>
<td style="line-height:35px;width:189px;border-left:3px #000000 solid;"><?php echo $tmt; ?></td>
<td style="line-height:35pxwidth:200px;;border-left:3px #000000 solid;">---</td>
</tr>
</table>
</td>
...
<tr align="center" style="font-weight:bold; color:#000;">
<td style="line-height:35px;width:68px;"><?php echo $ttmot1; ?></td>
</tr>
</table>
</td>
...
<?PHP
$sid = $rowstud['student_id'];
$rmk=mysqli_query($con,"select * from health where student='$sid' and class='".$rowstud['student_class']."' and exam='Annual Evaluation' and session='$ses'");
...
<br clear="all" />
<table border="1" width="" cellpadding="0" cellspacing="0" style="margin-left:5px; border:2px #000000 solid; color:#000; margin-top:-15px; font-size:21px; width:99%;">
<tr align="center" style="line-height:25px;"><td style="width:70px;">1</td><td style="width:320px;" align="left">&nbsp;&nbsp;Drawing</td>
<td style="width:180px;">100</td><td style="width:180px;">33</td><td style="width:220px; font-weight:bold;"><?php echo $rowrmk['weight']; ?></td>
</tr>
<tr align="center" style="line-height:25px;"><td style="width:70px;">2</td><td style="width:320px;" align="left">&nbsp;&nbsp;G.K.</td>
<td style="width:180px;">100</td><td style="width:180px;">33</td><td style="width:220px; font-weight:bold;"><?php echo $rowrmk['height']; ?></td>
</tr>
</table>


<?php			
$qrst=mysqli_query($con,"select subject,obtainmarks,totalmarks,status from marks where student='$uid' and exam='Annual Evaluation' and status='fail' and ses='$ses'") 
or die(mysqli_error());
...
<br clear="all" />
<table style="width:1036px; float:left;margin-left:50px;font-weight:bold; color:#ff5722; font-size:21px;" border="0" cellpadding="0" cellspacing="0">
...
<table border="0" cellpadding="0" cellspacing="0" style="width:99%;font-size:21px; margin-top:75px; margin-left:10px;font-weight:bold;color:#0e4174;">
<tr>
...
<div style="width:100%; height:auto;">
<img src="fot1.png" style="margin-left:5px; margin-top:20px;" />
</div>
</div>
</div>	
