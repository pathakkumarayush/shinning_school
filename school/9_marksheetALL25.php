...
<br clear="all" />
<div style="width:99%;height:190px;text-transform: capitalize;">
...
$mqeng_75 = round($rowmeng['obtainmarks']*75/80);

$meng_m = $mqeng_75+$rowqpeng['obtainmarks'];
...
$mheng_75 = round($rowheng['obtainmarks']*75/80);

$heng_m = $mheng_75+$rowhpeng['obtainmarks'];
...
$mqhindi_75 = round($rowmhindi['obtainmarks']*75/80);

$mhindi_m = $mqhindi_75+$rowqphindi['obtainmarks'];
...
$mhhindi_75 = round($rowhhindi['obtainmarks']*75/80);


$hhindi_m = $mhhindi_75+$rowhphindi['obtainmarks'];
...
$mqsans_75 = round($rowmsans['obtainmarks']*75/80);
$msans_m = $mqsans_75+$rowqpsans['obtainmarks'];
...
$mhsans_75 = round($rowhsans['obtainmarks']*75/80);
$hsans_m = (float)$mhsans_75+(float)$rowhpsans['obtainmarks'];
...
$mqmath_75 = round($rowmmath['obtainmarks']*75/80);
$mmath_m = $mqmath_75+$rowqpmath['obtainmarks'];
...
$mhmath_75 = round($rowhmath['obtainmarks']*75/80);
$hmath_m = $mhmath_75+$rowhpmath['obtainmarks'];
...
$mqsc_75 = round($rowmsc['obtainmarks']*75/80);
$msc_m = $mqsc_75+$rowqpsc['obtainmarks'];
$msc_m5 = $msc_m*5/100;
...
$mhsc_75 = round($rowhsc['obtainmarks']*75/80);
$hsc_m = $mhsc_75+$rowhpsc['obtainmarks'];
$hsc_m5 = $hsc_m*5/100;
...
$mqss_75 = round($rowmss['obtainmarks']*75/80);
$mss_m =$mqss_75+$rowqpss['obtainmarks'];
$mss_m5 = $mss_m*5/100;
...
$mhss_75 = round($rowhss['obtainmarks']*75/80);
$hss_m = $mhss_75+$rowhpss['obtainmarks'];
$hss_m5 = $hss_m*5/100;
...
<!--<td align="center" style="border-right:2px #000000 solid;">100</td>-->
<?php /*?><td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $msans_m;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $hsans_m;  ?></td><?php */?>
<td align="center" style="border-right:2px #000000 solid;">75</td>
<td align="center" style="border-right:2px #000000 solid;">25</td>
<td align="center" style="border-right:2px #000000 solid;">100</td>
...
<td align="center" style="border-right:2px #000000 solid;" colspan="3">600</td>
