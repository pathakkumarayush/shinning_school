...
<div class="full_div">
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
		 ...
		 {
		  $searchs=mysqli_query($con,"select * from lang_skill where student='".$studrow['student_id']."' and class='".$studrow['student_class']."' and exam='".$_POST['exam']."' and session='".$_SESSION['session']."'");
...
var data_str= "cls="+cls+"&idm="+idm+"&exam="+exam+"&act_project="+act_project+"&dicussion="+dicussion;
