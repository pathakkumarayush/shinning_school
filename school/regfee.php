...
<?php
$res_stud=mysqli_query($con,"select * from reg where id='".$_SESSION['id']."'")or die(mysqli_error());
...
window.location="<?php echo $var."regfee&rno=$insertid";  ?>";
</script>
...
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/regreceipt.php?id=<?php echo $_GET['rno']; ?>')">
...
<form method="post" name="myForm" action="#" enctype="multipart/form-data" style="font-weight:bold;"  onsubmit="return(validate());">
    ...
    <td><input type="text" name="rno" class="tb5" value="<?php echo $rowstud['rno']; ?>" readonly="readonly"  required></td>
	</tr>
    ...
    <td><input type="text" name="mobile" class="tb5" value="<?php echo $rowstud['fmobile']; ?>" readonly="readonly" required></td>
	</tr>
	<tr> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
	<tr> 
