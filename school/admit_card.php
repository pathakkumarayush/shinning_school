...
.tab tr{ line-height:25px;}
	  ...
	  <center><span style="font-size:22px;">Annual Examination 2022-23</span></center>
	  ...
	  <div style="width:100%;height:34px;">
	   ...
	   <span style="float:right;font-size:16px; margin-right:20px;font-weight:bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Principal<br />Shining Public Hr. Sec. School<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Raisen</span>
