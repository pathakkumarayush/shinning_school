...
<td colspan="38">&nbsp;&nbsp;ANNUAL RESULT SHEET, SESSION <?php echo $_GET['ses']; ?>
...
<tr style="line-height:25px;color:#000000;font-size:21px; font-weight:bold;" align="left">
<td colspan="38">&nbsp;&nbsp;Name Of School - Shining Public Higher Secondary School</td>
</tr>
...
<td colspan="2">&nbsp;Block : Sanchi</td><td colspan="28">&nbsp;District : Raisen</td>
</tr>
...
<td colspan="3" align="center">Final Result</td>
</tr>
...
$heng_m400 = (float)$rowheng['obtainmarks']*40/60; 
$heng_m40 =  number_format($heng_m400, 2);
...
$hhindi_m400 = (float)$rowhhindi['obtainmarks']*40/60;
$hhindi_m40 =  number_format($hhindi_m400, 2);
...
$hmath_m400 = (float)$rowhmath['obtainmarks']*40/60;
$hmath_m40 =  number_format($hmath_m400, 2);
...
$hsc_m40 = (float)$rowhsc['obtainmarks']*40/60;
