...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Add Banks</h2>
</div>
<div class="col_4">
...
{
echo "<b class='b'>This Bank Already Exits</b>";
}
else
{
mysqli_query($con,"insert into country(bank,school) values('$bank','$school') ");
echo "<b class='b1'>Bank Add Successfully</b>";
}
...
<div class="col_6">
<div class="form-style-2-heading">Bannks</div>
	...
	while($row=mysqli_fetch_array($memo))
	{
		?>
                 <tr>
                  ...
                  <td><a style="color:#CC0033" href="<?php echo $var."add_bank"."&&did=".$row['id']; ?>" onClick="return confirmation();">Delete</a></td>
			     </tr>
