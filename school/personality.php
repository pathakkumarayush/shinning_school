...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">OTHER SUBJECTS MARKS</h2>
		 ...
		 <table style="width:100%;color:#000000">
		    ...
		    <tr style="color:#FFFFFF;text-align: center; background-color:#006699;">
             <th style="padding: 10px;">STUDENT NAME</th><th style="width:104px;">CLASS</th><th style="width:95px;">Exam</th>
              <th>IS CONFIDENT</th>
              <th >IS POLITE</th>
			  <th >GENIS RESPONSIBLE</th>
			  <th >IS DISCIPLINEDE</th>
			  <th >IS REGULAR</th>
			  <th >TAKES PRIDE IN
APPEARANCE</th>
			  <th >HAS A SENSE OF
SHARING</th>
		 ...
		 {
		  $searchs=mysqli_query($con,"select * from personality where student='".$studrow['student_id']."' and class='".$studrow['student_class']."' and exam='".$_POST['exam']."' and session='".$_SESSION['session']."'");
	     ...
	     <select name="confidant" class="select" id="confidant<?php echo $i;?>" style="width:105px;">
         <option value="">ATTITUDES & VALUES</option>
         <option value="ALWAYS" <?php if($studrows['confidant']=="ALWAYS") { ?> selected="selected" <?php }  ?>>ALWAYS</option>
         <option value="SOMETIMES" <?php if($studrows['confidant']=="SOMETIMES") { ?> selected="selected" <?php }  ?>>SOMETIMES</option>
	     <option value="NEVER" <?php if($studrows['confidant']=="NEVER") { ?> selected="selected" <?php }  ?>>NEVER</option>
         </select>
			
         </td>
		 <td>
           
		<select name="polite" class="select" id="polite<?php echo $i;?>" style="width:105px;">
         <option value="">ATTITUDES & VALUES</option>
         <option value="ALWAYS" <?php if($studrows['polite']=="ALWAYS") { ?> selected="selected" <?php }  ?>>ALWAYS</option>
         <option value="SOMETIMES" <?php if($studrows['polite']=="SOMETIMES") { ?> selected="selected" <?php }  ?>>SOMETIMES</option>
	     <option value="NEVER" <?php if($studrows['polite']=="NEVER") { ?> selected="selected" <?php }  ?>>NEVER</option>
         </select>
         </td>
		 
		  <td >
        
		 <select name="reponsible" class="select" id="reponsible<?php echo $i;?>" style="width:105px;">
         <option value="">ATTITUDES & VALUES</option>
         <option value="ALWAYS" <?php if($studrows['reponsible']=="ALWAYS") { ?> selected="selected" <?php }  ?>>ALWAYS</option>
         <option value="SOMETIMES" <?php if($studrows['reponsible']=="SOMETIMES") { ?> selected="selected" <?php }  ?>>SOMETIMES</option>
	     <option value="NEVER" <?php if($studrows['reponsible']=="NEVER") { ?> selected="selected" <?php }  ?>>NEVER</option>
         </select>
         </td>
		 
		  <td >
       
		 <select name="decipline" class="select" id="decipline<?php echo $i;?>" style="width:105px;">
         <option value="">ATTITUDES & VALUES</option>
         <option value="ALWAYS" <?php if($studrows['decipline']=="ALWAYS") { ?> selected="selected" <?php }  ?>>ALWAYS</option>
         <option value="SOMETIMES" <?php if($studrows['decipline']=="SOMETIMES") { ?> selected="selected" <?php }  ?>>SOMETIMES</option>
	     <option value="NEVER" <?php if($studrows['decipline']=="NEVER") { ?> selected="selected" <?php }  ?>>NEVER</option>
         </select>
         </td>
		 
		  <td >
         
			<select name="regular" class="select" id="regular<?php echo $i;?>" style="width:105px;">
         <option value="">ATTITUDES & VALUES</option>
         <option value="ALWAYS" <?php if($studrows['regular']=="ALWAYS") { ?> selected="selected" <?php }  ?>>ALWAYS</option>
         <option value="SOMETIMES" <?php if($studrows['regular']=="SOMETIMES") { ?> selected="selected" <?php }  ?>>SOMETIMES</option>
	     <option value="NEVER" <?php if($studrows['regular']=="NEVER") { ?> selected="selected" <?php }  ?>>NEVER</option>
         </select>
         </td>
		 
		  <td >
           
		 <select name="appe" class="select" id="appe<?php echo $i;?>" style="width:105px;">
         <option value="">ATTITUDES & VALUES</option>
         <option value="ALWAYS" <?php if($studrows['appe']=="ALWAYS") { ?> selected="selected" <?php }  ?>>ALWAYS</option>
         <option value="SOMETIMES" <?php if($studrows['appe']=="SOMETIMES") { ?> selected="selected" <?php }  ?>>SOMETIMES</option>
	     <option value="NEVER" <?php if($studrows['appe']=="NEVER") { ?> selected="selected" <?php }  ?>>NEVER</option>
         </select>
         </td>
		 
		  <td >
          <select name="sans" class="select" id="sans<?php echo $i;?>" style="width:105px;">
         <option value="">ATTITUDES & VALUES</option>
         <option value="ALWAYS" <?php if($studrows['sans']=="ALWAYS") { ?> selected="selected" <?php }  ?>>ALWAYS</option>
         <option value="SOMETIMES" <?php if($studrows['sans']=="SOMETIMES") { ?> selected="selected" <?php }  ?>>SOMETIMES</option>
	     <option value="NEVER" <?php if($studrows['sans']=="NEVER") { ?> selected="selected" <?php }  ?>>NEVER</option>
         </select>
         </td>
		 
		 
		 <td >
      <?php if(!empty($studrows['confidant']) || !empty($studrows['polite']) || !empty($studrows['reponsible']) || !empty($studrows['decipline']) || !empty($studrows['regular']) || !empty($studrows['appe']) || !empty($studrows['sans']) ){ ?>
...
var data_str= "cls="+cls+"&idm="+idm+"&exam="+exam+"&confidant="+confidant+"&polite="+polite+"&reponsible="+reponsible+"&decipline="+decipline+"&regular="+regular+"&appe="+appe+"&sans="+sans;
