...
<div class="full_div">
	    ...
	    <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."view_document"."&&divid=4"; ?>">Search Student By Class</a>
			&nbsp;||&nbsp;
		<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."view_document"."&&divid=2"; ?>">Search Student By Name</a>
		</div>				
	  ...
	  <?php
       ...
       <?php
		...
		<td>Student<br>SSSM ID</td>
		<td>Student<br>Bank Passbook</td>
		<td>Other Doc.</td>
        </tr>
    <?php
	...
	while($studrow=mysqli_fetch_array($search))
    {
		...
		?>
		<a href="document/<?php echo $studrow["sssmid_img"]; ?>" target="_blank">VIEW</a>
		<?php
		}
		?>
		</td>	
		...
		?>
		<a href="document/<?php echo $studrow["bank_img"]; ?>" target="_blank">VIEW</a>
		<?php
		}
		?>
		</td>	
