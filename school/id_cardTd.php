...
.tab tr{ line-height:30px;}
      ...
      <?php
	  $i=1;
	  $search=mysqli_query($con,"select * from teacher where staff_typ='grd' and teacher_session='".$_GET['ses']."' and status='Active' and school_type='higher'");
	  ...
	  <tr><td style="width:80px;color:#000000;">Designation&nbsp;:</td>  <td style="font-size:13px;"><?php echo $rowstud["designation"]; ?></td></tr>
