               ...
               $("#excel").click(function(){
                var file_name = $("#ses").val();
                  $("#sample_1").table2excel({
                    /*exclude: ".noExl",*/
                    name: "Worksheet Name",
                    filename: "Class Subject Teacher("+file_name+")", //do not include extension
...
{
mysqli_query($con,"insert into class_teacher_sub(class,teacher,teacher_session,sub)values('".$_POST["class"]."','".$_POST["teacher"]."','".$_SESSION['session']."',
'".$_POST["subject"]."')");
...
<tr>
<td>Class : </td>
<td><select name="class" class="class" style="width:150px; border-radius:4px;">
    <option value="-1">Select Class</option>
       <?php
...
<td></td><td><input type="submit" name="addclass"></td>
     ...
     <div class="box-head">
      ...
      <div class="table" style="border:#FF0000 0px solid; height:820px; overflow:scroll">
...
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/cslist.php?ses=<?php echo $_SESSION['session'];  ?>')"><input type="button" value="Print List " style="width:100px;">
</a>
			 </td>
