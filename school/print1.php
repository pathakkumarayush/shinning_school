	...
	<table class="table" style="margin:5px 0px 0px 1px; width:325px; font-size:12px;font-weight:bold;" border="0">
               ...
               <td colspan="4">Month :&nbsp;
                <?php 
				 ...
				 else if( $rowfeedetail['month']=='April,July,August,September,October,November,December,January,February') 
				 {
				 echo 'April to February';
				 }
				 else if( $rowfeedetail['month']=='April,July,August,September,October,November,December,January') 
				 {
				 echo 'April to January';
				 }
				 else if( $rowfeedetail['month']=='April,July,August,September,October,November,December') 
				 {
				 echo 'April to December';
				 }
				 else if( $rowfeedetail['month']=='April,July,August,September,October,November') 
				 {
				 echo 'April to November';
				 }
				 else if( $rowfeedetail['month']=='July,August,September,October,November,December,January,February,March') 
				 {
				 echo 'July to March';
				 }
				 else if( $rowfeedetail['month']=='July,August,September,October,November,December,January,February') 
				 {
				 echo 'July to February';
				 }
				 else if( $rowfeedetail['month']=='July,August,September,October,November,December,January') 
				 {
				 echo 'July to January';
				 }
				 else if( $rowfeedetail['month']=='July,August,September,October,November,December') 
				 {
				 echo 'July to December';
				 }
				 else if( $rowfeedetail['month']=='August,September,October,November,December,January,February,March') 
				 {
				 echo 'August to March';
				 }
				 else if( $rowfeedetail['month']=='August,September,October,November,December,January,February') 
				 {
				 echo 'August to February';
				 }
				 else if( $rowfeedetail['month']=='August,September,October,November,December,January') 
				 {
				 echo 'August to January';
				 }
				 else if( $rowfeedetail['month']=='September,October,November,December,January,February,March') 
				 {
				 echo 'September to March';
				 }
				 else if( $rowfeedetail['month']=='September,October,November,December,January,February') 
				 {
				 echo 'September to February';
				 }
				 else if( $rowfeedetail['month']=='October,November,December,January,February,March') 
				 {
		 ...
		 <?php }?>
		  ...
		  <?php /*?>  <tr style="line-height:22px;">
		  <td td colspan="3"><b>&nbsp;&nbsp;Collection</b>&nbsp;&nbsp;: <b><?php echo $rowfeedetail['colle']; ?></b></td>
		  </tr><?php */?>
		  <tr style="line-height:22px;">
		  <td td colspan="3"><b>&nbsp;&nbsp;Remark</b>&nbsp;&nbsp;: <b><?php echo $rowfeedetail['remark']; ?></b></td>
		  </tr>
		 ...
		 <?php /*?> <tr style="line-height:22px;">
		  <td td colspan="3"><b>&nbsp;&nbsp;Balance Fee</b>&nbsp;&nbsp;: <b><?php echo $bal; ?></b></td>
		  </tr><?php */?>
          </table>				
		  <br><br>
		  <span style="float:right; margin-right:25px">Authorized Signature</span>
