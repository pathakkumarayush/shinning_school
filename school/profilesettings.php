...
.col_4{ width:40%; height:3500px; margin-left:2px; background-color:#FFFFFF;float:left; margin-top:10px;}
...
{
$login=mysqli_query($con,"update login set pass='".$_POST['password']."' where uid='".$_POST['uid']."' and type='exa'");
...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Change Password-Subject Teaher</h2>

<a href="./?pageid=profilesettingt" style="color:#FFFFFF;float:right; background-color:#CC0033; margin-top:10px; padding:6px; font-size:18px">Class Teacher</a>
</div>
<div class="col_4">
...
<td>
<?php
$login=mysqli_query($con,"select * from login where type='exa'");
?>
...
<td></td><td><input type="submit" name="submit"></td>
 ...
 <table border="1" cellpadding="0" cellspacing="0" style="width:300px; height:300px; overflow:scroll;">
 ...
 <td>&nbsp;&nbsp;Password</td>
   ...
   <?php
    $sql=mysqli_query($con,"select * from  login where type='exa'");
