...
<body alink="#00FF66" link="#00CC00">
             ...
             // $d=date("Y-m-d");
			  ...
			  {
			  $search=mysqli_query($con,"select * from student where class='".$_POST['class']."' and  student_session='".$_SESSION['session']."' and status='0' order by student_name Asc");
				
			  $num=mysqli_num_rows($search);	   
			  }
			  else
          	  {
			  $search=mysqli_query($con,"select * from student where class='".$_POST['class']."' and student_section='".$_POST['section']."' and 
...
<div class="full_div">
	...
	&nbsp;||&nbsp;
	 ...
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/studentlists.php?student_class=<?php echo $_POST['class'];  ?>')">     <input type="button" value="Print List " style="width:100px; position:absolute"></a>
	 
	 
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/studentlistallca.php?ses=<?php echo $_SESSION['session'];  ?>')">     <input type="button" value="ALL STUDENT List " style="width:150px; margin-left:114PX;  position:absolute"></a>
	   ...
	   <?php  
		$maxcls=mysqli_query($con,"select count(student_id) from student where class='".$_POST['class']."' and student_session='".$_SESSION['session']."' and status='0'");
