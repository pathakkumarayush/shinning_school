...
<?php
   ...
   {
   if(empty($_POST['name']) || empty($_POST['store']) ||  empty($_POST['item'])  || empty($_POST['type']))
   {
   ...
   if(empty($err))
   {
    ...
    $item=implode(",",$v3);
    $query=mysqli_query($con,"insert into purchase(categories,item,supplier,date,address,type,amount,due,ino) values('".$_POST['store']."','$item','".$_POST['name']."','".$_POST['date']."','".$_POST['add']."','".$_POST['type']."','".$_POST['amount']."','".$_POST['due']."','".$_POST['ino']."')");
...
<div class="col_4" style="margin-top:0px; min-height:335px;" >
	...
	<td>&nbsp;</td>
	   ...
	   <tr>
		<td>Invoice No.</td>
		<td><input type="text" name="ino" class="tb5" style="width:217px;"></td>
	 </tr>
	 <tr>
    <td>&nbsp;</td>
	<td>&nbsp;</td>
	...
	<td>&nbsp;</td>
	  ...
	  <tr>
		<td>Date</td>
		<td><input type="text" name="date" class="tb5" style="width:217px;"></td>
	</tr>
	<tr>
    <td>&nbsp;</td>
	<td>&nbsp;</td>
