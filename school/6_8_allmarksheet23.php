...
.tbl tr{line-height:30px!important;}
.tbl1 tr{line-height:30px!important;}
...
<div style="width:99%;height:210px;text-transform: capitalize;">
...
<img src="upload/<?php echo $rowstud["student_img"]; ?>" style="border-radius:5px; width:170px; margin-left:25PX; height:200px;">
</td>
</tr>
...
if($rowstud['student_class']=='VI' || $rowstud['student_class']=='VI A' || $rowstud['student_class']=='VI B')
{
$clls = 'VI';
}
...
<td>&nbsp;
<?php 
if($rowstud['student_class']=='VI')
{
$sec = '-';
}
else if($rowstud['student_class']=='VI A')
{
$sec = 'A';
}
else if($rowstud['student_class']=='VI B')
{
$sec = 'B';
}
...
<td style="width:200px;border-right:2px #000000 solid;" rowspan="3">Subjects</td>
<td colspan="6" style="border-right:2px #000000 solid;">Educational Performance</td>
<td colspan="6" style="">Weightage Based Result
</td>
</tr>
...
<td colspan="2" style="border-right:2px #000000 solid;">Monthly<br />Evaluation</td>
<td colspan="2" style="border-right:2px #000000 solid;">Half Yearly<br />Evaluation</td>
<td colspan="2" style="border-right:2px #000000 solid;">Annual<br />Evaluation</td>
<td colspan="6" style="">Final Assessment (Max. Marks-100)<br />(Monthly10%+Half Yearly20%+Annual60%+Project10%=100%)</td>
</tr>

<tr style="font-size:15px;" align="center" class="mtr">
<td style="border-right:2px #000000 solid;">Max.</td><td style="border-right:2px #000000 solid;">Obt.</td>
<td style="border-right:2px #000000 solid;">Max.</td><td style="border-right:2px #000000 solid;">Obt.</td>
<td style="border-right:2px #000000 solid;">Max.</td><td style="border-right:2px #000000 solid;">Obt.</td>
<td style="border-right:2px #000000 solid;">Monthly</td><td style="border-right:2px #000000 solid;">Half Yearly</td>
<td style="border-right:2px #000000 solid;">Written</td><td style="border-right:2px #000000 solid;">Project</td><td style="border-right:2px #000000 solid;">Total</td>
<td style="">Grade</td>
</tr>
...
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $english100;  ?></td>

<td align="center" style="border-right:2px #000000 solid; color:#d54421;font-weight:bold;"><?php echo number_format($meng_m10, 2); ?></td>
<td align="center" style="border-right:2px #000000 solid; color:#00B0F0;font-weight:bold;"><?php echo number_format($heng_m20, 2);  ?></td>
<td align="center" style="border-right:2px #000000 solid; color:#cb6a1a;font-weight:bold;"><?php echo $aeng_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid; color:#7030A0;font-weight:bold;"><?php echo number_format($peng_m10, 2); ?></td>

<td align="center" style="border-right:2px #000000 solid; color:#00356A;font-weight:bold;"><?php echo number_format($english, 2); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $hindi100;  ?></td>

<td align="center" style="border-right:2px #000000 solid;color:#d54421;font-weight:bold;"><?php echo number_format($mhindi_m10, 2); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00B0F0;"><?php echo number_format($hhindi_m20, 2);  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#cb6a1a;"><?php echo $ahindi_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#7030A0;"><?php echo number_format($phindi_m10, 2); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A;"><?php echo number_format($hindi, 2); ?></td>
...
<tr style="line-height:30PX;">
<td style="width:200PX;border-right:2px #000000 solid;">&nbsp;<img src="ar.png"  style=""/>Sanskrit/Urdu</td>
<td align="center" style="border-right:2px #000000 solid;">40</td>
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $sanskrit100;  ?></td>

<td align="center" style="border-right:2px #000000 solid;color:#d54421;font-weight:bold;"><?php echo number_format($msans_m10, 2); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00B0F0;"><?php echo number_format($hsans_m20, 2);  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#cb6a1a;"><?php echo $asans_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#7030A0;"><?php echo number_format($psans_m10, 2); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A;"><?php echo number_format($sanskrit, 2); ?></td>
...
<?php 
							 ...
							 if($sanskrit > 75 && $sanskrit < 86)
                             {
                             $ressans= 'A';
                             }
							 if($sanskrit > 65 && $sanskrit < 76)
                             {
                             $ressans= 'B+';
                             }
							 if($sanskrit > 55 && $sanskrit < 66)
                             {
                             $ressans= 'B';
                             }
							 if($sanskrit > 50 && $sanskrit < 56)
                             {
                             $ressans= 'C+';
                             }
							 if($sanskrit > 45 && $sanskrit < 51)
                             {
                             $ressans= 'C';
                             }
							 if($sanskrit > 32 && $sanskrit < 46)
                             {
                             $ressans= 'D';
                             }
							 if($sanskrit < 33)
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $math100;  ?></td>

<td align="center" style="border-right:2px #000000 solid;color:#d54421;font-weight:bold;"><?php echo number_format($mmath_m10, 2); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00B0F0;"><?php echo number_format($hmath_m20, 2);  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#cb6a1a;"><?php echo $amath_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#7030A0;"><?php echo number_format($pmath_m10, 2); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A;"><?php echo number_format($math, 2); ?></td>
...
<tr style="line-height:30PX;">
<td style="width:200PX;border-right:2px #000000 solid;">&nbsp;<img src="ar.png"  style=""/>Science</td>
<td align="center" style="border-right:2px #000000 solid;">40</td>
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $science100;  ?></td>

<td align="center" style="border-right:2px #000000 solid;color:#d54421;font-weight:bold;"><?php echo number_format($msc_m10, 2); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00B0F0;"><?php echo number_format($hsc_m20, 2);  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#cb6a1a;"><?php echo $asc_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#7030A0;"><?php echo number_format($psc_m10, 2); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A;"><?php echo number_format($science, 2); ?></td>
...
<tr style="line-height:30PX;">
<td style="width:200PX;border-right:2px #000000 solid;">&nbsp;<img src="ar.png"  style=""/>Social Science</td>
<td align="center" style="border-right:2px #000000 solid;">40</td>
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $ss100;  ?></td>

<td align="center" style="border-right:2px #000000 solid;color:#d54421;font-weight:bold;"><?php echo number_format($mss_m10, 2); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00B0F0;"><?php echo number_format($hss_m20, 2);  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#cb6a1a;"><?php echo $ass_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#7030A0;"><?php echo number_format($pss_m10, 2); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A;"><?php echo number_format($ss, 2); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;">240</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $mothly;  ?></td>
<td align="center" style="border-right:2px #000000 solid;">360</td>
...
<td align="center" style="border-right:2px #000000 solid;color:#d54421;font-weight:bold;"><?php echo number_format($mothly10, 2); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00B0F0;"><?php echo number_format($half20, 2);  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#cb6a1a;"><?php echo $annual60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#7030A0;"><?php echo number_format($project60, 2); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A;"><?php echo number_format($annual100, 2); ?></td>

<td align="center" style="font-weight:bold;color:#2d3b87;">
<?php  $fg = $annual100*100/600;
...
<td align="center" style="border-right:2px #000000 solid;">40</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $mgk_m;  ?></td>
<td align="center" style="border-right:2px #000000 solid;">60</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $hgk_m;  ?></td>
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $gk100;  ?></td>

<td align="center" style="border-right:2px #000000 solid;color:#d54421;font-weight:bold;"><?php echo number_format($mgk_m10, 2); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00B0F0;"><?php echo number_format($hgk_m20, 2);  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#cb6a1a;"><?php echo $agk_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#7030A0;"><?php echo number_format($pgk_m10, 2); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A;"><?php echo number_format($gk, 2); ?></td>
...
<td>600</td><td><?php echo number_format($annual100, 2); ?></td><td>Pass</td>

<td><?php $fg = $annual100*100/600; echo number_format($fg, 2);?>%</td>
<td>
<?php
                             if($fg > 85)
                             {
