...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Student Transport Fee Details</h2>
<a href="./?pageid=feecollectinby_month" style="color:#FFFFFF;float:right; background-color:#009966; margin-top:10px; padding:6px; font-size:18px">Tution Fee</a>
</div>
<div class="col_4">

<form action="#" method="post" enctype="multipart/form-data">
				 <div class="box-head" style="font-size:18px">
					 <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."trans_fee_month"; ?>"><a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."feecollectinby_month"."&&divid=2"; ?>">Toal Fee Collection By b/w date and Month</a>
						</div>
       ...
       <div style="border: solid #000 0px; width:500; margin-left:30px; border-radius:5px; margin-top:7px;">
		...
		<br>
			  ...
			  <?php
                   ...
                   $b=$_POST['to'];
				   $c=$_POST['class'];
				   $search=mysqli_query($con,"select * from fee_detail_trans where session='".$_SESSION['session']."' and date BETWEEN '$a' AND '$b' AND class='$c'");
			 ...
			 <h2 align="center" style="margin-top:10px; color:#990033">Transport Income Report Class <?php echo $c ?> </h2>
