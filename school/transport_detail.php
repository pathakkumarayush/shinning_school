    ...
    <?php
	 ...
	 ?>
         ...
         <table border="0" style="margin:10px 0px 0px 20px">
			...
			<option value="Rout 1">Rout 1</option>
			<option value="Rout 2">Rout 2</option>
		    <option value="Rout 3">Rout 3</option>
			<option value="Rout 4">Rout 4</option>
			<option value="Rout 5">Rout 5</option>
			 </select>
