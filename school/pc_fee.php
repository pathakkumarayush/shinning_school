...
<div class="full_div">
<br clear="all" />
<div class="left_sect"><img src="images/FEE Management/feehome.png" /><a href="./?pageid=p_fee">
...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Previous Year Fee Report Class Wise
</h2>
</div>
<div class="col_4">
  ...
  <form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
            <div class="box-head">
		  Previous Year Fee Report Class Wise
		    </div>
	 ...
	 <a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/feelistc.php?class=<?php echo $_POST['class']."&ses=".$_SESSION['session'];  ?>')"><input type="button" value="Print List " style="width:100px; position:absolute"></a>
	...
	<td>
	   ...
	   <?php
	   $enquiry=mysqli_query($con,"select * from privious_fee where cid='".$_POST['class']."' and session='".$_SESSION['session']."'");
       $i=1;
...
?>			
	...
	<td><?php echo  $enquiryrow['amt'] - $depo-$tcon; ?></td>
	    ...
	    <td> 
	    <a href="<?php echo $var."pc_fee&did=".$enquiryrow['id']; ?>" onClick="return confirmation();">Delete</a>
