...
<table border="1" id="sample_1" cellspacing="0" cellpadding="0" style="width:900px;">
		...
		$maxcls=mysqli_query($con,"select count(student_id) from student where class='".$_GET['student_class']."' and student_session='".$_SESSION['session']."' and status='0'");
	  ...
	  $i=1;
        ...
        $search=mysqli_query($con,"select * from student where class='".$_GET['student_class']."' and  student_session='".$_SESSION['session']."' and status='0' order by student_class,student_name asc");
