...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Student ID Card Details</h2>
        </div>
        <div class="col_4">
	    ...
	    <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."pro_detail"."&&divid=4"; ?>">Search Student By Class</a>
		
		 &nbsp;||&nbsp;
		 <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."pro_detail"."&&divid=2"; ?>">Search Student By Name</a>
		</div>				
	 ...
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/id_cards.php?student_class=<?php echo $_POST['class']."&ses=".$_SESSION['session'];  ?>')">     <input type="button" value="Print ID Cards " style="width:125px; position:absolute"></a>
	 
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/id_cardsall.php?student_class=<?php echo $_POST['class']."&ses=".$_SESSION['session'];  ?>')">     <input type="button" value="All Print ID Cards " style="width:150px;margin-left:150px; position:absolute"></a>
	 
	 
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/admitcard.php?student_class=<?php echo $_POST['class']."&ses=".$_SESSION['session'];  ?>')">     <input type="button" value="Print Admit Cards " style="width:150px; margin-left:350px; position:absolute"></a>
	 
	 
	  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/buscard.php?student_class=<?php echo $_POST['class']."&ses=".$_SESSION['session'];  ?>')">     <input type="button" value="Print Bus Cards " style="width:150px; margin-left:500px; position:absolute"></a>
        ...
        <td><input type="checkbox" name="ids[]" value="<?php echo $studrow['id']; ?>"></td>
        <td><?php echo $i; ?></td>
	    ...
	    <td>
	<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/printa.php?id=<?php echo $studrow['id']; ?>')">
   Print
    </a>
    ...
    <?php
	 ...
	 <tr><td colspan="10">  <input type="button" value="Print ID Cards " id="printcheckbox" style="width:125px;color:#FF0000;"></td> </tr>
    <?php	}
	else
	{
	?>
...
<script>
     ...
     document.getElementById('printcheckbox').addEventListener('click', function () {
          ...
          // Submit the form normally for ID Cards
              ...
              const url = `https://smarterponline.com/shining/school/selected_id_cards.php?ses=${ses}&ids=${ids.join(",")}`;
              popitup(url);
        });
</script>
