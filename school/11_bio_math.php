...
<div style="width:99%;height:250px;text-transform: capitalize;">
...
$gtm = $theng100+$thhindi100+$thsans100+$thsc100+$thss100;

$mothly = $meng_m+$msans_m+$mhindi_m+$msc_m+$mss_m;
$half = $heng_m+$hsans_m+$hhindi_m+$hsc_m+$hss_m;
$annual = $english100+$hindi100+$sanskrit100+$science100+$ss100;
...
<tr style="line-height:40PX;">
<td style="border-right:2px #000000 solid;">&nbsp;<img src="ar.png"  style=""/>Biology</td>
<td align="center" style="border-right:2px #000000 solid;">100</td>
...
><td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo number_format($msans_m5, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo number_format($hsans_m5, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo number_format($asans_m90, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo number_format($psans_m90, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo round($thsans); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo round($psans_m90); ?></td>
...
<tr style="line-height:40PX;">
<td colspan="20"><span style="color:#2d3b87; font-size:22px;font-family:Calisto MT; font-weight:bold; margin-left:25PX;">
...
<table border="0" cellpadding="0" cellspacing="0" style="width:99%;font-size:21px; margin-top:30px; margin-left:10px;font-weight:bold;color:#000000;">
<tr>
