...
$d = date("d-m-Y");
$t = 'tech';
 $query=mysqli_query($con,"insert into renewbook(bno,name,sname,sid,idate,ddate,date,amt,type,ses) values('".$_POST['bno']."','".$_POST['title']."','".$_POST['tname']."','".$_POST['sid']."','".$_POST['doe']."','".$_POST['due']."','$d','".$_POST['famt']."','$t','".$_SESSION['session']."') "); 
