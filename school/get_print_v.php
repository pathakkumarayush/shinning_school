...
<div id="dvContainer">
    <?php
    $qry="select * from teacher_sal where session='".$_SESSION['session']."' and st='teaching' and month='".$_GET['id']."' ";
	...
	$rowss['teacher_name'];
    ?>
<div style="width:550px; height:470px; border:4px #000000 solid;">
<div style="width:100%;"><span style="font-size:20px; margin-left:50PX; font-weight:bold;font-family:Calibri (Body);"><?php echo $rowsch['school_name'];?></span></div>
...
<tr style="line-height:19px;"><td colspan="4">
<br clear="all">
