...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Add Teacher Task </h2>
</div>
<?php
if(!empty($_GET['did']))
{
...
Total Staff: <?php echo $maxrow['count(teacher_id)']; ?>
...
<table class="table table-bordered" id="sample_1" style="font-size:12px; ">
			  ...
			  <tbody>
			  <?php
              $sql=mysqli_query($con,"select * from teacher where status='Active' and teacher_session='".$_SESSION['session']."' ORDER BY staff_typ DESC, teacher_name ASC");
	          $i=1;
		      ...
		      ?>
               <tr style="line-height:20px;">
	              ...
	              <td><a href="<?php echo $var."add_task&uid=".$row["teacher_id"];  ?>" target="_blank" style="font-weight:bold;">ADD TASK</a></td>
