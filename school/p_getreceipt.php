...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <div>
		<div> <img src="shining.png" style="width:329px; height:50px; margin-left:1px;">  </div>
		<div>
		<br>
		<label style="font-size:15px; font-weight:bold;  margin-left:15px">RECEIPT - Office Copy (Previous Year Fee)</label>
		</div>
		</div>
		<br clear="all">
	    <div style=" border:#000000 1px solid; width:698x; margin:0px 0px 0px 0px;"></div>
		 ...
		 <tr>
               ...
               <td colspan="4">Fee Ac. No. :&nbsp;
               <?php echo $rowfeedetail['acn'];  ?></td>
			   </tr>
		...
		<div style="border:#CCC 1px solid; float:right; height:450px;width:330px;">
        <div>
		<div> <img src="shining.png" style="width:329px; height:50px; margin-left:1px;">  </div>
		<div>
		...
		<br>
		<label style="font-size:15px; font-weight:bold;  margin-left:15px">RECEIPT - Student Copy (Previous Year Fee)</label>
		</div>
		</div>
		<br clear="all">
	    <div style=" border:#000000 1px solid; width:698x; margin:0px 0px 0px 0px;"></div>
