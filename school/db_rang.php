	...
	<div class="shell"  >
		<div id="main" >
			...
			<div id="content" style="border:#F00 0px solid; width:990px; height:auto">
				...
				<div  style="border:#FF0000 0px solid; height:400px; margin-top:100px">
				 ...
				 <span style="float:right"><a href="./?pageid=feecollection_home" style="color:#FFFFFF; font-size:18px">Back</a></span>
                 <div class="box-head" style="margin-top:20px; font-size:18px">
			   <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="<?php echo $var."db_fee_date"."&&divid=1"; ?>">Today Collection </a>&nbsp;||&nbsp;
			 <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."db_fee_date"."&&divid=2"; ?>">Collection By Date</a>&nbsp;||&nbsp;
			    <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."db_rang"?>">Search By Date Range</a>
		...
		<br>
			 ...
			 <table width="100%" border="2" cellspacing="0" cellpadding="0" style=" font-size:14px">
		      ...
		      $a=$_POST['from'];
              $b=$_POST['to'];
		      $searchs=mysqli_query($con,"select date,SUM(fee_deposit) from fee_db where session='".$_SESSION['session']."' and date BETWEEN '$a' AND '$b' GROUP BY date");
		 ...
		 $sch=mysqli_query($con,"select * from school");
			...
			$rowsch['school_name'];
			  ...
			  <h2 align="center" style="margin-top:10px; color:#990033"><?php echo $rowsch['school_name'];?> </h2>
			  <h2 align="center" style="margin-top:10px; color:#990033"> Income Report</h2>
			  ...
			  <td align="center"><a href="db_collection.php?date=<?php echo $studrow['date']; ?>" >View</a> </td>
			  </tr>
			  <?php $i++; } ?>	
