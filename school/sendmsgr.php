...
<tr><td align="center" colspan="10"><center><h2>Class:&nbsp; <?php echo $maxmarkr; ?></h2></center>
	<center><h2 style="margin-top:5px;">Exam:&nbsp; <?php echo $_POST['exam']; ?>&nbsp;&nbsp;Session:&nbsp; <?php echo $_REQUEST["session"]; ?></h2></center></td></tr>
...
$res1=mysqli_query($con,"select * from student where student_class='".$rowclass['class']."' and student_section='".$rowclass['class_section']."' and student_session='".$_SESSION['session']."' and status='0' order by student_rollno Asc")or die(mysqli_error());
$i=1;
