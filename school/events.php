...
<div class="full_div">
<br clear="all" />
<div class="left_sect"><img src="images/ac/cale.png" /><a href="./?pageid=school_event">
...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">School Event and Holiday</h2>

<a href="<?php echo $var."events" ?>" style="border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px">Search Class Wise</a>
...
<tr>
 ...
 <tr>
         <td>Month<span class="textfieldRequiredMsg"></span></td>
       
         <td>
		 <select name="month" class="select" style="width:150px" onChange="showSection(this.value)">
...
<tr>
<td>&nbsp;</td><td><input type="submit" value="Search" name="submitt"></td>
</tr>
</table>
    ...
    {
    $memo=mysqli_query($con,"select * from event_calendar where class='".$_POST['class']."' and month1='".$_POST['month']."' and  session='".$_SESSION['session']."' ORDER BY event_date ASC");
    $i=1;
