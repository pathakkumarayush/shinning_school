...
{
//$instn = $_POST['montha'];
$query=mysqli_query($con,"insert into fee_detail(session,class,adm_fee,caution,inst_fee,tamnt,tpay,due,pdue,pay_type,fee_deposit,month,student,date,latefee,concession,school,receiptno,current_month,instalment,extra_amnt,remark,cno,cd,padv,sch,bank,ne_no,ndat,colle,cba,cbno,name,ptype,acn)
values('".$_POST['ses']."','".$_POST['class']."','".$_POST['admissionfee']."','".$_POST['caution']."','".$_POST['inst_fee']."','".$_POST['amt']."','".$_POST['tamount']."','$due','".$_POST['pdue']."','".$_POST['ftype']."','".$_POST['amntdeposit']."','".$_POST['montha']."','".$_POST['student']."','$datee','".$_POST['latefee1']."','".$_POST['concession']."','".$_SESSION['uid']."','".$_POST['srecipt']."','$m',
'$instn','$extra','".$_POST['remarks']."','".$_POST['cno']."','".$_POST['dat']."','".$_POST['padv']."','".$_POST['sch']."','".$_POST['bank']."','".$_POST['ne_no']."','".$_POST['ndat']."','".$_POST['colle']."','".$_POST['cba']."','".$_POST['cbno']."','".$_POST['nnm']."','adm','".$_POST['acn']."')");
...
?> <br clear="all"> <br clear="all">
		  ...
		  <a href="./?pageid=pay_feer" style="color:#FFFFFF;font-size:18px; ">Pay Registration Fee</a>&nbsp;&nbsp;
		 ...
		 ?>
		  ...
		  <?php
		  $search1=mysqli_query($con,"select * from fee_detail where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."'  and student='".$studrow['student_id']."' and ptype='adm' order by id desc limit 1"); 
