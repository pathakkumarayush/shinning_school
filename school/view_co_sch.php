...
<div class="full_div">
        ...
        <div class="table" style="min-height:480px; width:1087px;">
		 ...
		 $search=mysqli_query($con,"select * from other_marks where class='".$_POST['class']."' and exam='".$_POST['exam']."'");
         ?>
		 ...
		 <th>Term</th><th>Art/Craft</th><th>Music</th><th>Dance</th> <th>Game</th><th>Moral</th><th>GK</th><th>Conver.</th>
		 <th>Action</th>
		 ...
		 <td><?php echo $studrow['art']; ?></td>
		 <td><?php echo $studrow['music']; ?></td>
		 <td><?php echo $studrow['dance']; ?></td>
		 <td><?php echo $studrow['game']; ?></td>
		 <td><?php echo $studrow['moral']; ?></td>
		 <td><?php echo $studrow['gk']; ?></td>
		  <td><?php echo $studrow['con']; ?></td>
