...
?>
<div class="col_4">
<div class="form-style-2-heading" style="font-style:normal;">Total Student: <?php echo $maxrow['count(student_id)']; ?></div>
	...
	while($row=mysqli_fetch_array( $sql))
	{
		?>
               <tr>
				  ...
				  <a href="<?php echo $var."vadmission&upstudid=".$row['student_id']; ?>">View Details</a>
