...
<?php 
$exam=mysqli_query($con,"select * from examination where school='".$_SESSION["uid"]."' and examination_session='".$_SESSION['session']."'"); ?>
  
    <select name="examination" class="select" style="width:150px;" >
...
<?php 
$cls=mysqli_query($con,"select * from class where school='".$_SESSION["uid"]."'"); ?>
  
    <select name="class" class="select" style="width:150px;">
    <option>Select</option>
	<?php while ($rowc=mysqli_fetch_array($cls)) { ?>
	<option value="<?php echo $rowc["class"]; ?>"><?php echo $rowc["class"]; ?></option>
	<?php } ?>
	</select></td>
  </tr>
  <tr>
