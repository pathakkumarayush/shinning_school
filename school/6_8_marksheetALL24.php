...
<div style="width:1050px;height:1531px;font-family:Calisto MT;background:url(BK_3.png);background-repeat:no-repeat;background-position:center; background-position:center;" class="fsz">
<br clear="all" />
...
<?php
$msans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='MONTHLY TEST' and subject='Sanskrit/Urdu' and ses='$ses'") 
or die(mysqli_error());
$rowmsans=mysqli_fetch_array($msans);
$msans_m = $rowmsans['obtainmarks'] ?? '';
$msans_m10 = round((float)$msans_m*10/40);
...
$hsans_m20 = round((float)$hsans_m*20/60);
...
$psans_m10 = round((float)$psans_m*10/40);
...
<?php
$msc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='MONTHLY TEST' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
...
<?php
$mss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='MONTHLY TEST' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
$rowmss=mysqli_fetch_array($mss);
$mss_m = $rowmss['obtainmarks'] ?? '';
$mss_m10 = round((float)$mss_m*10/40);
...
$hss_m20 = round((float)$hss_m*20/60);
...
$pss_m10 = round((float)$pss_m*10/40);
...
$mgk_m10 = round((float)$mgk_m*10/40);
...
$hgk_m20 = round((float)$hgk_m*20/60);
...
$pgk_m10 = round((float)$pgk_m*10/40);
...
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($hhindi_m20);  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo $ahindi_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($phindi_m10); ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#00356A;"><?php echo round($hindi); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($msans_m10); ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($hsans_m20);  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo $asans_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($psans_m10); ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#00356A;"><?php echo round($sanskrit); ?></td>
<td align="center" style="font-weight:bold;color:#2d3b87;">
<?php 
                             if($sanskrit > 85)
                             {
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($mmath_m10); ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($hmath_m20);  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo $amath_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($pmath_m10); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($msc_m10); ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($hsc_m20);  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo $asc_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($psc_m10); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($mss_m10); ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($hss_m20);  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo $ass_m60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;color:#000;"><?php echo round($pss_m10); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;">600</td>
<td align="center" style="border-right:2px #000000 solid;color:#000;font-weight:bold;"><?php echo round($mothly10); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#000;"><?php echo round($half20);  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#000;"><?php echo $annual60;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#000;"><?php echo round($project60); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;">-</td>
<td align="center" style="border-right:2px #000000 solid;">-</td>
<td align="center" style="border-right:2px #000000 solid;">-</td>
<td align="center" style="border-right:2px #000000 solid;">-</td>
<td align="center" style="border-right:2px #000000 solid;">-</td>
...
<td>600</td><td><?php echo round($annual100); ?></td><td>Pass</td>

<td><?php $fg = $annual100*100/600; echo round($fg);?>%</td>
<td>
<?php
                             if($fg > 85)
                             {
...
<td style="width:320; color:#B9001C; font-weight:bold;border-top:2px #000 solid;border-bottom:2px #000 solid;">
<?php
                             if($fg > 90)
                             {
                             $rmk='Outstanding';
