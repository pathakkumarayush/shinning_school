...
<table border="1" id="sample_1" cellspacing="0" cellpadding="0" style="width:900px;">
		<tr align="center">
	    <td colspan="19">
		<span align="center" style="margin-top:20px; color:#006633;font-weight:bold;">Shining Middle School Raisen (M.P.)</span><br />
        </td>
		</tr>	
	  ...
	  $i=1;
        ...
        $search=mysqli_query($con,"select * from student where student_school='".$_SESSION['uid']."' and student_session='".$_GET['ses']."' and status='0' order by student_class,student_name Asc");
    ...
    <td align="center"><?php echo ucwords($studrow['class']);?></td>
