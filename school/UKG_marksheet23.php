...
?>	
<div style="width:1050px;height:1540px; border:4px #000 solid;font-family:Calisto MT;background:url(wn.png) no-repeat center;" class="fsz">
<br clear="all" />
...
<br clear="all" />
<div style="width:100%; margin:0 auto; line-height:33px;margin-top:0px; border-top:2px #000000 solid;border-bottom:2px #000000 solid;">
...
{
?>
<img src="fo.png" style="width:1040px; margin-left:5px; margin-top:150px;" />
<?php 
}else{
?>
<img src="fot1.png" style="margin-left:5px; margin-top:30px;" />
<?php
}
?>
