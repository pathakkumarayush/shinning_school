...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Teacher Book Renew Details Here</h2>
<a href="./?pageid=book_statusR" class="item" style="color:#000; margin-top:14px; float:right">Student Renew Book Details</a> 
</div>
...
<table class="table table-bordered"  border="1" id="sample_1" style="font-size:14px;" width="1141px">
			 ...
			 <tbody>
			 <?php
	         $sql="select * from renewbook where type='tech'";
