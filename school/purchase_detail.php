...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">
 <a href="./?pageid=inventry_home" style="text-decoration:none">Inventory</a> -> Purchase Details</a>
 
 
 <a href="./?pageid=service" style="color:#FFFFFF;float:right; margin-right:0px; background-color: #CC0000; margin-top:-5px; padding:6px; font-size:18px">Servic Details</a>
 <a href="./?pageid=stock" style="color:#FFFFFF;float:right; margin-left:300px; background-color: #009999; margin-top:-5px; padding:6px; font-size:18px">Stock Details</a>
 </h2>
</div>
<div class="col_4" style="margin-top:0px; min-height:335px;" >
  ...
  <br><br>
       ...
       <?php
        $memo=mysqli_query($con,"select * from purchase where type='purchase' order by id desc");
