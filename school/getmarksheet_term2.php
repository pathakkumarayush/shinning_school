...
<style>
.tbl{ width:240px;color:#303192; border:1px #303192 solid; font-size:20px; font-weight:bold;}
.tb2{ width:150px;color:#303192; border:1px #303192 solid;font-size:20px; font-weight:bold;}
.sn{ width:135px!important;}
.sn1{ width:125px!important;}
</style>
<body>
<div style="width:1038px; height:auto; background-color:#FDE7DC; border:16px #CC0000 solid;">
...
<span style="font-size:24px; color:#da1010;font-weight:bold;"><center>Panchkuiyaan Tiraha, Near Prakash Sales, Jhansi(U.P.)</center></span>
...
<br />
<br clear="all" />
<div style="width:100%; margin-top:3px; font-size:25px; background-color:#CC0000; height:auto; line-height:28px; color:#FFFFFF">
...
<div style="width:100%; margin-top:10px; background-color:#CC0000;font-size:25px;font-weight:bold; height:auto; line-height:29px; color:#FFFFFF">
...
<tr style="border:1px #303192 solid; line-height:50px; font-weight:bold;  font-size:20px; font-weight:bold;background-color:#ea7d75; color:#FFFFFF;">
