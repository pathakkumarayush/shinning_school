...
?>	
<div style="width:1050px;height:1548px; border:6px #000 solid;font-family:Arial;background:url(wmm.png) no-repeat center;" class="fsz">
<br clear="all" />
...
<tr style="line-height:37px;"><td class="sn2">Admission No.</td><td class="snn">&nbsp;:&nbsp;<span style="color:#FF0000;"><?php echo $rowstud['student_scholar']; ?></td></tr>
<tr style="line-height:37px;"><td class="sn2">FMID No.</td><td class="snn">&nbsp;:&nbsp;<?php echo ucwords($rowstud['family_id']); ?></td></tr>
<tr style="line-height:37px;"><td class="sn2">SSSM ID</td><td class="snn">&nbsp;:&nbsp;<?php echo $rowstud['religion']; ?></td></tr>
...
<tr><td colspan="5" align="center" style="font-weight:bold; font-size:25px;">First Terminal Result - <?php echo $_GET['ses'];?></td></tr>
<tr>
<td>
...
<?php
$sid = $rowstud['student_id'];
$att_re=mysqli_query($con,"select * from health where student='$sid' and class='".$rowstud['student_class']."' and exam='FIRST TERMINAL' and session='$ses'");
$rowar=mysqli_fetch_array($att_re);
...
<?php			
$qrst=mysqli_query($con,"select subject,obtainmarks,totalmarks,status from marks where student='$uid' and exam='FIRST TERMINAL' and status='fail' and ses='$ses'") 
or die(mysqli_error());
...
<td style="width:135px;">Divion</td>
<td>
:&nbsp;&nbsp;<?php                        if($rowcount > 0)
                             {
							 $res2='-';
...
<br clear="all" /><br clear="all" />
<table border="0" style="width:98%;margin-top:10px; margin-left:50px;font-weight:bold; font-size:22px;color: #FF0000;">
<tr>

<td style="width:325px;">Class Teacher</td>

<td style="width:240px;"> <span style="float:right;font-size:22px; margin-right:74px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Principal<br />Shining Public Hr. Sec. School<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Raisen(M.P.)</span></td>
</tr>
</table>
...
<div style="width:100%;"><img src="fo.png" style="width:1040px; margin-left:5px; margin-top:0px;" /></div>
