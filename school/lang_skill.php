...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Enter LANGUAGE SKILLS Marks</h2>
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
		 ...
		 {
		  $searchs=mysqli_query($con,"select * from lang_skill where student='".$studrow['student_id']."' and class='".$studrow['student_class']."' and exam='".$_POST['exam']."' and subject='".$_POST['subject']."' and session='".$_SESSION['session']."'");
		 ...
		 <td >
      <?php if(!empty($studrows['act_project']) || !empty($studrows['dicussion']) ){ ?>
...
var data_str= "cls="+cls+"&idm="+idm+"&exam="+exam+"&subject="+subject+"&act_project="+act_project+"&dicussion="+dicussion;
