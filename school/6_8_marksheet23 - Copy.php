...
<div style="width:1050px;height:1547px; border:5px #000 solid;font-family:Arial;" class="fsz">
<br clear="all" />
<div style="width:100%; margin:0 auto; height:auto;margin-top:-15px;">
<img src="sn.png" style=" margin-left:10px;" />
<br clear="all" />
</div>

<div style="width:100%; margin:0 auto; line-height:33px;margin-top:10px; border-top:3px #000000 solid;border-bottom:3px #000000 solid;">
...
<table style="width:100%;font-size:21px; margin-left:12px; font-size:21px; font-weight:bold;color:#000000; border:1px #000000 solid;" border="1"  cellpadding="0" cellspacing="0" class="tbl1">
<tr><td class="sn">Class</td><td class="snn">&nbsp;:&nbsp;<?php echo ucwords($rowstud['student_class']); ?></td></tr>
<tr><td class="sn">Student's Namee</td><td class="snn">&nbsp;:&nbsp;<?php echo ucwords($rowstud['student_name']); ?></td></tr>
...
<td style="width:335px;border-right:2px #000000 solid;">Computer & GK</td>
