...
<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
		  ...
		  &nbsp;||&nbsp;
			 ...
			 &nbsp;||&nbsp;
			  <a style=" border-radius:5px; padding:5 5 5 5 ; color:#FFFFFF; font-size:16px" href="./?pageid=feecollectionby_datee&&divid=1">Today Collection</a>&nbsp;||&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="./?pageid=feecollectionby_datee&&divid=2">Fee Collection date-wise</a>	
			  &nbsp;||&nbsp;<a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."date_rangp"."&&divid=2"; ?>">
		 ...
		 ?>
		   ...
		   <div id="printablediv" style="width: 100%;">
		    <h2 align="center" style="margin-top:9px; color:#006633"><?php echo $rowsch['school_name'];?></h2>
                   <h2 align="center" style="margin-top:9px; color:#006633">Previous Fee - Session: <?php echo $_SESSION['session']; ?></h2>
         ...
         <?php
	      ...
	      ?>
		   ...
		   <table width="90%" id="tbl_exm" border="1" cellspacing="0" cellpadding="0" style="margin:10px 0px 0px 20px; font-size:14px">
		      <tr style="line-height:40px;"><td colspan="7"><a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/date_listp.php?ses=<?php echo $_SESSION['session'];  ?>')"> 
			...
			$today=date("Y-m-d");
			  $search=mysqli_query($con,"select * from fee_detail_preivios where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."'  and date='".$today."'");
	   ...
	   <h2 align="center" style="margin-top:9px; color:#006633">Date: <?php echo date("d-m-Y",strtotime($_POST['date'])); ?></h2>
		   <table id="tbl_exml" width="90%" border="1" cellspacing="0" cellpadding="0" style="margin:10px 0px 0px 50px; font-size:14px">
		        <tr style="line-height:40px;"><td colspan="7">
				  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/date_listtp.php?date=<?php echo $_POST['from']."&ses=".$_SESSION['session'] ;  ?>')">     <input type="button" value="Print List " style="width:100px; position:absolute"></a>
			  ...
			  $search=mysqli_query($con,"select * from fee_detail_preivios where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."'  and date='".$_POST['from']."'");
			...
			<tr style="font-weight:bold">
				...
				<td>Cash Amt -
			<?php
$searchca=mysqli_query($con,"select * from fee_detail_preivios where session='".$_SESSION['session']."' and ftype='Cash' and date='".$_POST['from']."'");
			 while($studrowca=mysqli_fetch_array($searchca))
			  {
			  $valca+=$studrowca['fee_deposit']; 
			  }
				...
				Paytm Amt - 
				<?php
		 $searchon=mysqli_query($con,"select * from fee_detail_preivios where session='".$_SESSION['session']."' and ftype='Paytm' and date='".$_POST['from']."'");
			 while($studrowon=mysqli_fetch_array($searchon))
			  {
			  $valon+=$studrowon['fee_deposit']; 
			  }
