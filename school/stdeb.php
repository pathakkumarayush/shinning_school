...
<div class="full_div">
        <br clear="all" />
        <div class="left_sect"><img src="images/Transport/trans.png" style="width:500px; height:80px;" />
		<a href="./?pageid=transport_home">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">BUS STATUS</h2>
		<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/bus_c.php?ses=<?php echo $_SESSION['session']; ?>')"> <input type="button" value="Print Cards " style="width:120px; position:absolute;margin-left:220px;"></a>
        </div>
        <div class="col_4">
	   ...
	   <select name="ses" style="width:200px;" class="select">
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
		 ...
		 /*echo $_POST['class'];
		 echo $_POST['exam'];*/
		 $search=mysqli_query($con,"select * from student where student_session='".$_POST['ses']."' and status='0' and transport_status='Active' order by student_name Asc");
         ?>
		 <form action="" method="post">
		 <table style="width:100%;color:#000000">
             <thead>
		     <tr style="color:#FFFFFF;text-align: center; background-color:#006699;">
			 <th style="padding: 10px;">Adm_No.</th>
         ...
         <input type="text" name="m_name" value="<?php echo $studrow['m_name']; ?>" id="m_name<?php echo $i;?>" style="width:100px;">
		  ...
		  <td>
         <input type="text" name="student_contactno" value="<?php echo $studrow['student_id']; ?>" id="student_contactno<?php echo $i;?>" maxlength="10" style="width:85px;">
         </td>
		 
		  <td>
         <input type="text" name="student_dob" value="<?php echo $studrow['bus']; ?>" id="student_dob<?php echo $i;?>" style="width:70px;">
         </td>
...
var data_str= "student_class="+student_class+"&idm="+idm+"&student_name="+student_name+"&student_fname="+student_fname+"&m_name="+m_name+"&student_contactno="+student_contactno+"&student_scholar="+student_scholar+"&student_dob="+student_dob;
