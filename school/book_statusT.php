...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;"> Student Return Book Details
<a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/b_list_r.php?class=<?php echo $_POST['class']."&ses=".$_SESSION['session'] ;;  ?>')">     <input type="button" value="Print List " style="width:100px; position:absolute"></a>

</h2>
<a href="./?pageid=book_status_techT" class="item" style="color:#000; margin-top:14px; float:right">Teacher Book Return Details Here</a> 
...
<table class="table table-bordered"  border="1" id="sample_1" style="font-size:14px;" width="1141px">
			 ...
			 <tbody>
			 <?php
	         $sql="select * from returnbook where type='student'";
