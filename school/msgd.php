...
<div class="enquiry">
<img src="images/Sms-icon.png"  style=" float:left; width:60px; height:40px;"/>
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">MESSAGE DETAILS-Student</h2>

<a href="./?pageid=msgt" style="color:#FFFFFF;float:right; background-color:#CC0000; margin-top:10px; padding:6px; font-size:18px">MESSAGE DETAILS-Teacher </a>
</div>
<div class="col_4">
