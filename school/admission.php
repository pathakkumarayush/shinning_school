...
student_address,student_school,student_session,student_class,student_section,uid,mother_tong,religion,caste,pschool,reason_change,f_prof,f_quali,f_off_add,f_tell_no_off,m_name,m_prof,m_off_add,m_off_tel,m_quali,is_bro,b1,c1,b2,c2,addmisionfee,rti,student_doj,std_type,hname,bus,mot,hostel_status,presult,fc,famt,date,memail,ochild,bg,bank,family_id,class,hostel_name,caste_no,alt_no,income,acc_holder,pen,apaar,school_type)
values('$maxv','".$_POST["scholar"]."','".$_POST["txtrno"]."','".$_POST["txtname"]."','".$_POST["gender"]."','".$_POST["txtfatname"]."','".$_POST["txtdob"]."','".$_POST["txtmobile"]."','".$_POST["femail"]."','".$_POST["address"]."','".$_SESSION["uid"]."','".$_SESSION["session"]."','".$_POST["txtclass"]."','$sec','$stdid','".$_POST['mothertong']."','".$_POST['religion']."','".$_POST['caste']."','".$_POST['prev_school']."','".$_POST['reas_school']."','".$_POST['fprofession']."','".$_POST['fqualification']."','".$_POST['oaddress']."','".$_POST['offadd']."','".$_POST['m_name']."','".$_POST['mprofession']."','".$_POST['moaddress']."','".$_POST['mofftel']."','".$_POST['mqualification']."','".$_POST['mype2']."','".$_POST['b1']."','".$_POST['c1']."','".$_POST['b2']."','".$_POST['c2']."','".$_POST['student_type']."','".$_POST['rti']."','".$_POST["txtdoj"]."','$t','$hname','$bus','".$_POST['mot']."','".$_POST['hostel_status']."','".$_POST['presult']."','".$_POST['fc']."','".$_POST['famt']."','$da','".$_POST['memail']."','".$_POST['ochild']."','".$_POST['bg']."','".$_POST['bank']."','".$_POST['family_id']."','".$_POST['class']."','".$_POST['hostel_name']."','".$_POST['caste_no']."','".$_POST['alt_no']."','".$_POST['income']."','".$_POST['acc_holder']."','".$_POST['pen']."','".$_POST['apaar']."','".$_POST['school_type']."')")or die(mysqli_error());
	      ...
	      $page=1;
	      $r=sms($con,$_SESSION["uid"],$maxv,$sub,$msg,'Yes',$session,$page);	  
...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Student Admission</h2>
 ...
 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/admf.php?date=<?php echo $_POST['from']."&ses=".$_SESSION['session'] ;  ?>')"> Print Admission Form </a>
...
<tr><td>Form No.</td> <?php
	  ...
	  <td>&nbsp;&nbsp;Admission No<span style="color:#FF0000">*</span></td> 
		 <td><input name="scholar" type="text" id="txtrno" value="<?php if(($_POST)  && (empty($_GET["upstudid"]))) echo $_POST['scholar']; if(isset($_GET["upstudid"])){ echo $rowstud["student_scholar"];   }?>" /></td> 
	  ...
	  <td>Blood Group</td> 
		...
		<tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
	     ...
	     <tr>
		<td>SSSMID</td> 
		   <td><input type="text" name="religion" maxlength="9" class="tb5" value="<?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['religion']; if(isset($_GET["upstudid"])){echo $rowstud["religion"]; } ?>"  ></td>
		 
		 
		 <td>Aadhar No</td> 
		 <td><input name="txtrno" type="text" id="txtrno" maxlength="12" value="<?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['txtrno']; if(isset($_GET["upstudid"])){echo $rowstud["student_rollno"];} ?>"  class="tb5"  /></td>
		 </tr>
	...
	<tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
		...
		<tr>
		<td>Family Id</td> 
		 <td><input type="text" name="family_id" maxlength="8" class="tb5" value="<?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['family_id']; if(isset($_GET["upstudid"])){echo $rowstud["family_id"]; } ?>"  ></td>
...
<tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>  
		 ...
		 <input type="text" name="caste_no" class="tb5"> </td> 
		   </tr>
		 ...
		 <input type="text" name="alt_no" class="tb5"> </td> 
		   </tr>
	  ...
	  <td><textarea cols="25"  name="address"  ><?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['address']; if(isset($_GET["upstudid"])){echo $rowstud["student_address"];} ?></textarea></td>
	  
	   <td>Residential Address(M)</td> 
	  <td><textarea cols="25"  name="moaddress"  ><?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['moaddress']; if(isset($_GET["upstudid"])){echo $rowstud["m_off_add"];} ?></textarea></td>
	  ...
	  <td>Office Address(F)</td> 
	   <td><textarea cols="25"  name="oaddress"  ><?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['oaddress']; if(isset($_GET["upstudid"])){echo $rowstud["f_off_add"];} ?></textarea></td>
	 
	  <td>Office Address(M)</td> 
	   <td><textarea cols="25"  name="mofftel"  ><?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['mofftel']; if(isset($_GET["upstudid"])){echo $rowstud["m_off_tel"];} ?></textarea></td>
	   ...
	   <td> <input name="txtmobile" type="text" id="txtmobile" value="<?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['txtmobile']; if(isset($_GET["upstudid"])){echo $rowstud["student_contactno"];} ?>" maxlength="10" class="tb5"  /></td>
	    
	   
	   
	   <td>Mobile No.(Mother)</td>
	    <td><input name="offadd" type="text" id="txtmobile" value="<?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['offadd']; if(isset($_GET["upstudid"])){echo $rowstud["f_tell_no_off"];} ?>" maxlength="10" class="tb5"  /></td> 
