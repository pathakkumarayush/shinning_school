...
<td colspan="4">Monthly Evaluation <br />Max. Marks-40)</td>
<td colspan="4">Half Yearly Evaluation<br />Max. Marks-60)</td>
<td colspan="4">Annual Evaluation<br />(Written) (Max. Marks-60)</td>
<td colspan="4">Annual Evaluation <br />(Project) (Max. Marks-40)</td>
<td colspan="5">Monthly10%+Half Yearly20%+<br />Annual(Written)60%+Project10%=100%</td>
...
<?php
$msans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Monthly Evaluation' and subject='EVS' and ses='$ses'") 
or die(mysqli_error());
$rowmsans=mysqli_fetch_array($msans);
$msans_m = $rowmsans['obtainmarks'];
$msans_m10 = $msans_m*10/40;

$hsans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Half Yearly Evaluation' and subject='EVS' and ses='$ses'") 
or die(mysqli_error());
$rowhsans=mysqli_fetch_array($hsans);
$hsans_m = $rowhsans['obtainmarks'];
$hsans_m20 = $hsans_m*20/60;

$asans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Annual Evaluation' and subject='EVS' and ses='$ses'") 
or die(mysqli_error());
$rowasans=mysqli_fetch_array($asans);
$asans_m = $rowasans['obtainmarks'];
$asans_m60 = $asans_m*60/60;

$psans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project' and subject='EVS' and ses='$ses'") 
or die(mysqli_error());
...
$annual100 = $english+$hindi+$sanskrit+$math;
...
<td align="center"><?php $fg = $annual100*100/400; echo number_format($fg, 2);?>%</td>
<td align="center">
<?php
                             if($fg > 85)
                             {
