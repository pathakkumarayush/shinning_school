...
<td colspan="2" style="color:#FF0000">Math<br />(Additional)</td>
...
<td rowspan="2" style="color:#FF0000;">Che.</td>
<td rowspan="2" style="color:#FF0000;border-right:1px #FF0000 solid;">Math</td>
...
<td colspan="2" style="color:#FF0000;border-right:1px #FF0000 solid;color:#FF0000">Math.</td>
...
<?php
$qpsans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
$rowqpsans=mysqli_fetch_array($qpsans);
$qpsans_m = $rowqpsans['obtainmarks'];

$msans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Quarterly Evaluation' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
$rowmsans=mysqli_fetch_array($msans);
$msans_m = $rowmsans['obtainmarks'];
$msans_m5 = $msans_m*5/100;

$hpsans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_H' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
$rowhpsans=mysqli_fetch_array($hpsans);
$hpsans_m = $rowhpsans['obtainmarks'];
$hsans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Half Yearly Evaluation' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
$rowhsans=mysqli_fetch_array($hsans);
$hsans_m = $rowhsans['obtainmarks'];
$hsans_m5 = $hsans_m*5/100;

$asans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Annual Evaluation' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
$rowasans=mysqli_fetch_array($asans);
$asans_m = $rowasans['obtainmarks'];
$asans_m90 = $asans_m*90/100;

$psans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_A' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
...
<td align="center" ><?php echo number_format($qss5, 1); ?></td>
<td align="center" style="border-right:1px #FF0000 solid;"><?php echo number_format($qsans5, 1); ?></td>
...
<td align="center" ><?php echo number_format($hss5, 1); ?></td>
<td align="center" style="border-right:1px #FF0000 solid;"><?php echo number_format($hsans5, 1); ?></td>
