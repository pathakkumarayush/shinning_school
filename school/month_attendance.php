...
<div class="col_4">
  ...
  <form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
       ...
       <?php
		...
		<tr style="line-height:30px;font-weight:bold;"><td colspan="34" align="center">Monthly Attendance Report - Month - <?php echo $_REQUEST['month1'] ?>, &nbsp; Class - <?php echo $_REQUEST['class'] ?></td></tr>
