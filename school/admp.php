...
<?php 
$reg=mysqli_query($con,"select * from student where student_session='".$_GET['ses']."' and  student_id='".$_GET['id']."' ");
...
<td style="width:175px;">&nbsp;&nbsp;&nbsp;&nbsp;Date Of Birth</td><td style="border-bottom:2px #000000 dotted;"><?php echo $rowstud['student_dob']; ?>&nbsp;</td>
</tr>
