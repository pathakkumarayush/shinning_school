<?php
 ...
 <?php
  ...
  mysqli_query($con,"insert into bus_details(class,sid,root,stopage,vno,status,type,time_in) values('".$_POST["class"]."','".$_POST["std_id"]."','".$_POST['rout']."','".$_POST['stopage']."','".$_POST['vehcle']."','".$_POST['status']."','".$_POST['transport_type']."','".$_POST['time_in']."')");
   ...
   $alloc_std=mysqli_query($con,"update student set transport_status='".$_POST['status']."',transport_stopage='".$_POST['stopage']."',transport_rout='".$_POST['rout']."',transport_veh='".$_POST['vehcle']."',transport_type='".$_POST['transport_type']."',m1='".$_POST['m1']."',m2='".$_POST['m2']."',m3='".$_POST['m3']."',m4='".$_POST['m4']."',m5='".$_POST['m5']."',m6='".$_POST['m6']."',m7='".$_POST['m7']."',m8='".$_POST['m8']."',m9='".$_POST['m9']."',m10='".$_POST['m10']."',m='".$_POST['tm']."' where student_id='".$_POST['std_id']."' 
 and student_session='".$_SESSION['session']."'");
?>
      ...
      <?php
       ...
       <?php
		 ...
		 <?php
		   ...
		   $search=mysqli_query($con,"select * from student where student_session='".$_SESSION['session']."' and status='0' and student_id='".$_POST['scholarno1']."'");
	   ...
	   <option value="<?php echo $row['id'];  ?>"> <?php echo $row['rout_no']."-".$row['time_in']; ?></option>
		...
		?>	
	       ...
	       <tr>
			...
			<td>Select Month</td>
			<td>
			 <select name="m1" class="select" style="width:75px" required />
			 <option value="April">April</option>
		     <option value="No">No</option>
			 </select>
			 
			 <select name="m2" class="select" style="width:75px" required />
			 <option value="July">July</option>
		     <option value="No">No</option>
			 </select>
			 
			  <select name="m3" class="select" style="width:75px" required />
			 <option value="August">August</option>
		     <option value="No">No</option>
			 </select>
			 
			  <select name="m4" class="select" style="width:75px" required />
			 <option value="September">September</option>
		     <option value="No">No</option>
			 </select>
			 
			  <select name="m5" class="select" style="width:75px" required />
			 <option value="October">October</option>
		     <option value="No">No</option>
			 </select>
			 
			   <select name="m6" class="select" style="width:75px" required />
			 <option value="November">November</option>
		     <option value="No">No</option>
			 </select>
			 
			   <select name="m7" class="select" style="width:75px" required />
			 <option value="December">December</option>
		     <option value="No">No</option>
			 </select>
			 
			   <select name="m8" class="select" style="width:75px" required />
			 <option value="January">January</option>
		     <option value="No">No</option>
			 </select>
			 
			   <select name="m9" class="select" style="width:75px" required />
			 <option value="February">February</option>
		     <option value="No">No</option>
			 </select>
			 
			   <select name="m10" class="select" style="width:75px" required />
			...
			<td>Total Month</td>
			<td>
			 <select name="tm" class="select" style="width:75px" required />
