...
?>	
<div style="width:1060px;height:1550px;font-family:Calisto MT;background:url(BKN_LKG.png);background-repeat:no-repeat;background-position:center;" class="fsz">
<br clear="all" />
...
if($rowstud['student_class']=='LKG A')
{
$clss = 'UKG';
}
if($rowstud['student_class']=='LKG B')
{
$clss = 'UKG';
}
