...
<div id="container">
 <div class="shell">
  ...
  <input type="button" onclick="gets('msg'); display('sub1','none'); display('sub2','inline');" value="view Message" name="sendall" />
   ...
   <input type='checkbox' value='on' id='chkall' name='allbox' onclick='checkAll();'/>
   </td><td>&nbsp;Sr.No</td><td>&nbsp;NAME</td><td>&nbsp;Father</td><td>&nbsp;DOB</td><td>&nbsp;Contact</td><td>&nbsp;Class</td></tr>
	<?php
	...
	while($row_all=mysqli_fetch_array($res_all))
	{
	   ...
	   $bday = date("d-m");
		...
		<td>&nbsp;<?php echo $row_all["student_dob"]; ?></td>
...
function gets(s)
{
	...
	{
		mymsg = "School wishes NAME a very happy birthday filled with love and prosperity";
	}
