...
if(isset($_POST["add_student"]))
{
        ...
        <?php
			...
			$bus=$_POST['bus'];	
		    $res_ins=mysqli_query($con,"insert into reg(student_id,student_scholar,student_rollno,student_name,student_gender,student_fname,student_dob,student_contactno,femail,
student_address,fid,student_school,student_session,student_class,student_section,uid,mother_tong,religion,caste,pschool,reason_change,subj_req,f_prof,f_quali,f_off_add,f_tell_no_off,m_name,m_prof,m_off_add,m_off_tel,m_quali,is_bro,b1,c1,b2,c2,addmisionfee,rti,student_doj,tc,std_type,bus,mot,hostel_status,presult,fc,famt,date,memail,orn,ochild,d1,d2,e1,e2,bty,veh)
values('$maxv','".$_POST["scholar"]."','".$_POST["txtrno"]."','".$_POST["txtname"]."','".$_POST["gender"]."','".$_POST["txtfatname"]."','".$_POST["txtdob"]."','".$_POST["txtmobile"]."','".$_POST["femail"]."','".$_POST["address"]."','".$_POST["fid"]."','".$_SESSION["uid"]."','".$_SESSION["session"]."','".$_POST["txtclass"]."','$sec','$stdid','".$_POST['mothertong']."','".$_POST['religion']."','".$_POST['caste']."','".$_POST['prev_school']."','".$_POST['reas_school']."','".$_POST['subject']."','".$_POST['fprofession']."','".$_POST['fqualification']."','".$_POST['oaddress']."','".$_POST['offadd']."','".$_POST['m_name']."','".$_POST['mprofession']."','".$_POST['moaddress']."','".$_POST['mofftel']."','".$_POST['mqualification']."','".$_POST['mype2']."','".$_POST['b1']."','".$_POST['c1']."','".$_POST['b2']."','".$_POST['c2']."','".$_POST['student_type']."','".$_POST['rti']."','".$_POST["txtdoj"]."','$tc','$t','$bus','".$_POST['mot']."','".$_POST['hostel_status']."','".$_POST['presult']."','".$_POST['fc']."','".$_POST['famt']."','$da','".$_POST['memail']."','".$_POST['orn']."','".$_POST['ochild']."','".$_POST['d1']."','".$_POST['d2']."','".$_POST['e1']."','".$_POST['e2']."','".$_POST['bty']."','".$_POST['veh']."')")or die(mysqli_error());
	...
	?>
                   <script type="text/javascript">
                    window.location="<?php echo $var."reg&&sumsg=Inserted Successfully"; ?>";
			       </script>
			  <?php
              }
	        else
			    {
				  $error_msg="Reg Number Already Exist";
				}
			  }
	 }
...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Student Registration</h2>
</div>
<div class="col_4">
...
<tr><td>Form No.</td> <?php
	   $maxid=mysqli_query($con,"select count(student_id) from reg where student_school='".$_SESSION["uid"]."'");
	  ...
	  <td>&nbsp;&nbsp;Registration No<span style="color:#FF0000">*</span></td> 
	   ...
	   <tr>
	   <td>Student Name<span style="color:#FF0000">*</span></td> <td> 
      ...
      <?php } ?></td>
	   ...
	   <tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
		...
		<td>&nbsp;&nbsp;Date Of Reg.<span style="color:#FF0000">*</span></td> 
		...
		<tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
		  ...
		  <td>Class Passed</td> <td><input type="text" name="subject" class="tb5"  value="<?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['subject']; if(isset($_GET["upstudid"])){echo $rowstud["subj_req"];} ?>" ></td> 
		 </tr>
 ...
 <tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
	   ...
	   <?php
	    ...
	    <td>&nbsp;&nbsp;Select One</td> 
		 <td>
         <input  type="radio" value="bus" name="bty" <?php if(!empty($_GET["upstudid"]) && ($rowstud["bty"]=="bus") ) { ?> checked="checked"  <?php  } ?> >
		 <span style="color:Blue;">Bus</span>
		 <input  type="radio" value="auto" name="bty" <?php if(!empty($_GET["upstudid"]) && ($rowstud["bty"]=="auto") ) { ?> checked="checked"  <?php } ?> >
		  <span style="color:Green;">Auto</span>
		 <input  type="radio" value="van" name="bty" <?php if(!empty($_GET["upstudid"]) && ($rowstud["bty"]=="van") ) { ?> checked="checked"  <?php   } ?> >
		 <span style="color:#ffc107;">Van</span>
		 <input  type="radio" value="by own" name="bty" <?php if(!empty($_GET["upstudid"]) && ($rowstud["bty"]=="by own") ) { ?> checked="checked"  <?php } ?> >
		  <span style="color:Red;">By OWN</span>
		</td>
		</tr>
		<tr><td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;</td></tr>
	  <tr>
	  <td>Detail Driver+Vehicle</td> 
	   <td><textarea cols="23"  name="veh"  ><?php if(($_POST) && (empty($_GET["upstudid"]))) echo $_POST['veh']; if(isset($_GET["upstudid"])){echo $rowstud["veh"];} ?></textarea></td>
	  ...
	  <td></td> 
	   <td></td>
	    ...
	    <table>
		<tr>
		<td> <span style="color:#993300;margin-left:0px">If Any Brother And Sister Studying In This Schools</span></td>
	    <td>
...
<input type="radio" name="mype2" value="No"  <?php if(!empty($_GET["upstudid"]) && ($rowstud["is_bro"]=="No") ) { ?>  checked="checked"<?php   } ?>>No </td>
	   ...
	   ?>
	     <table>
		<tr>
		<td> <span style="color:#FF0000; margin-left:0px">About Brother And Sister Studying In School</span></td>
...
<input type="radio" name="mype2" value="No" onclick="showMe2()" checked="checked">No </td>
	   ...
	   <div id="TextBoxDiv1" style="display:none; margin-left:30px" class="row" >
        ...
        <td> 
		<label>Class : </label> 
		<select name="c1" class="select" style="width:100px;">
        <option value="-1">Select Class</option>
        <?php
        $res=mysqli_query($con,"select distinct(class) from class where school='".$_SESSION["uid"]."'");
        while($rows=mysqli_fetch_array($res))
	    ...
	    <td>
        <label>Name : </label><input type='text' name="b1" id='textbox1' style="width:100px;">
		</td>
		
		<td>
        <label>Age : </label><input type='text' name="d1" id='textbox1' style="width:50px;">
		</td>
		
		<td>
        <label>School : </label><input type='text' name="e1" id='textbox1' style="width:100px;">
		</td>
		...
		<td> 
		<label>Class : </label>
		<select name="c2" class="select" style="width:100px;" >
        <option value="-1">Select Class</option>
        <?php
        $res=mysqli_query($con,"select distinct(class) from class where school='".$_SESSION["uid"]."'");
        while($rows=mysqli_fetch_array($res))
        ...
        <td>
        <label>Name : </label><input type='text' name="b2" id='textbox2' style="width:100px;"></td>
		
		
		<td>
        <label>Age : </label><input type='text' name="d2" id='textbox1' style="width:50px;">
		</td>
		
		<td>
        <label>School : </label><input type='text' name="e2" id='textbox1' style="width:100px;">
		</td>
