...
<div class="col_4">
  ...
  <form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return(validate());">
		...
		&nbsp; || &nbsp;  <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."student_attendance_details"."&&divid=5"; ?>">Annual Report</a>
						</div>
   ...
   <td>Select Session</td><td><select name="session" class="select">
       ...
       $i=1;
	    if($num>0)
		{
         ...
         <td>
         <?php
         $search10=mysqli_query($con,"select * from month where session='".$_SESSION['session']."' and month='".$_POST['month1']."' ");
	     ...
	     <td><?php echo $p = $td-$num;  ?></td>
		 
		 <td><?php $re = $p*100/$td; echo substr($re, 0, 5);?></td>
	     </tr>
         <?php
     $i++;
	 }
