...
<?php
 if(!empty($_GET['did']))
 {
 $delete=mysqli_query($con,"delete from student_detail where id='".$_GET['did']."'");
 }
 ?>
<div class="full_div">
<br clear="all" />
...
<a href="./?pageid=userid_password_tech" style="float:right; margin-top:12px; color:#333366; font-size:20px;">Teacher Details</a>
<a href="./?pageid=userid_password_modules" style="float:right; color:#990000; margin-top:12px;  font-size:20px;">Modules Details</a>
</div>

<div class="col_6">
<div class="form-style-2-heading">Student User name and password information</div>
<table class="table table-bordered" id="sample_1" style="font-size:12px; font-weight:bold; ">
	          ...
	          {
	          $uid = $row['student_user_name'];
	          $search=mysqli_query($con,"select * from student where uid='$uid' and student_session='".$_SESSION['session']."' and status='0'");	
              ...
              <td><?php echo $row['student_orgpassword']; ?></td>
			  <td> <a href="<?php echo $var."userid_password&&did=".$row['id']; ?>" onClick="return confirmation();" style="color:#FF0000">
...
<br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" /><br clear="all" />
</div>
</div>
