...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Update Student Roll No</h2>
      ...
      <option>Select</option>
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
         ...
         <input type="text" name="m_name" value="<?php echo $studrow['m_name']; ?>" id="m_name<?php echo $i;?>" style="width:100px;">
		  ...
		  <td>
         <input type="text" name="rno" value="<?php echo $studrow['rno']; ?>" id="rno<?php echo $i;?>" style="width:100px;">
         </td>
...
var rno= document.getElementById('rno'+hid).value;


var data_str= "student_class="+student_class+"&idm="+idm+"&student_name="+student_name+"&student_fname="+student_fname+"&m_name="+m_name+"&student_scholar="+student_scholar+"&rno="+rno;
