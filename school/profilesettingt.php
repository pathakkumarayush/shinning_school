...
{
$login=mysqli_query($con,"update login set pass='".$_POST['password']."' where uid='".$_POST['uid']."' and type='teacher'");
...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Change Password-Class Teaher</h2>
...
<td>
<?php
$login=mysqli_query($con,"select * from login where type='teacher'");
?>
...
<td></td><td><input type="submit" name="submit"></td>
 ...
 <td>&nbsp;&nbsp;Password</td>
   ...
   <?php
    $sql=mysqli_query($con,"select * from  login where type='teacher'");
