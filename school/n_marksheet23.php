...
?>	
<div style="width:1050px;height:1530px; border:4px #000 solid;font-family:Calisto MT;background:url(wn.png) no-repeat center;" class="fsz">
<br clear="all" />
...
<img src="upload/<?php echo $rowstud["student_img"]; ?>" style="border-radius:5px; width:210px; margin-left:8PX; height:240px;">
</td>
</tr>
...
if($rowstud['student_class']=='NURSERY' || $rowstud['student_class']=='NURSERY A' || $rowstud['student_class']=='NURSERY B')
{
$clls = 'NURSERY';
}
...
else if($rowstud['student_class']=='NURSERY A')
{
$sec = 'A';
}
else if($rowstud['student_class']=='NURSERY B')
{
$sec = 'B';
}
...
?>
<img src="fot2.png" style="margin-left:5px; margin-top:34px;" />
<?php
}
?>
