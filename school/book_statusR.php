...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;"> Student Renew Book Details

<a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/i_list_rn.php?class=<?php echo $_POST['class']."&ses=".$_SESSION['session'] ;;  ?>')">     <input type="button" value="Print List " style="width:100px; position:absolute"></a>

</h2>
<a href="./?pageid=book_status_techR" class="item" style="color:#000; margin-top:14px; float:right">Teacher Book Renew Details Here</a> 
