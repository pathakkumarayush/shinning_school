...
.tbl1 tr{line-height:35px!important;}
...
<div style="width:99%;height:255px;text-transform: capitalize;">
...
if($rowstud['student_class']=='IX' || $rowstud['student_class']=='IX A' || $rowstud['student_class']=='IX B' || $rowstud['student_class']=='IX C')
{
$clls = 'IX';
}
...
<td colspan="3">&nbsp;
<?php 
if($rowstud['student_class']=='IX')
{
$sec = '-';
}
else if($rowstud['student_class']=='IX A')
{
$sec = 'A';
}
else if($rowstud['student_class']=='IX B')
{
$sec = 'B';
}
else if($rowstud['student_class']=='IX C')
{
$sec = 'C';
}
...
<?php
$qpsans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project' and subject='Sanskrit' and ses='$ses'") 
or die(mysqli_error());
$rowqpsans=mysqli_fetch_array($qpsans);
$qpsans_m = $rowqpsans['obtainmarks'];

$msans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Quarterly Evaluation' and subject='Sanskrit' and ses='$ses'") 
or die(mysqli_error());
$rowmsans=mysqli_fetch_array($msans);
$msans_m = $rowmsans['obtainmarks']+$rowqpsans['obtainmarks'];
$msans_m5 = $msans_m*5/100;

$hpsans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_H' and subject='Sanskrit' and ses='$ses'") 
or die(mysqli_error());
...
$psans=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_A' and subject='Sanskrit' and ses='$ses'") 
or die(mysqli_error());
...
<!--Maths marking start-->
<?php
$qpmath=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
$rowqpmath=mysqli_fetch_array($qpmath);
$qpmath_m = $rowqpmath['obtainmarks'];

$mmath=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Quarterly Evaluation' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
$rowmmath=mysqli_fetch_array($mmath);
$mmath_m = $rowmmath['obtainmarks']+$rowqpmath['obtainmarks'];
$mmath_m5 = $mmath_m*5/100;

$hpmath=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_H' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
...
$pmath=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_A' and subject='Mathematics' and ses='$ses'") 
or die(mysqli_error());
...
<?php
$qpsc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
$rowqpsc=mysqli_fetch_array($qpsc);
$qpsc_m = $rowqpsc['obtainmarks'];

$msc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Quarterly Evaluation' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
$rowmsc=mysqli_fetch_array($msc);
$msc_m = $rowmsc['obtainmarks']+$rowqpsc['obtainmarks'];
$msc_m5 = $msc_m*5/100;

$hpsc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_H' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
...
$psc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_A' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
...
<?php
$qpss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
$rowqpss=mysqli_fetch_array($qpss);
$qpss_m = $rowqpss['obtainmarks'];

$mss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Quarterly Evaluation' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
$rowmss=mysqli_fetch_array($mss);
$mss_m = $rowmss['obtainmarks']+$rowqpss['obtainmarks'];
$mss_m5 = $mss_m*5/100;

$hpss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_H' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
...
$pss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='Project_A' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
...
<td align="center" style="border-right:2px #000000 solid; color:#000000;">75</td>
...
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#19a99b;"><?php echo number_format($meng_m5, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#CC3399"><?php echo number_format($heng_m5, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A"><?php echo number_format($aeng_m90, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#ff5722"><?php echo number_format($peng_m90, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#FF0066"><?php echo round($theng); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#9c27b0"><?php echo round($peng_m90); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#19a99b;"><?php echo number_format($mhindi_m5, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#CC3399"><?php echo number_format($hhindi_m5, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A"><?php echo number_format($ahindi_m90, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#ff5722"><?php echo number_format($phindi_m90, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#FF0066"><?php echo round($thhindi); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#9c27b0"><?php echo round($phindi_m90); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;">100</td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $msans_m;  ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;"><?php echo $hsans_m;  ?></td>
<td align="center" style="border-right:2px #000000 solid;">75</td>
<td align="center" style="border-right:2px #000000 solid;">25</td>
...
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#19a99b;"><?php echo number_format($msans_m5, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#CC3399"><?php echo number_format($hsans_m5, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A"><?php echo number_format($asans_m90, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#ff5722"><?php echo number_format($psans_m90, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#FF0066"><?php echo round($thsans); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#9c27b0"><?php echo round($psans_m90); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#19a99b;"><?php echo number_format($mmath_m5, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#CC3399"><?php echo number_format($hmath_m5, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A"><?php echo number_format($amath_m90, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#ff5722"><?php echo number_format($pmath_m90, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#FF0066"><?php echo round($thmath); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#9c27b0"><?php echo round($pmath_m90); ?></td>
...
<tr style="line-height:40PX;">
<td style="border-right:2px #000000 solid;">&nbsp;<img src="ar.png"  style=""/>Science</td>
<td align="center" style="border-right:2px #000000 solid;">100</td>
...
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#19a99b;"><?php echo number_format($msc_m5, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#CC3399"><?php echo number_format($hsc_m5, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A"><?php echo number_format($asc_m90, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#ff5722"><?php echo number_format($psc_m90, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#FF0066"><?php echo round($thsc); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#9c27b0"><?php echo round($psc_m90); ?></td>
...
<tr style="line-height:40PX;">
<td style="border-right:2px #000000 solid;">&nbsp;<img src="ar.png"  style=""/>Social Science</td>
<td align="center" style="border-right:2px #000000 solid;">100</td>
...
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#19a99b;"><?php echo number_format($mss_m5, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#CC3399"><?php echo number_format($hss_m5, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A"><?php echo number_format($ass_m90, 1); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#ff5722"><?php echo number_format($pss_m90, 1); ?></td>

<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#FF0066"><?php echo round($thss); ?></td>
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#9c27b0"><?php echo round($pss_m90); ?></td>
...
<td align="center" style="border-right:2px #000000 solid;">600</td>
...
<td align="center" style="border-right:2px #000000 solid;" colspan="2">600</td>
...
<td align="center" style="border-right:2px #000000 solid;font-weight:bold;color:#00356A;"><?php echo $gtm; $per = $gtm*100/600; ?></td>
...
<td style="background-color:#ffeb3b">Pass</td><td rowspan="2">600</td><td rowspan="2"><?php echo $gtm;  ?></td>
...
<br clear="all" />
<table class="tbl" border="0" cellpadding="0" cellspacing="0" style="color:#000000;font-size:21PX;margin-left:5PX;float:left;margin-top:2px;width:1041PX;">
<tr style="line-height:40px; color:#000;">
