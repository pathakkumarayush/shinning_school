...
<div class="col_4" style="margin-top:0px;" >				 
	...
	<a href="<?php echo $var."printmarksheetannual24" ?>" style="border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px">Annual Marksheet</a>
...
<?php if($studrow['student_class']=="I" || $studrow['student_class']=="I A" || $studrow['student_class']=="I B" || $studrow['student_class']=="II" || $studrow['student_class']=="II A" || $studrow['student_class']=="II B")
  {
  ?>
 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/1_2_marksheet24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session']."&rno=".$i; ?> ')">Marksheet</a>
  <?php 
  }
  ...
  {
  ?>
<a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/3_4_marksheet24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session']."&rno=".$i;  ?> ')">Marksheet</a>
   <?php 
  }
  ...
  {
  ?>
 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/6_8_marksheet24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Marksheet</a>
 ...
 <?php 
  ...
  {
  ?>
   <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/9_marksheet24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
 <?php 
  }
  else if($studrow['student_class']=="XI Maths")
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/11_math24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
   <?php 
  }
  else if($studrow['student_class']=="XI Bio")
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/11_bio24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
   <?php 
  }
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/11_com24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
  <?php 
  }
 else if($studrow['student_class']=="XI Math Bio")
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/11_math_bio24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
  <?php 
  }
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/11_bio_math24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
  <?php 
  }
  else if($studrow['student_class']=="UKG" || $studrow['student_class']=="UKG A" || $studrow['student_class']=="UKG B")
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/UKG_marksheet24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session']."&rno=".$i; ; ?> ')">Print Marksheet</a>
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/LKG_marksheet24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session']."&rno=".$i; ; ?> ')">Print Marksheet</a>
 ...
 {
 ?>	
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/n_marksheet24.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session']."&rno=".$i; ; ?> ')">Print Marksheet</a>
...
<tr><td colspan="6">
 ...
 <?php if($row_class['class']=="I" || $row_class['class']=="I A" || $row_class['class']=="I B" || $row_class['class']=="II" || $row_class['class']=="II A" || $row_class['class']=="II B")
  {
  ?>
 <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/1_2_marksheetALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session']; ?> ')"><span style="font-size:36px;">
 ...
 {
 ?>
   <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/3_4_marksheetALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
...
<?php
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/6_8_marksheetALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/9_marksheetALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/11_mathALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
...
<?php
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/11_bioALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/11_comALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/11_math_bioALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/UKG_marksheetALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/LKG_marksheetALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 ...
 {
 ?>
 <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/n_marksheetALL24.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ; ?> ')"><span style="font-size:36px;">
 <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
 </a>
