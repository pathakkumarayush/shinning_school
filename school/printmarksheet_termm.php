...
if(empty($row_class['class_section']))
{
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/1_4_marksheeth.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/5_marksheeth.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
  <?php 
  }
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/6_8_marksheeth.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
  <?php 
  }
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/8_marksheeth.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
  <?php 
  }
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/9_marksheeth.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
 ...
 <?php 
  ...
  else if($studrow['student_class']=="X C" || $studrow['student_class']=="X B" || $studrow['student_class']=="X A")
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/10_marksheeth.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
 ...
 <?php 
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/11_marksheeth.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
  <?php 
  }
  ...
  {
  ?>
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/ukg_marksheeth.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
  <?php 
  }
 ...
 {
 ?>	
  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/shining/school/n_marksheeth.php?student_id=<?php echo $studrow["uid"]."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')">Print Marksheet</a>
...
<tr><td colspan="6">
 ...
 <?php if($row_class['class']=="I" || $row_class['class']=="I A" || $row_class['class']=="I B" || $row_class['class']=="II" || $row_class['class']=="II A" || $row_class['class']=="II B" || $row_class['class']=="III" || $row_class['class']=="III A" || $row_class['class']=="III A" || $row_class['class']=="IV" || $row_class['class']=="IV A" || $row_class['class']=="IV B")
  {
  ?>
 <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/1_4_allmarksheeth.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/5_allmarksheeth.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 <?php
 }
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/6_8_allmarksheeth.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 <?php
 }
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/8_allmarksheeth.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
 <?php
 }
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/9_allmarksheeth.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
  <?php
 }
 
 else if($row_class['class']=="X A" || $row_class['class']=="X B" || $row_class['class']=="X C")
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/10_allmarksheeth.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
  <?php
 }
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/11_allmarksheeth.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
  <?php
 }
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/11_allmarksheetsh.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
  </a>
  <?php
 }
 ...
 {
 ?>
  <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/ukg_allmarksheeth.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ?> ')"><span style="font-size:36px;">
  <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
 ...
 {
 ?>
 <a href="javascript:void(0)" style="color:#FF0000;" onClick="return  popitup('https://smarterponline.com/shining/school/n_allmarksheeth.php?class=<?php echo $row_class['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session'] ; ; ?> ')"><span style="font-size:36px;">
 <input type="submit" name="submit" value="ALL Print Marksheet" style="margin-left:70px">
