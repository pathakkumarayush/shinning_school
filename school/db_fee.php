...
function updateDuee() {
    ...
    var val2 = parseInt(document.getElementById("dbfee").value);
...
<div id="container">
  <div class="shell"  >
		<div id="main" >
		    ...
		    <img src="db.png" style="width:200px; height:80px;" />
 <?php
 if(isset($_POST['pay']))
    {
	  $m=date("M");
...
$query=mysqli_query($con,"insert into fee_db(session,class,reg,dbf,fee_deposit,student,date,school,receiptno,current_month,remark)
values('".$_SESSION['session']."','".$_POST['class']."','".$_POST['reg']."','".$_POST['dbfee']."','".$_POST['total']."','".$_POST['student']."','$ddd','gps','".$_POST['rno']."','$m','".$_POST['remark']."')");
...
$insertid=mysqli_insert_id();
 $_SESSION['studentid']=$_POST['student'];
	  ...
	  ?>
			...
			<a href="./?pageid=fee_home" style="color:#673AB7; font-size:22px; margin-top:10px; position:absolute;">Back</a></span>
			<br /><br /><br />
            <form method="post" name="myForm" action="" enctype="multipart/form-data"  onsubmit="return(validate());">
            <div class="box-head">
		 <span style="font-size:24px;">   Day Boarding Fee  </span>
		 
		 <a href="./?pageid=sl" style="float:right; color:#FFFFFF; font-size:24px; position:absolute; margin-left:200px;">STUDENT LEDGER</a>
		 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		  <a href="./?pageid=slt" style="float:right; color:#FFFFFF; font-size:24px">Total Collection</a>
		  
		  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		  <a href="./?pageid=db_fee_date" style="float:right; color:#FFFFFF; font-size:24px; margin-right:25px;">Today Collection</a>
		    </div>
	  ...
	  <?php
	   ...
	   <div>
		<?php
		   ...
		   {
		?>
	  <td><a  href="javascript:void(0)" style="color:#FF0000" onClick="return  popitup('https://smarterponline.com/gps/school/receipdb.php?id=<?php echo $_SESSION['studentid']; ?>')"><input type="button" value="Genrate Receipt " style="width:200px; margin-left:0px; margin-top:15px" ></a></td>
		<?php
		...
		?>
			...
			<table style="margin-left:50px; margin-top:-70PX; font-size:16px;">
			<tr>
            ...
            ?>
			<?php 
			$regdb=mysqli_query($con,"select * from definefeedb where class='".$rowclass['class']."'");
            $rowdbf=mysqli_fetch_array($regdb);
            
			$getdetail=mysqli_query($con,"select * from fee_db where student='".$rowfeedetail['student_id']."' and session='".$_SESSION['session']."' ");
            while($rowfeedetail=mysqli_fetch_array($getdetail))
	     	{
			$tfee+=$rowfeedetail['fee_deposit'];
			}
			?>
		  ...
		  <tr>
		  <td><span style="font-weight:bold; color:#CC9900;">Total Fee </span> - &nbsp;<span style="font-weight:bold; color:#CC0033;"><?php echo $rowdbf['amnt']; ?></span></td>
		  <td>&nbsp;&nbsp;<span style="font-weight:bold; color:#CC9900;">Pay Fee</span> - &nbsp;<span style="font-weight:bold; color:#CC0033;"><?php echo $tfee; ?></td>
<td>&nbsp;&nbsp;<span style="font-weight:bold; color:#CC9900;">Bal. Fee</span> - &nbsp;<span style="font-weight:bold; color:#CC0033;"><?php echo $rowdbf['amnt']-$tfee; ?></td>
		  </tr> 
			...
			<?php 
			$rect=mysqli_query($con,"select max(receiptno) from fee_db where session='".$_SESSION['session']."'");
			...
			<td>Dayboarding Fee</td>
            <td>
			&nbsp;&nbsp;<input type="text" name="dbfee" class="form-control" id="dbfee" onchange="updateDuee()"></td>
