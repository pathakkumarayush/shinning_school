...
.col_4{ height:auto; background-color:#FFFFFF;float:left; margin-top:10px;-webkit-box-shadow: 0 0 10px rgba(0,0,0, .65);
...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Update Student Account No</h2>
      ...
      <option>Select</option>
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
         ...
         <div class="tablea" style=" height:980px; width:1140px;overflow:scroll">
         ...
         <input type="text" name="m_name" value="<?php echo $studrow['m_name']; ?>" id="m_name<?php echo $i;?>" style="width:100px;">
		  ...
		  <td>
         <input type="text" name="rnoo" value="<?php echo $studrow['sedate']; ?>" id="rnoo<?php echo $i;?>" style="width:70px;">
         </td>
...
var data_str= "student_class="+student_class+"&idm="+idm+"&student_name="+student_name+"&student_fname="+student_fname+"&m_name="+m_name+"&student_scholar="+student_scholar+"&rnoo="+rnoo;
