...
<br clear="all" /><br clear="all" />
<table border="0" style="width:98%;margin-top:30px; margin-left:50px;font-weight:bold; font-size:22px;color: #FF0000;">
<tr>
...
?>
<img src="fo.png" style="width:1040px; margin-left:5px; margin-top:25px;" />
<?php
}
?>
