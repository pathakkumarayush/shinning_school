...
<center>Non-Teaching Staff Salary , Month - <?php echo $_GET['id']; ?></center>
<br />
</td></tr>
    <tr class="box-head" >
  ...
  <?php
		$qry="select * from teacher_sal where session='".$_SESSION['session']."' and month='".$_GET['id']."' and st='nonteaching'";
