...
<div style="border: solid #000 0px; width:500; margin-left:30px; border-radius:5px; margin-top:7px;">
	    ...
	    <td colspan="4">Exam - <?php echo $_POST['exam'] ?>, Subject - <?php echo $_POST['subject'] ?></td>
...
$student_id = $studrow['student_id'];
	...
	<?php
	$search22=mysqli_query($con,"select * from exam_copy_collection where session='".$_SESSION['session']."' and student='$student_id' and exam='".$_POST['exam']."' and subject='".$_POST['subject']."' ");
	...
	<tr style="font-weight:bold;">
		...
		<?php  
		$maxabs=mysqli_query($con,"select count(student) from exam_copy_collection where class='".$_POST['class']."' and session='".$_SESSION['session']."' and exam='".$_POST['exam']."' and subject='".$_POST['subject']."'");
	...
	<tr style="font-weight:bold;">
	<td colspan="4">
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/print_copy_view.php?class=<?php echo $_POST['class']."&exam=".$_POST['exam']."&ses=".$_SESSION['session']."&subject=".$_POST['subject']; ?>')"> <input type="button" value="Print" style="width:100px; padding:5px;"></a>
	 </td>
	</tr>
	</table>
	<?php }?>
