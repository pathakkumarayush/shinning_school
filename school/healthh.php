...
<div class="full_div">
        ...
        <h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Co-Curricular Activities</h2>
       ...
       <option>Select</option>
		...
		<!-- <div style="width:1322px; height:50px; background-color:#FF0000; margin-top:10px;">
		 ...
		 {
		  $searchs=mysqli_query($con,"select * from healthh where student='".$studrow['student_id']."' and class='".$studrow['student_class']."' and exam='".$_POST['exam']."' and session='".$_SESSION['session']."'");
		 ...
		 <td >
            <input type="text" name="exam" value="<?php echo $_POST['exam']; ?>" id="exam<?php echo $i;?>" style="width:60px;">
         </td>
		 <td >
		 ...
		 <td >
		  ...
		  <td >
            <input type="text" name="bio" value="<?php echo $studrows['bio']; ?>" id="bio<?php echo $i;?>" style="width:45px;">
         </td>
		 
		  <td >
            <input type="text" name="math" value="<?php echo $studrows['math']; ?>" id="math<?php echo $i;?>" style="width:45px;">
         </td>
		
	
		 
		 <td >
        <?php if(!empty($studrows['height']) || !empty($studrows['weight']) || !empty($studrows['vision']) || !empty($studrows['bio']) || !empty($studrows['math']) ){ ?>
...
var data_str= "cls="+cls+"&idm="+idm+"&exam="+exam+"&height="+height+"&weight="+weight+"&vision="+vision+"&bio="+bio+"&math="+math;
