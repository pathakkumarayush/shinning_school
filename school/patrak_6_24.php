...
<td colspan="13">Monthly Evaluation <br />Max. Marks-40)</td>
<td colspan="13">Half Yearly Evaluation<br />Max. Marks-60)</td>
<td colspan="7">Annual Evaluation<br />(Written) (Max. Marks-60)</td>
<td colspan="13">Annual Evaluation <br />(Project) (Max. Marks-40)</td>
<td>Annal Result(600)</td>
...
<td colspan="2">So. Science</td>
<td rowspan="2" style="background-color:#FFCC99;">Total<br />(11+13+<br />15+17+<br />19+21)</td>
...
<td colspan="2">Science</td>
<td colspan="2">So. Science</td>
<td rowspan="2" style="background-color:#FFCC99;">Total<br />(24+24+<br />28+30+<br />32+34)</td>
...
<td>Science</td>
<td>So. Science</td>
<td rowspan="2" style="background-color:#FFCC99;">Total<br />(36+37+<br />38+39+<br />40+41)</td>
...
<td colspan="2">Science</td>
<td colspan="2">So. Science</td>
<td rowspan="2" style="background-color:#FFCC99;">Total<br />(44+46+<br />48+50+<br />52+54)</td>

<td rowspan="2" style="background-color:#FFCC99;">G.T.<br />(22+35+<br />42+55)</td>
...
<td>48</td><td>49</td><td>50</td><td>51</td><td>52</td><td>53</td><td>54</td><td>55</td><td>56</td><td>57</td><td>58</td><td>59</td>
</tr>
<?php
...
$rowhsans['obtainmarks'] = $rowhsans['obtainmarks'] ?? '';
$hsans_m = $rowhsans['obtainmarks'];
$hsans_m20 = (float)$rowhsans['obtainmarks']*20/60;
...
$psans_m10 = (float)$psans_m*10/40;

$sanskrit100 = (float)$asans_m+(float)$psans_m;
$sanskrit = (float)$msans_m10+(float)$hsans_m20+(float)$asans_m60+(float)$psans_m10;
?>
<!--Maths marking start-->
<?php
...
$hss_m20 = (float)$rowhss['obtainmarks']*20/60;
...
$mothly10 = (float)$meng_m10+(float)$mhindi_m10+(float)$msans_m10+(float)$mmath_m10+(float)$msc_m10+(float)$mss_m10;
$half20 = (float)$heng_m20+(float)$hsans_m20+(float)$hhindi_m20+(float)$hmath_m20+(float)$hsc_m20+(float)$hss_m20;
$annual60 = (float)$aeng_m60+(float)$ahindi_m60+(float)$asans_m60+(float)$amath_m60+(float)$asc_m60+(float)$ass_m60;
$project60 = (float)$peng_m10+(float)$phindi_m10+(float)$psans_m10+(float)$pmath_m10+(float)$psc_m10+(float)$pss_m10;
$annual100 = (float)$english+(float)$hindi+(float)$sanskrit+(float)$math+(float)$science+(float)$ss;
...
<td align="center"><?php echo number_format($msans_m10, 1); ?></td>
...
<td align="center"><?php echo number_format($mss_m10, 1); ?></td>


<td align="center"><?php echo $total_me = (float)$meng_m10+(float)$mhindi_m10+(float)$msans_m10+(float)$mmath_m10+(float)$msc_m10+(float)$mss_m10; ?></td>
...
<td align="center"><?php echo number_format($hsans_m20, 1);?></td>
...
<td align="center"><?php echo number_format($hss_m20, 1);?></td>

<td align="center"><?php $total_hy = (float)$heng_m20+(float)$hhindi_m20+(float)$hsans_m20+(float)$hmath_m20+(float)$hsc_m20+(float)$hss_m20; echo number_format($total_hy, 1);?></td>
...
<td align="center"><?php $total_aw = (float)$aeng_m+(float)$ahindi_m+(float)$asans_m+(float)$amath_m+(float)$asc_m+(float)$ass_m; echo number_format($total_aw, 1);?></td>
...
<td align="center"><?php echo number_format($psans_m10, 1);?></td>
...
<td align="center"><?php echo number_format($pss_m10, 1);?></td>

<td align="center"><?php $total_ap = (float)$peng_m10+(float)$phindi_m10+(float)$psans_m10+(float)$pmath_m10+(float)$psc_m10+(float)$pss_m10; echo number_format($total_ap, 1);?></td>
...
<td align="center"><?php $fg = $all_total*100/600; echo number_format($fg, 2);?>%</td>
