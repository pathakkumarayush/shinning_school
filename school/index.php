...
// Intercept AJAX requests for Question Paper Generator module before HTML wrapper layout prints
if (isset($_GET['ajax']) && $_GET['ajax'] == '1') {
    include "qg_index.php";
    exit;
}

// $var="https://smarterponline.com/shining/school/?pageid=";
$var="http://localhost/shining_school/school/?pageid=";
...
function showUser(stdname,std_id,str,divid,sday,sp,mob,remark)
{
if (str=="")
  {
...
var sday_v=document.getElementById(sday).value;
var sp_v=document.getElementById(sp).value;
var rem_v=document.getElementById(remark).value;
xmlhttp.open("GET","findtotal.php?q="+ap+"&stdname="+stdname+"&std_id="+std_id+"&sday="+sday_v+"&sp="+sp_v+"&mob="+mob+"&remark="+rem_v,true);
xmlhttp.send();
}
...
<div id="header">
	...
	<a href="index.php"><img src="shining.png" style="height:72px;" /></a>
	</div>
	...
	<div id="top-navigation">
                 ...
                 {
                 ?>
			<span style="color:#116549;">	Welcome </span><strong><span style="text-transform:uppercase; color:#FF0000;"><?php echo ucwords($_SESSION['uid']); ?></strong></span>
 ...
 <a href="<?php echo $var."birth"; ?>" style="background-color: #006600; font-size:13px; width:100px; margin-left:25px;" >
 Today Birthday
   <?php
   $res_all=mysqli_query($con,"select * from student where student_school='".$_SESSION["uid"]."' and student_session='".$_SESSION['session']."' order by student_name Asc")
	...
	while($row_all=mysqli_fetch_array($res_all))
	{
	   ...
	   $bday = date("d-m");
	    ?>
	    <?php if($birth==$bday){ ?>
        <?php $st = $row_all["student_email"]; $t+=$st; ?>
		
	<?php }?>	
    <?php
     }
	?>
	<span id="notification_count"><?php echo $t; ?></span>
 </a>
 <br clear="all" />
 
 <a href="<?php echo $var."home"; ?>" style="background-color: #006600; font-size:13px; width:100px;" >
...
<!-- End Header -->
<div class="content" style="margin-top:100px; margin-bottom: -70px; ">
