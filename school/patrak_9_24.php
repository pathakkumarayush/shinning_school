...
<td colspan="94">&nbsp;&nbsp;ANNUAL RESULT SHEET, SESSION <?php echo $_GET['ses']; ?>
...
<tr style="line-height:25px;color:#000000;font-size:21px; font-weight:bold;" align="left">
<td colspan="94">&nbsp;&nbsp;Name Of School - Shining Public Higher Secondary School</td>
</tr>
...
<td colspan="5">&nbsp;Block : Sanchi</td><td colspan="77">&nbsp;District : Raisen</td>
</tr>
...
<td colspan="13" style="border-left:1px #FF0000 solid;border-right:1px #FF0066 solid; color:#000000">
Quarterly Exam
</td>
<td colspan="13" style="border-left:1px #FF0000 solid;border-right:1px #FF0000 solid;border-right:1px #FF0066 solid; color:#000000">
Half Yearly Exam
</td>
...
<td colspan="6" style="border-left:1px #FF0000 solid;border-right:1px #FF0066 solid; color:#000000">
Quarterly Exam(5%)
</td>
<td colspan="6" style="border-left:1px #FF0000 solid;border-right:1px #FF0000 solid;border-right:1px #FF0066 solid; color:#000000">
Half Yearly Exam(5%)
</td>
<td colspan="12" style="border-left:1px #FF0000 solid;border-right:1px #FF0000 solid;border-right:1px #FF0066 solid; color:#000000">
Annual Exam(90%)
</td>

<td colspan="20" style="border-left:1px #FF0000 solid;border-right:2px #FF0000 solid;color:#000000">
...
<td rowspan="2" style="border-right:1px #FF0000 solid;color:#FF0000">Enrollment No</td>

<td style="border-left:1px #FF0000 solid;color:#FF0000" colspan="2">English</td>
<td colspan="2" style="color:#FF0000">Hindi</td>
<td colspan="2" style="color:#FF0000">Sanskrit</td>
<td colspan="2" style="color:#FF0000">Math</td>
<td colspan="2" style="color:#FF0000">Science</td>
<td colspan="2" style="color:#FF0000">Social Science</td>
...
<td rowspan="2" style="color:#FF0000">Sanskrit</td>
<td rowspan="2" style="color:#FF0000">Math</td>
<td rowspan="2" style="color:#FF0000">Science</td>
<td rowspan="2" style="color:#FF0000;border-right:1px #FF0000 solid;">Social Science</td>
...
<td colspan="2" style="color:#FF0000">Math</td>
<td colspan="2" style="color:#FF0000">Science</td>
<td colspan="2" style="color:#FF0000;border-right:1px #FF0000 solid;color:#FF0000">Social Science</td>
...
<td style="border-left:1px #FF0000 solid;">TH.<br> <span style="color:#006699">Max <br>[75]<br>Min<br>[25]</span></td>
<td>PR.<br> <span style="color:#006699">Max <br>[25]<br>Min<br>[8]</span></td>
<td>TH.<br> <span style="color:#006699">Max <br>[75]<br>Min<br>[25]</span></td>
<td>PR.<br> <span style="color:#006699">Max <br>[25]<br>Min<br>[8]</span></td>
<td>TH.<br> <span style="color:#006699">Max <br>[75]<br>Min<br>[25]</span></td>
<td>PR.<br> <span style="color:#006699">Max <br>[25]<br>Min<br>[8]</span></td>
<td>TH.<br> <span style="color:#006699">Max <br>[75]<br>Min<br>[25]</span></td>
...
<td style="border-left:1px #FF0000 solid;">13</td><td>14</td><td>15</td><td>16</td>
<td>17</td><td>18</td><td>19</td><td>20</td><td>21</td><td>22</td><td>23</td><td>24</td><td style="border-right:1px #FF0000 solid;">25</td>
<td style="border-left:1px #FF0000 solid;">26</td><td>27</td><td>28</td><td>29</td><td>30</td><td>31</td><td>32</td><td>33</td><td>34</td><td>35</td><td>36</td><td>37</td>
<td style="border-right:1px #FF0000 solid;">38</td><td style="border-left:1px #FF0000 solid;">39</td><td>40</td><td>41</td><td>42</td><td>43</td><td>44</td><td>45</td><td>46</td>

<td>47</td><td>48</td><td>49</td><td>50</td><td style="border-right:1px #FF0000 solid;">51</td><td style="border-left:1px #FF0000 solid;">52</td><td>53</td><td>54</td><td>55</td>
<td>56</td><td style="border-right:1px #FF0000 solid;">57</td><td style="border-left:1px #FF0000 solid;">58</td><td>59</td><td>60</td><td>61</td><td>62</td>

<td style="border-right:1px #FF0000 solid;">63</td><td style="border-left:1px #FF0000 solid;">64</td><td>65</td><td>66</td><td>67</td><td>68</td><td>69</td><td>70</td><td>71</td>
<td>72</td><td>73</td><td>74</td><td style="border-right:1px #FF0000 solid;">75</td><td style="border-left:1px #FF0000 solid;">76</td><td>77</td><td>78</td><td>79</td><td>80</td>
<td>81</td><td>82</td><td>83</td><td>84</td><td>85</td><td>86</td><td>87</td><td>88</td><td>89</td><td>90</td><td>91</td><td>92</td><td style="border-right:2px #FF0000 solid;">93</td>
</tr>
<?php
...
$meng_m = $rowmeng['obtainmarks']*75/80;
$meng_m75 = number_format($meng_m, 1);

$meng_m100 = $meng_m75+$qpeng_m;
$meng_m55 = $meng_m100*5/100;

$meng_m5 = number_format($meng_m55, 1);
...
$heng_m = $rowheng['obtainmarks']*75/80;
$heng_m75 = number_format($heng_m, 1);
$heng_m100 = $heng_m75+$hpeng_m;
$heng_m55 = $heng_m100*5/100;

$heng_m5 = number_format($heng_m55, 1);
...
<!--hindi marking start-->
<?php
$qphindi=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='FIRST TERM PROJECT' and subject='Hindi' and ses='$ses'") 
or die(mysqli_error());
$rowqphindi=mysqli_fetch_array($qphindi);
$qphindi_m = $rowqphindi['obtainmarks'];
 
$mhindi=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='FIRST TERMINAL' and subject='Hindi' and ses='$ses'") 
or die(mysqli_error());
$rowmhindi=mysqli_fetch_array($mhindi);
$mhindi_m = $rowmhindi['obtainmarks']*75/80;
$mhindi_m75 = number_format($mhindi_m, 1);
$mhindi_m100 = $mhindi_m75+$qphindi_m;
$mhindi_m55 = $mhindi_m100*5/100;

$mhindi_m5 = number_format($mhindi_m55, 1);


$hphindi=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='SECOND TERM PROJECT' and subject='Hindi' and ses='$ses'") 
or die(mysqli_error());
...
$hhindi_m = $rowhhindi['obtainmarks']*75/80;
$hhindi_m75 = number_format($hhindi_m, 1);
$hhindi_m100 = $hhindi_m75+$hphindi_m;
$hhindi_m55 = $hhindi_m100*5/100;

$hhindi_m5 = number_format($hhindi_m55, 1);
...
$msans_m = $rowmsans['obtainmarks']*75/80;
$msans_m75 = number_format($msans_m, 1);
$msans_m100 = $msans_m75+$qpsans_m;
$msans_m55 = $msans_m100*5/100;

$msans_m5 = number_format($msans_m55, 1);
...
$hsans_m = $rowhsans['obtainmarks']*75/80;
$hsans_m75 = number_format($hsans_m, 1);
$hsans_m100 = $hsans_m75+$hpsans_m;
$hsans_m55 = $hsans_m100*5/100;

$hsans_m5 = number_format($hsans_m55, 1);
...
$mmath_m = $rowmmath['obtainmarks']*75/80;
$mmath_m75 = number_format($mmath_m, 1);
$mmath_m100 = $mmath_m75+$qpmath_m;
$mmath_m55 = $mmath_m100*5/100;

$mmath_m5 = number_format($mmath_m55, 1);
...
$hmath_m = $rowhmath['obtainmarks']*75/80;
$hmath_m75 = number_format($hmath_m, 1);
$hmath_m100 = $hmath_m75+$hpmath_m;
$hmath_m55 = $hmath_m100*5/100;

$hmath_m5 = number_format($hmath_m55, 1);
...
<?php
$qpsc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='FIRST TERM PROJECT' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
$rowqpsc=mysqli_fetch_array($qpsc);
$qpsc_m = $rowqpsc['obtainmarks'];

$msc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='FIRST TERMINAL' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
$rowmsc=mysqli_fetch_array($msc);
$msc_m = $rowmsc['obtainmarks']*75/80;
$msc_m75 = number_format($msc_m, 1);
$msc_m100 = $msc_m75+$qpsc_m;
$msc_m55 = $msc_m100*5/100;

$msc_m5 = number_format($msc_m55, 1);

$hpsc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='SECOND TERM PROJECT' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
$rowhpsc=mysqli_fetch_array($hpsc);
$hpsc_m = $rowhpsc['obtainmarks'];
$hsc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='SECOND TERMINAL' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
$rowhsc=mysqli_fetch_array($hsc);
$hsc_m = $rowhsc['obtainmarks']*75/80;
$hsc_m75 = number_format($hsc_m, 1);
$hsc_m100 = $hsc_m75+$hpsc_m;
$hsc_m55 = $hsc_m100*5/100;

$hsc_m5 = number_format($hsc_m55, 1);

$asc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='ANNUAL EXAM' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
$rowasc=mysqli_fetch_array($asc);
$asc_m = $rowasc['obtainmarks'];
$asc_m90 = $asc_m*90/100;

$psc=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='ANNUAL PROJECT' and subject='Science' and ses='$ses'") 
or die(mysqli_error());
...
<?php
$qpss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='FIRST TERM PROJECT' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
$rowqpss=mysqli_fetch_array($qpss);
$qpss_m = $rowqpss['obtainmarks'];

$mss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='FIRST TERMINAL' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
$rowmss=mysqli_fetch_array($mss);
$mss_m = $rowmss['obtainmarks']*75/80;
$mss_m75 = number_format($mss_m, 1);
$mss_m100 = $mss_m75+$qpss_m;
$mss_m55 = $mss_m100*5/100;

$mss_m5 = number_format($mss_m55, 1);

$hpss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='SECOND TERM PROJECT' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
$rowhpss=mysqli_fetch_array($hpss);
$hpss_m = $rowhpss['obtainmarks'];
$hss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='SECOND TERMINAL' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
$rowhss=mysqli_fetch_array($hss);
$hss_m = $rowhss['obtainmarks']*75/80;
$hss_m75 = number_format($hss_m, 1);
$hss_m100 = $hss_m75+$hpss_m;
$hss_m55 = $hss_m100*5/100;

$hss_m5 = number_format($hss_m55, 1);

$ass=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='ANNUAL EXAM' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
$rowass=mysqli_fetch_array($ass);
$ass_m = $rowass['obtainmarks'];
$ass_m90 = $ass_m*90/100;

$pss=mysqli_query($con,"select subject,obtainmarks,totalmarks from marks where student='$uid' and exam='ANNUAL PROJECT' and subject='Social Science' and ses='$ses'") 
or die(mysqli_error());
...
?>
<td align="center" style="border-left:1px #FF0000 solid;"><?php echo $meng_m75; ?></td>
<td align="center"><?php echo $qpeng_m;  $qeng5 = ($meng_m+$qpeng_m)*5/100; ?></td>

<td align="center"><?php echo $mhindi_m75; ?></td>
<td align="center"><?php echo $qphindi_m;  $qhindi5 =($mhindi_m+$qphindi_m)*5/100;?></td>

<td align="center"><?php echo $msans_m75; ?></td>
<td align="center"><?php echo $qpsans_m; $qsans5 = ($msans_m+$qpsans_m)*5/100;?></td>

<td align="center"><?php echo $mmath_m75; ?></td>
<td align="center"><?php echo $qpmath_m; $qmath5 = ($mmath_m+$qpmath_m)*5/100;?></td>

<td align="center"><?php echo $msc_m75; ?></td>
<td align="center"><?php echo $qpsc_m; $qsc5 = ($msc_m+$qpsc_m)*5/100;?></td>

<td align="center"><?php echo $mss_m75; ?></td>
<td align="center"><?php echo $qpss_m; $qss5 = ($mss_m+$qpss_m)*5/100;?></td>

<td align="center" style=" border-right:1px #FF0000 solid;">
<?php $qyt_m =  $meng_m75+$qpeng_m+$mhindi_m75+$qphindi_m+$msans_m75+$qpsans_m+$mmath_m75+$qpmath_m+$msc_m75+$qpsc_m+$mss_m75+$qpss_m; 
echo round($qyt_m); ?></td>


<td align="center" style="border-left:1px #FF0000 solid;"><?php echo $heng_m75 ?></td>
<td align="center"><?php echo $hpeng_m;  $heng5 = ($heng_m+$hpeng_m)*5/100; ?></td>

<td align="center"><?php echo $hhindi_m75; ?></td>
<td align="center"><?php echo $hphindi_m; $hhindi5 = ($hhindi_m+$hphindi_m)*5/100;?></td>

<td align="center"><?php echo $hsans_m75; ?></td>
<td align="center"><?php echo $hpsans_m; $hsans5 = ($hsans_m+$hpsans_m)*5/100;?></td>

<td align="center"><?php echo $hmath_m75; ?></td>
<td align="center"><?php echo $hpmath_m; $hmath5 = ($hmath_m+$hpmath_m)*5/100;?></td>

<td align="center"><?php echo $hsc_m75; ?></td>
<td align="center"><?php echo $hpsc_m; $hsc5 = ($hsc_m+$hpsc_m)*5/100;?></td>

<td align="center"><?php echo $hss_m75; ?></td>
<td align="center"><?php echo $hpss_m; $hss5 = ($hss_m+$hpss_m)*5/100;?></td>

<td align="center" style=" border-right:1px #FF0000 solid;">
<?php $hy_m =  $heng_m75+$hpeng_m+$hhindi_m75+$hphindi_m+$hsans_m75+$hpsans_m+$hmath_m75+$hpmath_m+$hsc_m75+$hpsc_m+$hss_m75+$hpss_m; 
echo round($hy_m); ?></td>
...
<td align="center" ><?php echo number_format($qsans5, 1); ?></td>
...
<td align="center" ><?php echo number_format($hsans5, 1); ?></td>
...
<td align="center"><?php $asans90 = $asans_m*90/100; echo number_format($asans90, 1); ?></td>
<td align="center"><?php $psans90 = $psans_m*90/100; echo number_format($psans90, 1); ?></td>
...
<td align="center">
<?php $asans90 = $asans_m*90/100;  echo  $asans5_5_90 = round($qsans5+$hsans5+$asans90); ?></td>

<td align="center"><?php $psans90 = round($psans_m*90/100); echo $psans90; ?></td>
...
<td align="center"><?php echo $gtm =  $aeng5_5_90+$ahindi5_5_90+$asans5_5_90+$math5_5_90+$sc5_5_90+$ss5_5_90+$peng90+$phindi90+$psans90+$pmath90+$psc90+$pss90;?></td>

<td align="center"><?php  $per = $gtm*100/600;  echo number_format($per, 2); ?></td>
