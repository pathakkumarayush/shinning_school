...
instalment,extra_amnt,remark,cno,cd,padv,anual,sch,bank,ne_no,rt_no,im_no,sw_no)
...
'".$_POST['dat']."','".$_POST['padv']."','".$_POST['anual']."','".$_POST['sch']."','".$_POST['bank']."','".$_POST['ne_no']."','".$_POST['rt_no']."','".$_POST['im_no']."','".$_POST['sw_no']."')");
...
<div class="col_4">
	...
	<form method="post" name="myForm" action="#" enctype="multipart/form-data"  onsubmit="return validateForm()" >
         ...
         <?php $_SESSION['session']; ?></td>
		  ...
		  <td>Month</td>
		  <td>Tution Fee</td>
		  <td><span style="margin-left:-170px;">Annual Fee</span></td>
		  </tr>
		  <?php
		  ...
		  <?php
		  $search1=mysqli_query($con,"select * from fee_detail where session='".$_SESSION['session']."' and school='".$_SESSION['uid']."' 
    ...
    <div class="Neft box"><input type="text" name="ne_no" placeholder='Transaction Id' /></div>
    <div class="Rtgs box"><input type="text" name="rt_no" placeholder='Transaction Id' /></div>
	<div class="Imps box"><input type="text" name="im_no" placeholder='Transaction Id' /></div>
	<div class="Swipe box"><input type="text" name="sw_no" placeholder='Transaction Id' /></div>
		  </td>
	      </tr>	
