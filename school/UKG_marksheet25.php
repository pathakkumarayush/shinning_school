...
?>	
<div style="width:1060px;height:1550px;font-family:Calisto MT;background:url(BKN_UKG.png);background-repeat:no-repeat;background-position:center;" class="fsz">
<br clear="all" />
