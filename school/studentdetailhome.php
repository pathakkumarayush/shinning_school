...
<body alink="#00FF66" link="#00CC00">
              ...
              {
              $d=date("Y-m-d");
             $query=mysqli_query($con,"delete from student where id='".$_GET['did']."' and student_school='".$_SESSION['uid']."' and student_session='".$_SESSION['session']."'");	
              }
			  ?>
...
<div class="full_div">
        ...
        <center><h2 style="text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Student Print List</h2></center>
        </div>
        <div class="col_4">
	    ...
	    <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."studentdetailhome"."&&divid=4"; ?>">Search Student By Class Section</a>
	&nbsp;||&nbsp;
		 <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."studentdetailhomes"."&&divid=4"; ?>">Search Student By Class</a>
		 
		 &nbsp;||&nbsp;
		 <a style=" border-radius:5px; padding:5 5 5 5 ;color:#FFFFFF;font-size:16px" href="<?php echo $var."studentdetailhome"."&&divid=2"; ?>">Search Student By Name</a>
	 ...
	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/studentlist.php?student_class=<?php echo $_POST['class'];  ?>')">     <input type="button" value="Print List " style="width:100px; position:absolute"></a>
	 
	 	 <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/studentlistall.php?ses=<?php echo $_SESSION['session'];  ?>')">     <input type="button" value="ALL STUDENT List " style="width:150px; margin-left:114PX;  position:absolute"></a>
		 
		  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/r.php?student_class=<?php echo $_POST['class']; 
		  ?>')">     <input type="button" value="Roll No Exel" style="width:150px; margin-left:280PX;  position:absolute"></a>
		  
		  <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/u.php?student_class=<?php echo $_POST['class']; 
		  ?>')">     <input type="button" value="User Id" style="width:150px; margin-left:480PX;  position:absolute"></a>
		  
		 
		   <a  href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/ar.php?student_class=<?php echo $_POST['class']; 
		  ?>')">     <input type="button" value="Attendance" style="width:150px; margin-left:680PX;  position:absolute"></a>
	    ...
	    <td> <a href="<?php echo $var."edit_admission&upstudid=".$studrow['student_id']; ?>" target="_blank">Edit</a>|
	    <a href="<?php echo $var."studentdetailhome&did=".$studrow['id']; ?>" onClick="return confirmation();">Delete</a>|
