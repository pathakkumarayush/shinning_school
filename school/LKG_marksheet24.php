...
?>	
<div style="width:1060px;height:1550px;font-family:Calisto MT;background:url(BK_LKG.png);background-repeat:no-repeat;background-position:center;" class="fsz">
<br clear="all" />
