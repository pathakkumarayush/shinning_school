...
<a href="<?php echo $var."current_studen" ?>" style="border-radius:5px; padding:5 5 5 5 ;color:#000;font-size:16px; float:right; margin-top:-15px; margin-right:10px; font-weight:bold;"></a>
</div>
<script type="text/javascript">
	...
	while($row=mysqli_fetch_array( $sql))
	{
		?>
               <tr>
				  ...
				  <td><a href="<?php echo $var."admissionnf&upstudid=".$row['student_id']; ?>" target="_blank"><b>View</b></a> 
	 &nbsp;||&nbsp;
