...
<table border="1" id="sample_1" cellspacing="0" cellpadding="0" style="width:900px;">
	  ...
	  $i=1;
        ...
        $search=mysqli_query($con,"select * from student where student_class='".$_GET['student_class']."' and  student_session='".$_SESSION['session']."' and status='3' order by student_name Asc");
