...
.tab tr{ line-height:30px;}
      ...
      <?php
	  $i=1;
	  $search=mysqli_query($con,"select * from teacher where staff_typ='nonteaching' and teacher_session='".$_GET['ses']."' and status='Active' and school_type='higher'");
      ...
      <img src="idl.png" style="width:197px; height:45px;margin-left:4px; margin-top:0px; ">
	 ...
	 <tr style="line-height:20px;"><td style="color:#000000;" colspan="2">Address: <?php echo $rowstud["address"]; ?></td> 
	   </tr>
	  ...
	  <span style="font-size:12px; font-weight:bold;color:#FFFFFF; margin-left:5px;">Sagar Road, Raisen, M.P. 464551</span>
