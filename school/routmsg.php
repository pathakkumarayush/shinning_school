...
<h2 style="float:left; margin-left:10px; text-transform:uppercase; color:#006633; font-size:20px; margin-top:15px;">Sens Message -Bus Rout wise </h2>
</div>
<div class="col_4" style="margin-top:0px; min-height:400px;" >
  ...
  <div style="width:95%; height:100px; border:1px solid black" id="msg" >
   ...
   <input type='checkbox' value='on' id='chkall' name='allbox' onclick='checkAll();'/>
    </td><td>&nbsp;Sr.No</td><td>&nbsp;NAME</td><td>&nbsp;Father</td><td>&nbsp;Contact</td></tr>
	<?php
	$i=0;
	$res_all=mysqli_query($con,"select * from student where transport_rout='".$_GET['id']."' and student_session='".$_SESSION['session']."' order by student_name Asc")
	or die(mysqli_error());
    ...
    while($row_all=mysqli_fetch_array($res_all))
	{
        ...
        <td>&nbsp;<?php echo $i; ?></td>
        <td style="font-weight:bold">&nbsp;<?php echo $row_all["student_name"]; ?></td>
