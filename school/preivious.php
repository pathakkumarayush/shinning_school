...
<div class="col_4" style="min-height:400px;">
    ...
    <?php
        ...
        <?php
		  ...
		  &nbsp;||&nbsp;
		  <a  href="./?pageid=feecollectionby_datee&&divid=1" style="text-decoration:none; font-size:16px;  color:#FFFFFF">Today Collection</a> 
		  
		   &nbsp;||&nbsp;
		  <a href="./?pageid=feecollectionby_datee&&divid=2" style="text-decoration:none; font-size:16px;  color:#FFFFFF">Date-wise</a> 
		  
		  
		   &nbsp;||&nbsp;
		  <a  href="<?php echo $var."date_rangp"."&&divid=2"; ?>" style="text-decoration:none; font-size:16px;  color:#FFFFFF">Date-B/W</a> 
...
?>
		...
		?> 
		 ...
		 <table style="margin:20px 0px 0px 100px; font-size:14px" width="700">
		  ...
		  <td><input type="text" name="acn" style="width:140px" required/>			
				  ...
				  <?php		
				    ...
				    <input type="hidden" name="p_year" value="<?php echo $rowacaut['amt']; ?>">
							...
							<tr>
								...
								<label><input type="radio" name="ftype" value="Paytm">Paytm</label>
								</td>
								</tr>	
								  <tr>
							   <td></td>
...
?>
<td>
<a href="javascript:void(0)" style="color:#FF0000" onClick="return popitup('https://smarterponline.com/shining/school/p_getreceipt.php?id=<?php echo $_SESSION['studentid']; ?>')">
