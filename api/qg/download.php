                    ...
                    <div style="margin-bottom: 16px; font-size: 13px; page-break-inside: avoid">
                        ...
                        <?php if (!empty($q['image_path'])): ?>
                            <div style="text-align:center; margin:10px 0">
                                <img src="../../school/<?php echo htmlspecialchars($q['image_path']); ?>" style="max-width:320px; max-height:220px; object-fit:contain; border:1px solid #ddd; border-radius:3px" />
                            </div>
                        <?php endif; ?>
